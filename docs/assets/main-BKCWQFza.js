 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xv{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(Sv(n)){const i=n.getImmediate();return`${i.library}/${i.version}`}else return null}).filter(n=>n).join(" ")}}function Sv(t){const e=t.getComponent();return(e==null?void 0:e.type)==="VERSION"}const xl="@firebase/app",Mu="0.10.13";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Sl="[DEFAULT]",e0={[xl]:"fire-core",[Av]:"fire-core-compat",[Rv]:"fire-analytics",[kv]:"fire-analytics-compat",[Cv]:"fire-app-check",[Pv]:"fire-app-check-compat",[Mv]:"fire-auth",[Dv]:"fire-auth-compat",[Bv]:"fire-rtdb",[Lv]:"fire-data-connect",[Nv]:"fire-rtdb-compat",[Ov]:"fire-fn",[Fv]:"fire-fn-compat",[Vv]:"fire-iid",[zv]:"fire-iid-compat",[$v]:"fire-fcm",[Uv]:"fire-fcm-compat",[qv]:"fire-perf",[Hv]:"fire-perf-compat",[Wv]:"fire-rc",[Yv]:"fire-rc-compat",[jv]:"fire-gcs",[Gv]:"fire-gcs-compat",[Kv]:"fire-fst",[Jv]:"fire-fst-compat",[Qv]:"fire-vertex","fire-js":"fire-js",[Xv]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Pr=Zv;function vf(t,e={}){let n=t;typeof e!="object"&&(e={name:e});const i=Object.assign({name:Sl,automaticDataCollectionEnabled:!1},e),r=i.name;if(typeof r!="string"||!r)throw mi.create("bad-app-name",{appName:String(r)});if(n||(n=pf()),!n)throw mi.create("no-options");const s=zo.get(r);if(s){if(Vo(n,s.options)&&Vo(i,s.config))return s;throw mi.create("duplicate-app",{appName:r})}const o=new cv(r);for(const c of Al.values())o.addComponent(c);const l=new i0(n,i,o);return zo.set(r,l),l}function bf(t=Sl){const e=zo.get(t);if(!e&&t===Sl&&pf())return vf();if(!e)throw mi.create("no-app",{appName:t});return e}function gi(t,e,n){var i;let r=(i=e0[t])!==null&&i!==void 0?i:t;n&&(r+=`-${n}`);const s=r.match(/\s|\//),o=e.match(/\s|\//);if(s||o){const l=[`Unable to register library "${r}" with version "${e}":`];s&&l.push(`library name "${r}" contains illegal characters (whitespace or "/")`),s&&o&&l.push("and"),o&&l.push(`version name "${e}" contains illegal characters (whitespace or "/")`),zn.warn(l.join(" "));return}vr(new Hi(`${r}-version`,()=>({library:r,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const r0="firebase-heartbeat-database",s0=1,vs="firebase-heartbeat-store";let ul=null;function wf(){return ul||(ul=Ev(r0,s0,{upgrade:(t,e)=>{switch(e){case 0:try{t.createObjectStore(vs)}catch(n){console.warn(n)}}}}).catch(t=>{throw mi.create("idb-open",{originalErrorMessage:t.message})})),ul}async function o0(t){try{const n=(await wf()).transaction(vs),i=await n.objectStore(vs).get(_f(t));return await n.done,i}catch(e){if(e instanceof Yn)zn.warn(e.message);else{const n=mi.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});zn.warn(n.message)}}}async function Bu(t,e){try{const i=(await wf()).transaction(vs,"readwrite");await i.objectStore(vs).put(e,_f(t)),await i.done}catch(n){if(n instanceof Yn)zn.warn(n.message);else{const i=mi.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});zn.warn(i.message)}}}function _f(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function h0(t){vr(new Hi("platform-logger",e=>new xv(e),"PRIVATE")),vr(new Hi("heartbeat",e=>new c0(e),"PRIVATE")),gi(xl,Mu,t),gi(xl,Mu,"esm2017"),gi("fire-js","")}h0("");var f0="firebase",p0="10.14.1";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $o=new fc("@firebase/auth");function g0(t,...e){$o.logLevel<=oe.WARN&&$o.warn(`Auth (${Pr}): ${t}`,...e)}function To(t,...e){$o.logLevel<=oe.ERROR&&$o.error(`Auth (${Pr}): ${t}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function kl(){var t;return typeof self<"u"&&((t=self.location)===null||t===void 0?void 0:t.href)||""}function v0(){return Ou()==="http:"||Ou()==="https:"}function Ou(){var t;return typeof self<"u"&&((t=self.location)===null||t===void 0?void 0:t.protocol)||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const E0=new Fs(3e4,6e4);function jn(t,e){return t.tenantId&&!e.tenantId?Object.assign(Object.assign({},e),{tenantId:t.tenantId}):e}async function gn(t,e,n,i,r={}){return xf(t,r,async()=>{let s={},o={};i&&(e==="GET"?o=i:s={body:JSON.stringify(i)});const l=Os(Object.assign({key:t.config.apiKey},o)).slice(1),c=await t._getAdditionalHeaders();c["Content-Type"]="application/json",t.languageCode&&(c["X-Firebase-Locale"]=t.languageCode);const d=Object.assign({method:e,headers:c},s);return Yy()||(d.referrerPolicy="no-referrer"),If.fetch()(Sf(t,t.config.apiHost,n,l),d)})}async function xf(t,e,n){t._canInitEmulator=!1;const i=Object.assign(Object.assign({},_0),e);try{const r=new I0(t),s=await Promise.race([n(),r.promise]);r.clearNetworkTimeout();const o=await s.json();if("needConfirmation"in o)throw yo(t,"account-exists-with-different-credential",o);if(s.ok&&!("errorMessage"in o))return o;{const l=s.ok?o.errorMessage:o.error.message,[c,d]=l.split(" : ");if(c==="FEDERATED_USER_ID_ALREADY_LINKED")throw yo(t,"credential-already-in-use",o);if(c==="EMAIL_EXISTS")throw yo(t,"email-already-in-use",o);if(c==="USER_DISABLED")throw yo(t,"user-disabled",o);const f=i[c]||c.toLowerCase().replace(/[_\s]+/g,"-");if(d)throw yc(t,f,d);qt(t,f)}}catch(r){if(r instanceof Yn)throw r;qt(t,"network-request-failed",{message:String(r)})}}async function Vs(t,e,n,i,r={}){const s=await gn(t,e,n,i,r);return"mfaPendingCredential"in s&&qt(t,"multi-factor-auth-required",{_serverResponse:s}),s}function Sf(t,e,n,i){const r=`${e}${n}?${i}`;return t.config.emulator?bc(t.config,r):`${t.config.apiScheme}://${r}`}function T0(t){switch(t){case"ENFORCE":return"ENFORCE";case"AUDIT":return"AUDIT";case"OFF":return"OFF";default:return"ENFORCEMENT_STATE_UNSPECIFIED"}}class I0{constructor(e){this.auth=e,this.timer=null,this.promise=new Promise((n,i)=>{this.timer=setTimeout(()=>i(Xt(this.auth,"network-request-failed")),E0.get())})}clearNetworkTimeout(){clearTimeout(this.timer)}}function yo(t,e,n){const i={appName:t.name};n.email&&(i.email=n.email),n.phoneNumber&&(i.phoneNumber=n.phoneNumber);const r=Xt(t,e,i);return r.customData._tokenResponse=n,r}function Fu(t){return t!==void 0&&t.enterprise!==void 0}class x0{constructor(e){if(this.siteKey="",this.recaptchaEnforcementState=[],e.recaptchaKey===void 0)throw new Error("recaptchaKey undefined");this.siteKey=e.recaptchaKey.split("/")[3],this.recaptchaEnforcementState=e.recaptchaEnforcementState}getProviderEnforcementState(e){if(!this.recaptchaEnforcementState||this.recaptchaEnforcementState.length===0)return null;for(const n of this.recaptchaEnforcementState)if(n.provider&&n.provider===e)return T0(n.enforcementState);return null}isProviderEnabled(e){return this.getProviderEnforcementState(e)==="ENFORCE"||this.getProviderEnforcementState(e)==="AUDIT"}}async function S0(t,e){return gn(t,"GET","/v2/recaptchaConfig",jn(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ds(t){if(t)try{const e=new Date(Number(t));if(!isNaN(e.getTime()))return e.toUTCString()}catch{}}async function k0(t,e=!1){const n=Be(t),i=await n.getIdToken(e),r=wc(i);Y(r&&r.exp&&r.auth_time&&r.iat,n.auth,"internal-error");const s=typeof r.firebase=="object"?r.firebase:void 0,o=s==null?void 0:s.sign_in_provider;return{claims:r,token:i,authTime:ds(hl(r.auth_time)),issuedAtTime:ds(hl(r.iat)),expirationTime:ds(hl(r.exp)),signInProvider:o||null,signInSecondFactor:(s==null?void 0:s.sign_in_second_factor)||null}}function hl(t){return Number(t)*1e3}function wc(t){const[e,n,i]=t.split(".");if(e===void 0||n===void 0||i===void 0)return To("JWT malformed, contained fewer than 3 sections"),null;try{const r=hf(n);return r?JSON.parse(r):(To("Failed to decode base64 JWT payload"),null)}catch(r){return To("Caught error parsing JWT payload as JSON",r==null?void 0:r.toString()),null}}function Vu(t){const e=wc(t);return Y(e,"internal-error"),Y(typeof e.exp<"u","internal-error"),Y(typeof e.iat<"u","internal-error"),Number(e.exp)-Number(e.iat)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ab(t){switch(t){case"recoverEmail":return"RECOVER_EMAIL";case"resetPassword":return"PASSWORD_RESET";case"signIn":return"EMAIL_SIGNIN";case"verifyEmail":return"VERIFY_EMAIL";case"verifyAndChangeEmail":return"VERIFY_AND_CHANGE_EMAIL";case"revertSecondFactorAddition":return"REVERT_SECOND_FACTOR_ADDITION";default:return null}}function lb(t){const e=ns(is(t)).link,n=e?ns(is(e)).deep_link_id:null,i=ns(is(t)).deep_link_id;return(i?ns(is(i)).link:null)||i||n||e||t}class Tc{constructor(e){var n,i,r,s,o,l;const c=ns(is(e)),d=(n=c.apiKey)!==null&&n!==void 0?n:null,f=(i=c.oobCode)!==null&&i!==void 0?i:null,m=ab((r=c.mode)!==null&&r!==void 0?r:null);Y(d&&f&&m,"argument-error"),this.apiKey=d,this.operation=m,this.code=f,this.continueUrl=(s=c.continueUrl)!==null&&s!==void 0?s:null,this.languageCode=(o=c.languageCode)!==null&&o!==void 0?o:null,this.tenantId=(l=c.tenantId)!==null&&l!==void 0?l:null}static parseLink(e){const n=lb(e);try{return new Tc(n)}catch{return null}}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ub(t,e,n=!1){const{auth:i}=t;if(Qt(i.app))return Promise.reject(Nn(i));const r="reauthenticate";try{const s=await br(t,Uf(i,r,e,t),n);Y(s.idToken,i,"internal-error");const o=wc(s.idToken);Y(o,i,"internal-error");const{sub:l}=o;return Y(t.uid===l,i,"user-mismatch"),Yi._forOperation(t,r,s)}catch(s){throw(s==null?void 0:s.code)==="auth/user-not-found"&&qt(i,"user-mismatch"),s}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function qf(t,e,n=!1){if(Qt(t.app))return Promise.reject(Nn(t));const i="signIn",r=await Uf(t,i,e),s=await Yi._fromIdTokenResponse(t,i,r);return n||await t._updateCurrentUser(s.user),s}async function hb(t,e){return qf(Gn(t),e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Hf(t){const e=Gn(t);e._getPasswordPolicyInternal()&&await e._updatePasswordPolicy()}async function fb(t,e,n){const i=Gn(t);await qo(i,{requestType:"PASSWORD_RESET",email:e,clientType:"CLIENT_TYPE_WEB"},"getOobCode",ib)}async function pb(t,e,n){if(Qt(t.app))return Promise.reject(Nn(t));const i=Gn(t),o=await qo(i,{returnSecureToken:!0,email:e,password:n,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",cb).catch(c=>{throw c.code==="auth/password-does-not-meet-requirements"&&Hf(t),c}),l=await Yi._fromIdTokenResponse(i,"signIn",o);return await i._updateCurrentUser(l.user),l}function mb(t,e,n){return Qt(t.app)?Promise.reject(Nn(t)):hb(Be(t),Cr.credential(e,n)).catch(async i=>{throw i.code==="auth/password-does-not-meet-requirements"&&Hf(t),i})}async function Wf(t,e){const n=Be(t),r={requestType:"VERIFY_EMAIL",idToken:await t.getIdToken()},{email:s}=await nb(n.auth,r);s!==t.email&&await t.reload()}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Sc extends Ec{constructor(e){super("custom","custom"),this.params=e}_getIdTokenResponse(e){return fr(e,this._buildIdpRequest())}_linkToIdToken(e,n){return fr(e,this._buildIdpRequest(n))}_getReauthenticationResolver(e){return fr(e,this._buildIdpRequest())}_buildIdpRequest(e){const n={requestUri:this.params.requestUri,sessionId:this.params.sessionId,postBody:this.params.postBody,tenantId:this.params.tenantId,pendingToken:this.params.pendingToken,returnSecureToken:!0,returnIdpCredential:!0};return e&&(n.idToken=e),n}}function Fb(t){return qf(t.auth,new Sc(t),t.bypassAuthState)}function Vb(t){const{auth:e,user:n}=t;return Y(n,e,"internal-error"),ub(n,new Sc(t),t.bypassAuthState)}async function zb(t){const{auth:e,user:n}=t;return Y(n,e,"internal-error"),db(n,new Sc(t),t.bypassAuthState)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class tp{constructor(e,n,i,r,s=!1){this.auth=e,this.resolver=i,this.user=r,this.bypassAuthState=s,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(n)?n:[n]}execute(){return new Promise(async(e,n)=>{this.pendingPromise={resolve:e,reject:n};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(i){this.reject(i)}})}async onAuthEvent(e){const{urlResponse:n,sessionId:i,postBody:r,tenantId:s,error:o,type:l}=e;if(o){this.reject(o);return}const c={auth:this.auth,requestUri:n,sessionId:i,tenantId:s||void 0,postBody:r||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(l)(c))}catch(d){this.reject(d)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return Fb;case"linkViaPopup":case"linkViaRedirect":return zb;case"reauthViaPopup":case"reauthViaRedirect":return Vb;default:qt(this.auth,"internal-error")}}resolve(e){$n(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){$n(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const rw=new Fs(3e4,6e4);function Qu(){const t=dn().___jsl;if(t!=null&&t.H){for(const e of Object.keys(t.H))if(t.H[e].r=t.H[e].r||[],t.H[e].L=t.H[e].L||[],t.H[e].r=[...t.H[e].L],t.CP)for(let n=0;n<t.CP.length;n++)t.CP[n]=null}}function sw(t){return new Promise((e,n)=>{var i,r,s;function o(){Qu(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{Qu(),n(Xt(t,"network-request-failed"))},timeout:rw.get()})}if(!((r=(i=dn().gapi)===null||i===void 0?void 0:i.iframes)===null||r===void 0)&&r.Iframe)e(gapi.iframes.getContext());else if(!((s=dn().gapi)===null||s===void 0)&&s.load)o();else{const l=W0("iframefcb");return dn()[l]=()=>{gapi.load?o():n(Xt(t,"network-request-failed"))},Vf(`${H0()}?onload=${l}`).catch(c=>n(c))}}).catch(e=>{throw So=null,e})}let So=null;function ow(t){return So=So||sw(t),So}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ji=new fc("@firebase/firestore");function es(){return ji.logLevel}function U(t,...e){if(ji.logLevel<=oe.DEBUG){const n=e.map(Ac);ji.debug(`Firestore (${Mr}): ${t}`,...n)}}function Un(t,...e){if(ji.logLevel<=oe.ERROR){const n=e.map(Ac);ji.error(`Firestore (${Mr}): ${t}`,...n)}}function wr(t,...e){if(ji.logLevel<=oe.WARN){const n=e.map(Ac);ji.warn(`Firestore (${Mr}): ${t}`,...n)}}function Ac(t){if(typeof t=="string")return t;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function G(t="Unexpected state"){const e=`FIRESTORE (${Mr}) INTERNAL ASSERTION FAILED: `+t;throw Un(e),new Error(e)}function ge(t,e){t||G()}function J(t,e){return t}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class kc{constructor(e,n){this.previousValue=e,n&&(n.sequenceNumberHandler=i=>this.ie(i),this.se=i=>n.writeSequenceNumber(i))}ie(e){return this.previousValue=Math.max(e,this.previousValue),this.previousValue}next(){const e=++this.previousValue;return this.se&&this.se(e),e}}kc.oe=-1;function ma(t){return t==null}function jo(t){return t===0&&1/t==-1/0}function Qw(t){return typeof t=="number"&&Number.isInteger(t)&&!jo(t)&&t<=Number.MAX_SAFE_INTEGER&&t>=Number.MIN_SAFE_INTEGER}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Lc(t,e){if(t.useProto3Json){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:jo(e)?"-0":e}}function xp(t){return{integerValue:""+t}}function __(t,e){return Qw(e)?xp(e):Lc(t,e)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Z_{constructor(e){this.ct=e}}function eE(t){const e=j_({parent:t.parent,structuredQuery:t.structuredQuery});return t.limitType==="LAST"?Nl(e,e.limit,"L"):e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const TT=/^__.*__$/;class IT{constructor(e,n,i){this.data=e,this.fieldMask=n,this.fieldTransforms=i}toMutation(e,n){return this.fieldMask!==null?new Ti(e,this.data,this.fieldMask,n,this.fieldTransforms):new Hs(e,this.data,n,this.fieldTransforms)}}class pm{constructor(e,n,i){this.data=e,this.fieldMask=n,this.fieldTransforms=i}toMutation(e,n){return new Ti(e,this.data,this.fieldMask,n,this.fieldTransforms)}}function mm(t){switch(t){case 0:case 2:case 1:return!0;case 3:case 4:return!1;default:throw G()}}class ed{constructor(e,n,i,r,s,o){this.settings=e,this.databaseId=n,this.serializer=i,this.ignoreUndefinedProperties=r,s===void 0&&this.vu(),this.fieldTransforms=s||[],this.fieldMask=o||[]}get path(){return this.settings.path}get Cu(){return this.settings.Cu}Fu(e){return new ed(Object.assign(Object.assign({},this.settings),e),this.databaseId,this.serializer,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}Mu(e){var n;const i=(n=this.path)===null||n===void 0?void 0:n.child(e),r=this.Fu({path:i,xu:!1});return r.Ou(e),r}Nu(e){var n;const i=(n=this.path)===null||n===void 0?void 0:n.child(e),r=this.Fu({path:i,xu:!1});return r.vu(),r}Lu(e){return this.Fu({path:void 0,xu:!0})}Bu(e){return ta(e,this.settings.methodName,this.settings.ku||!1,this.path,this.settings.qu)}contains(e){return this.fieldMask.find(n=>e.isPrefixOf(n))!==void 0||this.fieldTransforms.find(n=>e.isPrefixOf(n.field))!==void 0}vu(){if(this.path)for(let e=0;e<this.path.length;e++)this.Ou(this.path.get(e))}Ou(e){if(e.length===0)throw this.Bu("Document fields must not be empty");if(mm(this.Cu)&&TT.test(e))throw this.Bu('Document fields cannot begin and end with "__"')}}class xT{constructor(e,n,i){this.databaseId=e,this.ignoreUndefinedProperties=n,this.serializer=i||Ta(e)}Qu(e,n,i,r=!1){return new ed({Cu:e,methodName:n,qu:i,path:Qe.emptyPath(),xu:!1,ku:r},this.databaseId,this.serializer,this.ignoreUndefinedProperties)}}function Ra(t){const e=t._freezeSettings(),n=Ta(t._databaseId);return new xT(t._databaseId,!!e.ignoreUndefinedProperties,n)}function td(t,e,n,i,r,s={}){const o=t.Qu(s.merge||s.mergeFields?2:0,e,n,r);nd("Data must be an object, but it was:",o,i);const l=vm(i,o);let c,d;if(s.merge)c=new Mt(o.fieldMask),d=o.fieldTransforms;else if(s.mergeFields){const f=[];for(const m of s.mergeFields){const p=Wl(e,m,n);if(!o.contains(p))throw new q(M.INVALID_ARGUMENT,`Field '${p}' is specified in your field mask but missing from your input data.`);wm(f,p)||f.push(p)}c=new Mt(f),d=o.fieldTransforms.filter(m=>c.covers(m.field))}else c=null,d=o.fieldTransforms;return new IT(new Tt(l),c,d)}class Pa extends Jc{_toFieldTransform(e){if(e.Cu!==2)throw e.Cu===1?e.Bu(`${this._methodName}() can only appear at the top level of your update data`):e.Bu(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);return e.fieldMask.push(e.path),null}isEqual(e){return e instanceof Pa}}function gm(t,e,n,i){const r=t.Qu(1,e,n);nd("Data must be an object, but it was:",r,i);const s=[],o=Tt.empty();Xi(i,(c,d)=>{const f=id(e,c,n);d=Be(d);const m=r.Nu(f);if(d instanceof Pa)s.push(f);else{const p=Ca(d,m);p!=null&&(s.push(f),o.set(f,p))}});const l=new Mt(s);return new pm(o,l,r.fieldTransforms)}function ym(t,e,n,i,r,s){const o=t.Qu(1,e,n),l=[Wl(e,i,n)],c=[r];if(s.length%2!=0)throw new q(M.INVALID_ARGUMENT,`Function ${e}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let p=0;p<s.length;p+=2)l.push(Wl(e,s[p])),c.push(s[p+1]);const d=[],f=Tt.empty();for(let p=l.length-1;p>=0;--p)if(!wm(d,l[p])){const w=l[p];let x=c[p];x=Be(x);const I=o.Nu(w);if(x instanceof Pa)d.push(w);else{const A=Ca(x,I);A!=null&&(d.push(w),f.set(w,A))}}const m=new Mt(d);return new pm(f,m,o.fieldTransforms)}function Ca(t,e){if(bm(t=Be(t)))return nd("Unsupported field value:",e,t),vm(t,e);if(t instanceof Jc)return function(i,r){if(!mm(r.Cu))throw r.Bu(`${i._methodName}() can only be used with update() and set()`);if(!r.path)throw r.Bu(`${i._methodName}() is not currently supported inside arrays`);const s=i._toFieldTransform(r);s&&r.fieldTransforms.push(s)}(t,e),null;if(t===void 0&&e.ignoreUndefinedProperties)return null;if(e.path&&e.fieldMask.push(e.path),t instanceof Array){if(e.settings.xu&&e.Cu!==4)throw e.Bu("Nested arrays are not supported");return function(i,r){const s=[];let o=0;for(const l of i){let c=Ca(l,r.Lu(o));c==null&&(c={nullValue:"NULL_VALUE"}),s.push(c),o++}return{arrayValue:{values:s}}}(t,e)}return function(i,r){if((i=Be(i))===null)return{nullValue:"NULL_VALUE"};if(typeof i=="number")return __(r.serializer,i);if(typeof i=="boolean")return{booleanValue:i};if(typeof i=="string")return{stringValue:i};if(i instanceof Date){const s=qe.fromDate(i);return{timestampValue:Xo(r.serializer,s)}}if(i instanceof qe){const s=new qe(i.seconds,1e3*Math.floor(i.nanoseconds/1e3));return{timestampValue:Xo(r.serializer,s)}}if(i instanceof Xc)return{geoPointValue:{latitude:i.latitude,longitude:i.longitude}};if(i instanceof Ar)return{bytesValue:Lp(r.serializer,i._byteString)};if(i instanceof xt){const s=r.databaseId,o=i.firestore._databaseId;if(!o.isEqual(s))throw r.Bu(`Document reference is for database ${o.projectId}/${o.database} but should be for database ${s.projectId}/${s.database}`);return{referenceValue:Fc(i.firestore._databaseId||r.databaseId,i._key.path)}}if(i instanceof Zc)return function(o,l){return{mapValue:{fields:{__type__:{stringValue:"__vector__"},value:{arrayValue:{values:o.toArray().map(c=>{if(typeof c!="number")throw l.Bu("VectorValues must only contain numeric values.");return Lc(l.serializer,c)})}}}}}}(i,r);throw r.Bu(`Unsupported field value: ${Qc(i)}`)}(t,e)}function vm(t,e){const n={};return up(t)?e.path&&e.path.length>0&&e.fieldMask.push(e.path):Xi(t,(i,r)=>{const s=Ca(r,e.Mu(i));s!=null&&(n[i]=s)}),{mapValue:{fields:n}}}function bm(t){return!(typeof t!="object"||t===null||t instanceof Array||t instanceof Date||t instanceof qe||t instanceof Xc||t instanceof Ar||t instanceof xt||t instanceof Jc||t instanceof Zc)}function nd(t,e,n){if(!bm(n)||!function(r){return typeof r=="object"&&r!==null&&(Object.getPrototypeOf(r)===Object.prototype||Object.getPrototypeOf(r)===null)}(n)){const i=Qc(n);throw i==="an object"?e.Bu(t+" a custom object"):e.Bu(t+" "+i)}}function Wl(t,e,n){if((e=Be(e))instanceof Gs)return e._internalPath;if(typeof e=="string")return id(t,e);throw ta("Field path arguments must be of type string or ",t,!1,void 0,n)}const ST=new RegExp("[~\\*/\\[\\]]");function id(t,e,n){if(e.search(ST)>=0)throw ta(`Invalid field path (${e}). Paths must not contain '~', '*', '/', '[', or ']'`,t,!1,void 0,n);try{return new Gs(...e.split("."))._internalPath}catch{throw ta(`Invalid field path (${e}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,t,!1,void 0,n)}}function ta(t,e,n,i,r){const s=i&&!i.isEmpty(),o=r!==void 0;let l=`Function ${e}() called with invalid data`;n&&(l+=" (via `toFirestore()`)"),l+=". ";let c="";return(s||o)&&(c+=" (found",s&&(c+=` in field ${i}`),o&&(c+=` in document ${r}`),c+=")"),new q(M.INVALID_ARGUMENT,l+t+c)}function wm(t,e){return t.some(n=>n.isEqual(e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function MT(t){t=Ht(t,xt);const e=Ht(t.firestore,Ii);return gT(ka(e),t._key).then(n=>FT(e,t,n))}class Im extends RT{constructor(e){super(),this.firestore=e}convertBytes(e){return new Ar(e)}convertReference(e){const n=this.convertDocumentKey(e,this.firestore._databaseId);return new xt(this.firestore,null,n)}}function DT(t){t=Ht(t,Aa);const e=Ht(t.firestore,Ii),n=ka(e),i=new Im(e);return kT(t._query),yT(n,t._query).then(r=>new PT(e,i,t,r))}function BT(t,e,n){t=Ht(t,xt);const i=Ht(t.firestore,Ii),r=rd(t.converter,e,n);return Ks(i,[td(Ra(i),"setDoc",t._key,r,t.converter!==null,n).toMutation(t._key,vt.none())])}function LT(t,e,n,...i){t=Ht(t,xt);const r=Ht(t.firestore,Ii),s=Ra(r);let o;return o=typeof(e=Be(e))=="string"||e instanceof Gs?ym(s,"updateDoc",t._key,e,n,i):gm(s,"updateDoc",t._key,e),Ks(r,[o.toMutation(t._key,vt.exists(!0))])}function NT(t){return Ks(Ht(t.firestore,Ii),[new _a(t._key,vt.none())])}function OT(t,e){const n=Ht(t.firestore,Ii),i=Sr(t),r=rd(t.converter,e);return Ks(n,[td(Ra(t.firestore),"addDoc",i._key,r,t.converter!==null,{}).toMutation(i._key,vt.exists(!1))]).then(()=>i)}function Ks(t,e){return function(i,r){const s=new On;return i.asyncQueue.enqueueAndForget(async()=>sT(await mT(i),r,s)),s.promise}(ka(t),e)}function FT(t,e,n){const i=n.docs.get(e._key),r=new Im(t);return new Tm(t,r,e._key,i,new as(n.hasPendingWrites,n.fromCache),e.converter)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */function xm(t){return ka(t=Ht(t,Ii)),new VT(t,e=>Ks(t,e))}(function(e,n=!0){(function(r){Mr=r})(Pr),vr(new Hi("firestore",(i,{instanceIdentifier:r,options:s})=>{const o=i.getProvider("app").getImmediate(),l=new Ii(new Ow(i.getProvider("auth-internal")),new $w(i.getProvider("app-check-internal")),function(d,f){if(!Object.prototype.hasOwnProperty.apply(d.options,["projectId"]))throw new q(M.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new Es(d.options.projectId,f)}(o,r),o);return s=Object.assign({useFetchStreams:n},s),l._setSettings(s),l},"PUBLIC").setMultipleInstances(!0)),gi(ih,"4.7.3",e),gi(ih,"4.7.3","esm2017")})();const Sm={apiKey:"AIzaSyBdbve0H70D-Ch69WlaxEly7PVBFVRB5p0",authDomain:"pensiontools-4b237.firebaseapp.com",projectId:"pensiontools-4b237",storageBucket:"pensiontools-4b237.firebasestorage.app",messagingSenderId:"760877353696",appId:"1:760877353696:web:2d6f7173c8d7fab6fd9e85"};function Fe(){return Sm.apiKey!=="YOUR_API_KEY"}let bl=null,ct=null,It=null;try{Fe()?(bl=vf(Sm),ct=Dw(bl),It=_T(bl)):console.warn("Firebase not configured. Login required to save data.")}catch(t){console.error("Firebase initialization error:",t)}const zT=new Rn;let at=null,ms=[];function $T(){if(!Fe()||!ct){console.warn("Firebase not configured - auth disabled");return}wb(ct,t=>{console.log("onAuthStateChanged fired:",t?t.email:"null"),at=t,console.log("Notifying",ms.length,"listeners"),ms.forEach(e=>e(t))})}function Am(t){return console.log("onAuthStateChange: adding listener, currentUser is:",at&&at.email),ms.push(t),at&&(console.log("onAuthStateChange: immediately calling listener with user"),t(at)),()=>{ms=ms.filter(e=>e!==t)}}function Kn(){return at}function dt(){return at!==null}async function UT(t,e,n=null){if(!Fe()||!ct)throw new Error("Firebase not configured");const i=await pb(ct,t,e);n&&i.user&&await yb(i.user,{displayName:n});try{await Wf(i.user)}catch(r){console.error("Failed to send verification email:",r)}return i}async function qT(){if(!Fe()||!ct||!at)throw new Error("Not logged in");return Wf(at)}async function HT(){return at?(await at.reload(),at=ct.currentUser,at):null}async function WT(t,e){if(!Fe()||!ct)throw new Error("Firebase not configured");return mb(ct,t,e)}async function YT(){if(!Fe()||!ct)throw new Error("Firebase not configured");console.log("Initiating Google sign-in popup...");try{const t=await Ub(ct,zT);return console.log("Google sign-in successful:",t.user.email),t}catch(t){throw console.error("signInWithPopup error:",t.code,t.message),t}}async function sd(){if(!Fe()||!ct)throw new Error("Firebase not configured");return _b(ct)}async function jT(t){if(!Fe()||!ct)throw new Error("Firebase not configured");return fb(ct,t)}async function GT(){if(!Fe()||!ct||!at)throw new Error("Not logged in");return Eb(at)}$T();function sr(...t){return t.find(e=>e!==void 0)}function KT(t){if(!t||typeof t!="object")return{scenario:t,migrated:!1};const e=Object.keys(t).filter(c=>c.includes(".")),n="decisionSettings"in t||"stressSettings"in t||"name"in t||"description"in t||"taxYears"in t;if(!(e.length>0||n))return{scenario:t,migrated:!1};const r=t.decisionTool||{},s=t.stressTool||{},o=t.planDetails||{},l={isActive:t.isActive??!1,enabledTools:t.enabledTools||["stress","decision"],planDetails:{name:sr(t["planDetails.name"],o.name,t.name)??"My Plan",description:sr(t["planDetails.description"],o.description,t.description)??""},decisionTool:{settings:sr(t["decisionTool.settings"],r.settings,t.decisionSettings)??{},history:sr(t["decisionTool.history"],r.history)??[],taxYears:sr(t["decisionTool.taxYears"],r.taxYears,t.taxYears)??{}},stressTool:{settings:sr(t["stressTool.settings"],s.settings,t.stressSettings)??{}}};return t.id!==void 0&&(l.id=t.id),t.createdAt!==void 0&&(l.createdAt=t.createdAt),t.lastModified!==void 0&&(l.lastModified=t.lastModified),{scenario:l,migrated:!0}}function od(t,e="settings"){const n=Kn();return!n||!It?null:Sr(It,"users",n.uid,t,e)}function km(t){const e=Kn();return!e||!It?null:wT(It,"users",e.uid,t)}async function Rm(t){const{scenario:e,migrated:n}=KT(t);if(n){const i=Kn();if(i&&It)try{const{id:r,...s}=e;await BT(Sr(It,"users",i.uid,"scenarios",r),s)}catch(r){console.error("Scenario migration write failed:",r)}}return e}async function Ma(){if(!Fe())return[];const t=km("scenarios");if(!t)return[];try{const e=await DT(t),n=[];return e.forEach(i=>{n.push({id:i.id,...i.data()})}),Promise.all(n.map(i=>Rm(i)))}catch(e){return console.error("Error loading scenarios:",e),[]}}async function QT(t){if(!Fe())return null;const e=od("scenarios",t);if(!e)return null;try{const n=await MT(e);return n.exists()?Rm({id:n.id,...n.data()}):null}catch(n){return console.error("Error loading scenario:",n),null}}async function xi(t,e){if(!Fe())return;const n=od("scenarios",t);if(n)try{await LT(n,{...e,lastModified:new Date().toISOString()})}catch(i){throw console.error("Error saving scenario:",i),i}}async function Pm(t){if(!Fe())return null;const e=km("scenarios");if(!e)return null;try{return(await OT(e,{...t,createdAt:new Date().toISOString(),lastModified:new Date().toISOString()})).id}catch(n){throw console.error("Error creating scenario:",n),n}}async function JT(t){if(!Fe())return;const e=od("scenarios",t);if(e)try{await NT(e)}catch(n){throw console.error("Error deleting scenario:",n),n}}async function ad(t){if(!Fe())return;const e=Kn();if(!(!e||!It))try{const n=await Ma(),i=xm(It);for(const r of n){const s=Sr(It,"users",e.uid,"scenarios",r.id);r.id===t?i.update(s,{isActive:!0}):r.isActive&&i.update(s,{isActive:!1})}await i.commit()}catch(n){throw console.error("Error setting active scenario:",n),n}}async function Cm(){if(!Fe())return;const t=Kn();if(!(!t||!It))try{const e=await Ma(),n=xm(It);for(const i of e)n.delete(Sr(It,"users",t.uid,"scenarios",i.id));n.delete(Sr(It,"users",t.uid,"profile","settings")),await n.commit(),console.log("All user data wiped successfully")}catch(e){throw console.error("Error wiping user data:",e),e}}async function Mm(){return Fe()?(await Ma()).length>0:!1}const Dm={single:{minimum:14400,moderate:31300,comfortable:43100}},Yl={essential:[{label:"Rent / mortgage",period:"mo",hint:"Your regular housing payment"},{label:"Council tax",period:"mo",hint:""},{label:"Gas",period:"mo",hint:""},{label:"Electricity",period:"mo",hint:""},{label:"Water",period:"mo",hint:""},{label:"Broadband",period:"mo",hint:"Broadband tariff"},{label:"Mobile phones",period:"mo",hint:"Mobile phone tariffs"},{label:"TV licence",period:"yr",hint:""},{label:"Groceries & household",period:"mo",hint:"Food and everyday household items"},{label:"Home insurance",period:"yr",hint:"Buildings & contents"},{label:"Car insurance",period:"yr",hint:""},{label:"Car tax",period:"yr",hint:"DVLA vehicle tax"},{label:"Petrol / fuel",period:"mo",hint:""},{label:"Car servicing & maintenance",period:"yr",hint:"Servicing, MOT, repairs — a big replacement is a One-off cost"},{label:"Boiler service",period:"yr",hint:""},{label:"Personal health",period:"mo",hint:"Prescriptions, dental, optical, health cover"},{label:"Kids / dependents",period:"mo",hint:"Supporting children or other dependents"},{label:"Premier banking / account fees",period:"mo",hint:"Packaged or premier account fees"},{label:"Home upkeep",period:"mo",hint:"Routine maintenance & small repairs — big jobs go in One-off costs"}],discretionary:[{label:"Main holiday",period:"yr",hint:"Your big annual holiday"},{label:"UK breaks",period:"yr",hint:"Weekends & short breaks"},{label:"Day trips",period:"mo",hint:""},{label:"Eating out & takeaways",period:"mo",hint:""},{label:"Streaming & entertainment",period:"mo",hint:"Netflix, Amazon Prime, etc."},{label:"Digital subscriptions",period:"mo",hint:"Cloud storage, AI tools, credit-file, TradingView, broker subscriptions"},{label:"Gym & fitness",period:"mo",hint:"Membership & classes"},{label:"Sports & equipment",period:"yr",hint:"Kit and gear"},{label:"Clothes",period:"mo",hint:"Everyday clothing"},{label:"Sports clothes",period:"yr",hint:""},{label:"Hobbies & leisure",period:"mo",hint:""},{label:"Gifts & family",period:"mo",hint:"Presents, helping family"},{label:"Charity",period:"mo",hint:""},{label:"Pets",period:"mo",hint:"Food, insurance, vet (pet health)"},{label:"Personal spending money",period:"mo",hint:"Day-to-day 'spends'"},{label:"Home furnishings & décor",period:"yr",hint:"Soft furnishings, decorating, furniture refresh"},{label:"Home technology",period:"yr",hint:"Phones, laptops, gadgets"},{label:"Emergency buffer",period:"mo",hint:"A monthly set-aside for the unexpected"}]},XT=[{label:"Eating out & takeaways",tier:"discretionary",period:"mo",hint:"Meals out, takeaways, coffees"},{label:"Life insurance / income protection",tier:"essential",period:"mo",hint:"Protection premiums"},{label:"Health / dental insurance",tier:"essential",period:"mo",hint:"Private medical, dental plan, cash plan"},{label:"Dental & optical",tier:"essential",period:"yr",hint:"Check-ups, glasses, treatment not on the NHS"},{label:"Hearing",tier:"essential",period:"yr",hint:"Hearing tests & aids"},{label:"Breakdown cover",tier:"essential",period:"yr",hint:"AA / RAC vehicle breakdown"},{label:"Parking & permits",tier:"essential",period:"yr",hint:"Residents permit, ULEZ / congestion"},{label:"Public transport",tier:"essential",period:"mo",hint:"Bus, rail, rail card"},{label:"Cleaner / gardener",tier:"essential",period:"mo",hint:"Cleaner, window cleaner, gardener"},{label:"Long-term care set-aside",tier:"essential",period:"mo",hint:"A monthly reserve toward possible later-life care (easily forgotten)"},{label:"Christmas & birthdays",tier:"discretionary",period:"yr",hint:"Seasonal gifts & celebrations"},{label:"Alcohol",tier:"discretionary",period:"mo",hint:"Beer, wine, spirits"},{label:"Hairdressing & grooming",tier:"discretionary",period:"mo",hint:"Haircuts, beauty, barber"},{label:"Newspapers, books & media",tier:"discretionary",period:"mo",hint:"Papers, magazines, books"},{label:"Grandchildren",tier:"discretionary",period:"mo",hint:"Treats, days out, help with costs"},{label:"Professional memberships",tier:"discretionary",period:"yr",hint:"Institutes, unions, clubs"},{label:"Second / holiday home",tier:"discretionary",period:"mo",hint:"Running costs of a second property"},{label:"Storage / lock-up",tier:"discretionary",period:"mo",hint:"Self-storage, garage rental"},{label:"My personal spending",tier:"discretionary",period:"mo",hint:"Your own day-to-day 'spends'",paidBy:"me"},{label:"Partner's personal spending",tier:"discretionary",period:"mo",hint:"Your partner's day-to-day 'spends'",paidBy:"partner"}];function Ss(t){const e=new Set((t.lines||[]).map(s=>(s.label||"").trim().toLowerCase()).filter(Boolean)),n=[...Yl.essential.map(s=>({...s,tier:"essential"})),...Yl.discretionary.map(s=>({...s,tier:"discretionary"}))],i=new Set,r=[];for(const s of[...XT,...n]){const o=s.label.trim().toLowerCase();e.has(o)||i.has(o)||(i.add(o),r.push(s))}return r}const ZT=[{label:"New car",tier:"essential",hint:"Replacement vehicle",everyYears:8},{label:"Redecorating",tier:"essential",hint:"Whole-house repaint — a 4-bed runs ~£2,000–3,500 professionally, ~£300–600 DIY",everyYears:7},{label:"Major home work",tier:"essential",hint:"Kitchen, bathroom, roof, windows",everyYears:null},{label:"White goods",tier:"essential",hint:"Fridge, washer, cooker",everyYears:10}],eI={"Council tax":{s:97,c:165},Gas:{s:54,c:71},Electricity:{s:69,c:81},Water:{s:30,c:40},Broadband:{s:28,c:33},"Mobile phones":{s:15,c:30},"TV licence":{s:14,c:14},"Groceries & household":{s:180,c:320},"Home insurance":{s:20,c:28},"Car insurance":{s:26,c:37},"Car tax":{s:16,c:16},"Petrol / fuel":{s:38,c:82},"Car servicing & maintenance":{s:30,c:60},"Boiler service":{s:10,c:12},"Personal health":{s:15,c:40},"Home upkeep":{s:36,c:72},"Main holiday":{s:70,c:145},"UK breaks":{s:30,c:56},"Day trips":{s:20,c:30},"Eating out & takeaways":{s:40,c:110},"Streaming & entertainment":{s:15,c:20},"Digital subscriptions":{s:10,c:15},"Gym & fitness":{s:25,c:45},"Sports & equipment":{s:10,c:15},Clothes:{s:25,c:46},"Sports clothes":{s:5,c:8},"Hobbies & leisure":{s:20,c:30},"Gifts & family":{s:40,c:60},Charity:{s:10,c:15},Pets:{s:25,c:25},"Personal spending money":{s:30,c:50},"Home furnishings & décor":{s:30,c:50},"Home technology":{s:20,c:30},Alcohol:{s:18,c:53},"Hairdressing & grooming":{s:13,c:16},"Newspapers, books & media":{s:20,c:28},"Life insurance / income protection":{s:24,c:24},"Health / dental insurance":{s:10,c:17},"Dental & optical":{s:15,c:25},"Public transport":{s:29,c:55},"Christmas & birthdays":{s:30,c:50},"My personal spending":{s:30,c:30},"Partner's personal spending":{s:0,c:30}};function Lr(t,e){const n=eI[(t||"").trim()];return n?e&&e.sharedWithPartner?n.c:n.s:null}function Bm(){const t=e=>Yl[e].map(n=>({label:n.label,tier:e,annual:null,fromAge:null,toAge:null,hint:n.hint,period:n.period||"yr"}));return[...t("essential"),...t("discretionary")]}function Lm(){return ZT.map(t=>({label:t.label,tier:t.tier,hint:t.hint,amount:null,atAge:null,everyYears:t.everyYears}))}const Mo={pa:12570,brl:50270,hrl:125140},St=t=>Number.isFinite(+t)?+t:0;function tI(t,e){const n=t.fromAge??e.retirementAge,i=t.toAge??e.endAge;return{from:St(n),to:St(i)}}function Nm(t,e,n){const{from:i,to:r}=tI(t,e);return n>=i&&n<=r}function jl(t,e,n="all"){return(t.lines||[]).filter(i=>n==="all"||i.tier===n).filter(i=>Nm(i,t,e)).reduce((i,r)=>i+St(r.annual),0)}function Om(t,e){if(!e||!e.sharedWithPartner)return 1;const n=t&&t.paidBy||"me";if(n==="partner")return 0;if(n==="shared"){const i=t&&t.mySharePct,r=i!=null&&i!==""&&Number.isFinite(+i)?+i:Number.isFinite(+e.mySharePct)?+e.mySharePct:50;return Math.max(0,Math.min(1,r/100))}return 1}function Vh(t,e,n="all"){return(t.lines||[]).filter(i=>n==="all"||i.tier===n).filter(i=>Nm(i,t,e)).reduce((i,r)=>i+St(r.annual)*Om(r,t),0)}function nI(t){return jl(t,St(t.retirementAge),"all")}function Da(t,e=Mo){const n=St(t),{pa:i,brl:r,hrl:s}=e;if(n<=i)return n;const o=r-.2*(r-i);if(n<=o)return i+(n-i)/.8;const l=o+.6*(s-r);return n<=l?r+(n-o)/.6:s+(n-l)/.55}function zh(t,e=!1){return(t.oneOffs||[]).reduce((n,i)=>{const r=St(i.amount),s=St(i.everyYears);return s>0&&r?n+r/s*(e?Om(i,t):1):n},0)}function Nr(t){const e=St(t.retirementAge),n=Vh(t,e,"essential"),i=Vh(t,e,"all"),r=zh(t,!0),s=i+r,o=nI(t)+zh(t,!1),l=Math.max(0,o-s);return{partnerAllInAnnual:l,partnerAllInMonthly:l/12,essentialAnnualNet:n,comfortableAnnualNet:i,essentialMonthlyNet:n/12,comfortableMonthlyNet:i/12,periodicAnnualAverage:r,periodicMonthlyAverage:r/12,allInComfortableAnnual:s,allInComfortableMonthly:s/12,householdComfortableAnnual:o,householdComfortableMonthly:o/12,sharedWithPartner:!!t.sharedWithPartner,suggestedGrossAnnual:Da(s)}}function Ba(t){if(t==null)return null;const e=String(t).trim().replace(/^=/,"").replace(/[×x]/gi,"*").replace(/,/g,"");if(!e||!/^[\d+\-*/().\s]+$/.test(e)||!/\d/.test(e))return null;try{const n=Function('"use strict"; return ('+e+");")();return Number.isFinite(n)?Math.round(n*100)/100:null}catch{return null}}function Fm(t){return(t||[]).reduce((e,n)=>{const i=St(n&&n.amount);return i?e+((n.period||"yr")==="mo"?i*12:i):e},0)}function Vm(t,e,n){const i=Lr(t,n),r=St(e);if(i==null||i<=0||r<=0)return null;const s=i*12;return r<=s*.35?"low":r>=s*3?"high":null}function As(t=45,e=60,n=100){return{version:1,currentAge:St(t),retirementAge:St(e),endAge:St(n),sharedWithPartner:!1,mySharePct:50,lines:[],oneOffs:[]}}let mr=null,Re=null;function Si(){return Fe()&&dt()}function yn(){mr=null,Re=null}function ld(){return{equityMin:ye.EQUITY_MIN,bondMin:ye.BOND_MIN,cashTarget:ye.CASH_TARGET,duration:ye.DURATION_YEARS,baseSalary:ye.BASE_SALARY,other:0,statePension:12e3,statePensionYear:12,pa:Ye.PERSONAL_ALLOWANCE,brl:Ye.BASIC_RATE_LIMIT,hrl:Ye.HIGHER_RATE_LIMIT,taxMode:"inflates",protectionMult:Vi.PROTECTION_MULTIPLIER,consecutiveLimit:ye.CONSECUTIVE_LIMIT,disableProtection:!1,hodlEnabled:Vi.HODL_ENABLED,hodlValue:Vi.HODL_VALUE,isaBalance:0,isaReturn:Jt.RETURN,isaMin:Jt.MIN,isaDrawdownStrategy:Jt.DRAWDOWN_STRATEGY}}function zm(){return{equityMin:ye.EQUITY_MIN,bondMin:ye.BOND_MIN,cashTarget:ye.CASH_TARGET,duration:ye.DURATION_YEARS,baseSalary:ye.BASE_SALARY,protectionFactor:ye.PROTECTION_FACTOR,recoveryBuffer:ye.RECOVERY_BUFFER,consecutiveLimit:ye.CONSECUTIVE_LIMIT,spStartDate:null,spWeeklyAmount:0,statePension:0,statePensionYear:0,isaBalance:0,isaReturn:Jt.RETURN,isaMin:Jt.MIN,isaDrawdownStrategy:Jt.DRAWDOWN_STRATEGY}}function iI(t,e={},n=new Date().toISOString()){const i=t||{};return{...ld(),...e,equityMin:i.equityMin,bondMin:i.bondMin,cashTarget:i.cashTarget,duration:i.duration,baseSalary:i.baseSalary,spStartDate:i.spStartDate??e.spStartDate??null,spWeeklyAmount:i.spWeeklyAmount??e.spWeeklyAmount??0,consecutiveLimit:i.consecutiveLimit,recoveryBuffer:i.recoveryBuffer,protectionMult:i.protectionFactor!=null?1-i.protectionFactor/100:e.protectionMult??Vi.PROTECTION_MULTIPLIER,isaBalance:i.isaBalance??0,isaReturn:i.isaReturn??Jt.RETURN,isaMin:i.isaMin??Jt.MIN,isaDrawdownStrategy:i.isaDrawdownStrategy??Jt.DRAWDOWN_STRATEGY,seededFrom:"decision",seededAt:n,decisionChecksum:da(i)}}function $m(){return{}}function Um(){return As()}function rI(t="My Plan",e="",n=["stress","decision"]){return{planDetails:{name:t,description:e},enabledTools:n,isActive:!0,decisionTool:{settings:zm(),history:[],taxYears:$m()},stressTool:{settings:ld()},budgetTool:{settings:Um()}}}async function cd(){if(mr)return mr;if(!Si())return[];try{const t=await Ma();return mr=t,t}catch(t){return console.error("Error listing scenarios:",t),[]}}async function Bt(){if(Re)return Re;if(!Si())return null;try{const e=(await cd()).find(n=>n.isActive);return e?(Re=e,e):null}catch(t){return console.error("Error getting active scenario:",t),null}}async function sI(t,e,n,i={},r=!0){if(!Si())throw new Error("Must be logged in to create scenarios");const s=rI(t,e,n);if(i.stressSettings&&(s.stressTool.settings={...s.stressTool.settings,...i.stressSettings}),i.decisionSettings&&(s.decisionTool.settings={...s.decisionTool.settings,...i.decisionSettings}),i.taxYears&&(s.decisionTool.taxYears=i.taxYears),s.isActive=r,r&&mr){const l=mr.find(c=>c.isActive);l&&(await ad(null),await xi(l.id,{isActive:!1}))}const o=await Pm(s);return yn(),o}async function oI(t){if(!Si())throw new Error("Must be logged in to switch scenarios");await ad(t),yn()}async function aI(t,e){if(!Si())throw new Error("Must be logged in to duplicate scenarios");const n=await QT(t);if(!n)throw new Error("Source scenario not found");const{id:i,createdAt:r,lastModified:s,...o}=n;o.planDetails={...o.planDetails,name:e},o.isActive=!1;const l=await Pm(o);return yn(),l}async function lI(t,e){if(!Si())throw new Error("Must be logged in to rename scenarios");await xi(t,{"planDetails.name":e}),yn()}async function cI(t,e){if(!Si())throw new Error("Must be logged in to update scenarios");await xi(t,{enabledTools:e}),yn()}async function dI(t){if(!Si())throw new Error("Must be logged in to delete scenarios");const e=await cd();if(e.length<=1)throw new Error("Cannot delete the last scenario");const n=e.find(i=>i.id===t);if(n!=null&&n.isActive){const i=e.find(r=>r.id!==t);i&&await ad(i.id)}await JT(t),yn()}async function uI(){var e;const t=await Bt();return((e=t==null?void 0:t.stressTool)==null?void 0:e.settings)||ld()}async function qm(t){const e=await Bt();if(!e)throw new Error("No active scenario");await xi(e.id,{"stressTool.settings":t}),Re&&(Re.stressTool||(Re.stressTool={}),Re.stressTool.settings=t)}async function hI(){var e;const t=await Bt();return((e=t==null?void 0:t.decisionTool)==null?void 0:e.settings)||zm()}async function fI(t){const e=await Bt();if(!e)throw new Error("No active scenario");await xi(e.id,{"decisionTool.settings":t}),Re&&(Re.decisionTool||(Re.decisionTool={}),Re.decisionTool.settings=t)}async function pI(){var e;const t=await Bt();return((e=t==null?void 0:t.budgetTool)==null?void 0:e.settings)||Um()}async function mI(t){const e=await Bt();if(!e)throw new Error("No active scenario");await xi(e.id,{"budgetTool.settings":t}),Re&&(Re.budgetTool||(Re.budgetTool={}),Re.budgetTool.settings=t)}async function gI(){var e;const t=await Bt();return((e=t==null?void 0:t.decisionTool)==null?void 0:e.taxYears)||$m()}async function yI(t){const e=await Bt();if(!e)throw new Error("No active scenario");await xi(e.id,{"decisionTool.taxYears":t}),Re&&(Re.decisionTool||(Re.decisionTool={}),Re.decisionTool.taxYears=t)}async function vI(){var e;const t=await Bt();return((e=t==null?void 0:t.decisionTool)==null?void 0:e.history)||[]}async function Hm(t){const e=await Bt();if(!e)throw new Error("No active scenario");await xi(e.id,{"decisionTool.history":t}),Re&&(Re.decisionTool||(Re.decisionTool={}),Re.decisionTool.history=t)}async function Wm(){const t=await Bt();return(t==null?void 0:t.enabledTools)||["stress","decision"]}let vi=null;function Do(){return{settings:{equityMin:ye.EQUITY_MIN,bondMin:ye.BOND_MIN,cashTarget:ye.CASH_TARGET,duration:ye.DURATION_YEARS,equityGlideEnabled:!1,locked:!1,baseSalary:ye.BASE_SALARY,spendingProfile:"flat",protectionFactor:ye.PROTECTION_FACTOR,recoveryBuffer:ye.RECOVERY_BUFFER,consecutiveLimit:ye.CONSECUTIVE_LIMIT,startDate:null,spStartDate:null,spWeeklyAmount:0,statePension:0,statePensionYear:0},taxYears:{},history:[],lastModified:null,checksum:null}}function La(){return Fe()&&dt()}function Ei(){vi=null}function Ym(){return vi||Do()}async function vn(){if(vi)return vi;if(!La())return console.warn("Firebase not available - returning defaults"),Do();try{const[t,e,n]=await Promise.all([hI(),gI(),vI()]),i={settings:t||Do().settings,taxYears:e||{},history:n||[],lastModified:new Date().toISOString(),checksum:null};return i.checksum=jm(i),vi=i,i}catch(t){console.error("Error loading decision data:",t)}return Do()}async function Na(t){if(!La())throw new Error("Must be logged in to save data");try{t.lastModified=new Date().toISOString(),t.checksum=jm(t),await Promise.all([fI(t.settings),yI(t.taxYears)]),vi=t}catch(e){throw console.error("Error saving decision data:",e),new Error("Failed to save decision data")}}function jm(t){const e={settings:t.settings,taxYears:t.taxYears,historyCount:t.history.length,lastHistoryDate:t.history.length>0?t.history[t.history.length-1].date:null};return da(e)}function Gm(t){if(!t)return"";const{locked:e,...n}=t;return da(n)}async function bt(){return(await vn()).settings}async function Qs(t){const e=await vn();e.settings={...e.settings,...t},await Na(e)}function dd(){return{pa:Ye.PERSONAL_ALLOWANCE,brl:Ye.BASIC_RATE_LIMIT,hrl:Ye.HIGHER_RATE_LIMIT,cpi:.04,other:0,isaSavingsAllocation:0,isaSavingsUsed:0,isaContribution:0,isTaxEfficient:!0,taxEfficiencyChoice:null,grossIncomeToDate:0,startMonth:4,yearSetupComplete:!1,confirmedSalary:null}}function bI(t){const n=Ym().taxYears[t];return n||dd()}async function Oa(t){const n=(await vn()).taxYears[t];return n||dd()}async function er(t,e){console.log(`saveTaxYearConfig: Saving tax year ${t}`,e);const n=await vn();n.taxYears[t]={...bI(t),...e},await Na(n),console.log(`saveTaxYearConfig: Saved tax year ${t}, yearSetupComplete=${n.taxYears[t].yearSetupComplete}`)}async function wI(t){const e=vi||await vn(),n=(e.history||[]).filter(r=>r.taxYear===t),i=n.reduce((r,s)=>r+(s.isa||0),0);return console.log(`recalculateIsaSavingsUsed: Tax year ${t}, found ${n.length} records, total ISA used: ${i}`),console.log("recalculateIsaSavingsUsed: History records:",n.map(r=>({date:r.date,isa:r.isa}))),e.taxYears[t]||(console.log(`recalculateIsaSavingsUsed: No existing config for ${t}, creating default`),e.taxYears[t]=dd()),console.log(`recalculateIsaSavingsUsed: Before update, isaSavingsUsed=${e.taxYears[t].isaSavingsUsed}`),e.taxYears[t].isaSavingsUsed=i,console.log(`recalculateIsaSavingsUsed: After update, isaSavingsUsed=${e.taxYears[t].isaSavingsUsed}`),await Na(e),console.log("recalculateIsaSavingsUsed: Saved to Firebase"),i}async function _I(t){const e=await Oa(t),n=e.yearSetupComplete===!0;return console.log(`isYearSetupComplete: Tax year ${t}, yearSetupComplete=${e.yearSetupComplete}, result=${n}`),n}async function Qn(){return(await vn()).taxYears}function EI(t={}){let n=[...Ym().history];return t.taxYear&&(n=n.filter(i=>i.taxYear===t.taxYear)),t.startDate&&(n=n.filter(i=>i.date>=t.startDate)),t.endDate&&(n=n.filter(i=>i.date<=t.endDate)),t.sortDesc?n.sort((i,r)=>r.date.localeCompare(i.date)):n.sort((i,r)=>i.date.localeCompare(r.date)),t.limit&&(n=n.slice(0,t.limit)),n}async function tr(t={}){return await vn(),EI(t)}async function TI(t){if(!La())throw new Error("Must be logged in to save history");const e=await vn(),n=e.history.findIndex(i=>i.date===t.date);n>=0?e.history[n]=t:e.history.push(t),e.history.sort((i,r)=>i.date.localeCompare(r.date)),await Hm(e.history)}async function Km(t){if(!La())throw new Error("Must be logged in to delete history");const e=await vn();e.history=e.history.filter(n=>n.date!==t),await Hm(e.history)}async function ud(t){const e=await bt(),n=await Qn(),i=e.spStartDate,r=e.spWeeklyAmount||0;if(!i||!r){let f=null;if(i){const{formatStatePensionDate:m}=await Su(async()=>{const{formatStatePensionDate:p}=await Promise.resolve().then(()=>Hh);return{formatStatePensionDate:p}},void 0,import.meta.url);f=m(i)}return{amount:0,monthly:0,yearsUntil:0,isReceiving:!1,isFirstYear:!1,startDate:f}}const{calculateStatePensionForTaxYear:s,getTimeUntilStatePension:o,parseStatePensionDate:l}=await Su(async()=>{const{calculateStatePensionForTaxYear:f,getTimeUntilStatePension:m,parseStatePensionDate:p}=await Promise.resolve().then(()=>Hh);return{calculateStatePensionForTaxYear:f,getTimeUntilStatePension:m,parseStatePensionDate:p}},void 0,import.meta.url),c=s({taxYear:t,spStartDate:i,weeklyAmount:r,taxYearConfigs:n}),d=o(i);return{amount:c.annual,monthly:c.monthly,yearsUntil:d.years,monthsUntil:d.months,isReceiving:c.isReceiving,isFirstYear:c.isFirstYear,weeksInYear:c.weeksInYear,startDate:c.startDate}}async function II(t){const e=py(t);e.stdSipp=t.stdSipp||t.sippDraw;try{const n=await bt();e.settingsChecksum=Gm(n)}catch(n){console.warn("Could not stamp settings checksum on decision:",n)}await TI(e),t.taxYear&&await wI(t.taxYear)}const Gl={CONSECUTIVE_LIMIT:3,RECOVERY_BUFFER:1e4};function Qm({totalGrowth:t,minGrowth:e,consecCashDraws:n,wasInProtection:i,consecutiveLimit:r=Gl.CONSECUTIVE_LIMIT,recoveryBuffer:s=Gl.RECOVERY_BUFFER}){let o=!1;return i&&(o=t<=e+s),!o&&t<e&&n+1>=r&&(o=!0),o}const na={MAX_FRACTION:.5,MIN_BOOST:50,SURPLUS_BUFFER:15e3};function Jm({shortfall:t,standardMonthly:e,remainingMonths:n,surplus:i,brlHeadroom:r=1/0,maxFraction:s=na.MAX_FRACTION,minBoost:o=na.MIN_BOOST}){if(!(t>0)||!(i>0)||n<1)return 0;const l=[t/n,i/n];if(Number.isFinite(r)){if(r<=0)return 0;l.push(r/n)}l.push(e*s);const c=Math.min(...l);return c>o?c:0}const me=Object.freeze({SHARES:"shares",BONDS:"bonds",DIVERSIFIERS:"diversifiers",CASH:"cash"}),Ut=Object.freeze({ukEquityIncome:{bucket:me.SHARES,label:"UK equity income",nominalReturn:.068,yield:.04,vol:.16,eqCorr:.9,duration:0,inflationBeta:0,creditBeta:0,crisisBeta:0,idioVol:.07},globalEquityIncome:{bucket:me.SHARES,label:"Global equity income",nominalReturn:.07,yield:.03,vol:.16,eqCorr:.95,duration:0,inflationBeta:0,creditBeta:0,crisisBeta:0,idioVol:.05},worldGrowth:{bucket:me.SHARES,label:"World growth / tracker",nominalReturn:.07,yield:.02,vol:.17,eqCorr:1,duration:0,inflationBeta:0,creditBeta:0,crisisBeta:0,idioVol:0},reit:{bucket:me.SHARES,label:"Property / REITs",nominalReturn:.065,yield:.045,vol:.19,eqCorr:.65,duration:4,inflationBeta:.3,creditBeta:.2,crisisBeta:0,idioVol:.13,note:"listed property: equity-like with rate sensitivity; rents partly inflation-linked"},emEquity:{bucket:me.SHARES,label:"Emerging-markets equity",nominalReturn:.075,yield:.028,vol:.22,eqCorr:.8,duration:0,inflationBeta:0,creditBeta:0,crisisBeta:0,idioVol:.13},globalSmallCap:{bucket:me.SHARES,label:"Global smaller companies",nominalReturn:.075,yield:.018,vol:.2,eqCorr:.9,duration:0,inflationBeta:0,creditBeta:0,crisisBeta:0,idioVol:.09},shortGilts:{bucket:me.BONDS,label:"Short gilts 0-5y (buffer)",nominalReturn:.043,yield:.043,vol:.026,eqCorr:.1,duration:2.5,inflationBeta:0,creditBeta:0,crisisBeta:0,idioVol:.01},longGilts:{bucket:me.BONDS,label:"Long gilts 15y+",nominalReturn:.064,yield:.055,vol:.108,eqCorr:.2,duration:15,inflationBeta:0,creditBeta:0,crisisBeta:0,idioVol:.02},indexLinked:{bucket:me.BONDS,label:"Index-linked gilts (long)",nominalReturn:.047,yieldReal:.023,vol:.1,eqCorr:.33,duration:15,inflationBeta:1,creditBeta:0,crisisBeta:0,idioVol:.03,realYield:!0},corporateIG:{bucket:me.BONDS,label:"£ IG corporate",nominalReturn:.053,yield:.052,vol:.065,eqCorr:.41,duration:6.5,inflationBeta:0,creditBeta:.4,crisisBeta:0,idioVol:.03},globalAggHedged:{bucket:me.BONDS,label:"Global-agg £-hedged",nominalReturn:.045,yield:.045,vol:.053,eqCorr:.3,duration:6,inflationBeta:0,creditBeta:.2,crisisBeta:0,idioVol:.02},usTreasHedged:{bucket:me.BONDS,label:"US treasuries £-hedged",nominalReturn:.04,yield:.04,vol:.068,eqCorr:.1,duration:7,inflationBeta:0,creditBeta:0,crisisBeta:.15,idioVol:.02},infraDebt:{bucket:me.BONDS,label:"Infrastructure debt",nominalReturn:.064,yield:.06,vol:.07,eqCorr:.3,duration:8,inflationBeta:.3,creditBeta:.3,crisisBeta:0,idioVol:.03,note:"IG + ~115bps illiquidity premium"},highYield:{bucket:me.BONDS,label:"Global high-yield (£-hedged)",nominalReturn:.058,yield:.065,vol:.1,eqCorr:.6,duration:3.5,inflationBeta:0,creditBeta:.8,crisisBeta:0,idioVol:.05,note:"credit carry net of defaults; spreads blow out with equities in a crash"},moneyMarket:{bucket:me.CASH,label:"Money-market fund",nominalReturn:.034,yield:.034,vol:.002,eqCorr:0,duration:.1,inflationBeta:0,creditBeta:0,crisisBeta:0,idioVol:0,note:"FCA -1% real; = engine cash model"},savings:{bucket:me.CASH,label:"Savings / NS&I",nominalReturn:.034,yield:.034,vol:.001,eqCorr:0,duration:0,inflationBeta:0,creditBeta:0,crisisBeta:0,idioVol:0},gold:{bucket:me.DIVERSIFIERS,label:"Gold",nominalReturn:.055,yield:0,vol:.155,eqCorr:.05,duration:0,inflationBeta:.3,creditBeta:0,crisisBeta:.5,idioVol:.14,note:"near-uncorrelated; rises when stocks AND bonds fall (2022)"},trendMacro:{bucket:me.DIVERSIFIERS,label:"Trend / macro",nominalReturn:.045,yield:0,vol:.12,eqCorr:.07,duration:0,inflationBeta:0,creditBeta:0,crisisBeta:0,momentumBeta:.6,idioVol:.1,note:"lagged path-momentum; pays in prolonged 2008/2022, whipsaws in V-shaped 2020"},commodities:{bucket:me.DIVERSIFIERS,label:"Broad commodities",nominalReturn:.045,yield:0,vol:.16,eqCorr:.25,duration:0,inflationBeta:.8,creditBeta:0,crisisBeta:0,idioVol:.14,note:"the strongest inflation hedge (2022); long flat stretches otherwise; crashes WITH equities in a demand shock (2008)"}}),Fa=Object.freeze([{ticker:"VWRL",name:"Vanguard FTSE All-World (Dist)",subClass:"worldGrowth"},{ticker:"VWRP",name:"Vanguard FTSE All-World (Acc)",subClass:"worldGrowth"},{ticker:"VEVE",name:"Vanguard FTSE Developed World",subClass:"worldGrowth"},{ticker:"SWDA",name:"iShares Core MSCI World",subClass:"worldGrowth"},{ticker:"HMWO",name:"HSBC MSCI World",subClass:"worldGrowth"},{ticker:"VUSA",name:"Vanguard S&P 500",subClass:"worldGrowth"},{ticker:"PACW",name:"Amundi Prime All Country World",subClass:"worldGrowth"},{ticker:"CTY",name:"City of London Investment Trust",subClass:"ukEquityIncome"},{ticker:"LWDB",name:"Law Debenture Corporation",subClass:"ukEquityIncome"},{ticker:"FGT",name:"Finsbury Growth & Income Trust",subClass:"ukEquityIncome"},{ticker:"MRCH",name:"Merchants Trust",subClass:"ukEquityIncome"},{ticker:"ISF",name:"iShares Core FTSE 100",subClass:"ukEquityIncome"},{ticker:"VUKE",name:"Vanguard FTSE 100",subClass:"ukEquityIncome"},{ticker:"UKW",name:"Greencoat UK Wind",subClass:"ukEquityIncome"},{ticker:"HICL",name:"HICL Infrastructure",subClass:"ukEquityIncome"},{ticker:"TRIG",name:"The Renewables Infrastructure Group",subClass:"ukEquityIncome"},{ticker:"MYI",name:"Murray International Trust",subClass:"globalEquityIncome"},{ticker:"VHYL",name:"Vanguard FTSE All-World High Div Yld",subClass:"globalEquityIncome"},{ticker:"JGGI",name:"JPMorgan Global Growth & Income",subClass:"globalEquityIncome"},{ticker:"IGLS",name:"iShares UK Gilts 0-5yr",subClass:"shortGilts"},{ticker:"IGLT",name:"iShares Core UK Gilts",subClass:"longGilts"},{ticker:"VGOV",name:"Vanguard UK Gilt",subClass:"longGilts"},{ticker:"INXG",name:"iShares £ Index-Linked Gilts",subClass:"indexLinked"},{ticker:"TI5G",name:"iShares $ TIPS 0-5 (GBP Hedged)",subClass:"indexLinked"},{ticker:"SLXX",name:"iShares Core £ Corp Bond",subClass:"corporateIG"},{ticker:"VAGP",name:"Vanguard Global Aggregate Bond (GBP Hedged)",subClass:"globalAggHedged"},{ticker:"IBTM",name:"iShares $ Treasury Bond 7-10yr",subClass:"usTreasHedged"},{ticker:"SEQI",name:"Sequoia Economic Infrastructure",subClass:"infraDebt"},{ticker:"CSH2",name:"Amundi Smart Overnight Return",subClass:"moneyMarket"},{ticker:"ERNS",name:"iShares £ Ultrashort Bond",subClass:"moneyMarket"},{ticker:"SGLN",name:"iShares Physical Gold",subClass:"gold"},{ticker:"PHGP",name:"WisdomTree Physical Gold (GBP)",subClass:"gold"},{ticker:"BHMG",name:"BH Macro",subClass:"trendMacro"},{ticker:"CGT",name:"Capital Gearing Trust",subClass:"trendMacro"},{ticker:"PNL",name:"Personal Assets Trust",subClass:"trendMacro"},{ticker:"RICA",name:"Ruffer Investment Company",subClass:"trendMacro"}]),Xm=Object.freeze(Object.fromEntries(Fa.map(t=>[t.ticker,t.subClass])));function hd(t){const e=(t||"").toUpperCase().trim();return Fa.find(n=>n.ticker===e)||null}function xI(){const t={};for(const[e,n]of Object.entries(Ut))(t[n.bucket]=t[n.bucket]||[]).push({key:e,label:n.label});return t}const SI=.036,AI=.4,kI=.005,RI=.35,Zm=.01,fd=-.15,eg=.045;function $h(t,e=.1){let n=SI+AI*t;return e<fd&&t<eg&&(n-=Zm),n}function Uh(t,e=.1){let n=kI+RI*(t-.025);return e<fd&&t<eg&&(n-=Zm),n}function PI(t){return t.inf>.045?"inflation":t.eqReturn<fd?"crash":"normal"}const CI=Object.freeze({shortGilts:{normal:.05,inflation:.3,crash:-.2},longGilts:{normal:.1,inflation:.45,crash:-.35},indexLinked:{normal:.15,inflation:.35,crash:-.15},corporateIG:{normal:.35,inflation:.45,crash:.55},globalAggHedged:{normal:.25,inflation:.4,crash:.1},usTreasHedged:{normal:.05,inflation:.25,crash:-.4},infraDebt:{normal:.3,inflation:.35,crash:.35},gold:{normal:0,inflation:-.05,crash:-.2},trendMacro:{normal:.05,inflation:-.1,crash:-.3},highYield:{normal:.5,inflation:.55,crash:.6},commodities:{normal:.2,inflation:-.1,crash:.4}});function Va(t,e){const n=CI[t];if(!n)return 0;const i=n[PI(e)];return i??n.normal}const MI=new Map(Object.entries(Ut).map(([t,e])=>[e,t]));function za(t,e,n,i){if(!t)return 0;const r=(n-.1)/.17,s=or(0,1,i),o=e*r+Math.sqrt(Math.max(0,1-e*e))*s;return t*o}function DI(t,e,n){const{inf:i,prevInf:r,eqReturn:s,prevEqReturn:o=.1}=e,l=!!t.realYield,c=t.duration||0,d=l?Uh(i,s)-Uh(r,o):$h(i,s)-$h(r,o),f=l?(t.yieldReal||0)+i:t.yield||0,m=-c*d,p=l?0:(t.inflationBeta||0)*(i-.025),w=za(t.idioVol||0,Va(MI.get(t),e),s,n);return f+m+p+w}const BI=Object.freeze({shortGilts:.3,longGilts:.2,indexLinked:.2,corporateIG:.3});function LI(t,e,n=BI){let i=0;for(const r of Object.keys(n)){const s=n[r];if(!s)continue;const o=Ut[r];o&&(i+=s*DI(o,t,e))}return i}const NI=.048,OI=.045;function FI(t,e){const{inf:n,eqReturn:i}=t,r=Ut.gold,s=(r.inflationBeta||0)*(n-.025),o=za(r.idioVol||0,Va("gold",t),i,e);return NI+s+o}function VI(t,e,n){const i=Ut.trendMacro,r=t.eqReturn-.05,s=(i.momentumBeta||0)*n*r,o=za(i.idioVol||0,Va("trendMacro",t),t.eqReturn,e);return OI+s+o}const qh=.6,zI=.15;function $I(t,e){return qh*t+(1-qh)*e}function UI(t){return Math.max(-1,Math.min(1,t/zI))}const qI=.035;function HI(t,e){const{inf:n}=t,i=Ut.commodities,r=(i.inflationBeta||0)*(n-.025),s=za(i.idioVol||0,Va("commodities",t),t.eqReturn,e);return qI+r+s}const WI=Object.freeze({gold:.5,trendMacro:.5});function YI(t,e,n,i=WI){let r=0;return i.gold&&(r+=i.gold*FI(t,e)),i.trendMacro&&(r+=i.trendMacro*VI(t,e,n)),i.commodities&&(r+=i.commodities*HI(t,e)),r}const jI=-.01,GI=5;function tg(t){return Math.max(0,t+jI)}function kr(t,e,n=0){const i=hc(n);let r=t.equityStart,s=t.bondStart,o=t.cashStart,l=t.hodlEnabled?t.hodlStart!==void 0?t.hodlStart:t.hodlValue:0,c=0,d=t.diversifierStart||0,f=0,m=0,p=0,w=t.isaBalance||0,x=null;const I=t.isaBalance||0,A=Math.max(1e3,I*.05);let R=null,C=0,L=0;const N=new Array(t.years+1).fill(null),z=new Array(t.years+1).fill(null);let $=0,T=0,y=0,_=0,b=!1,E=!1,S=null,v=0,le=0,pe=-1;const H=[],ee=t.trace?[]:null,ne=[];let te=1;H.push({year:0,month:0,equity:r,bond:s,cash:o,hodl:l,total:r+s+o,draw:0,source:"None",inProtection:!1,equityMin:t.equityMin,bondMin:t.bondMin,cashMax:t.cashTarget});for(let se=0;se<t.years*12;se++){const ce=Math.floor(se/12),xe=se%12,Xn=ce;if(Xn!==pe&&(v=0,le=0,pe=Xn),se>0&&se%12===0){const ie=e.inflation[ce]||.025;ne.push(ie),te*=1+ie}const ut=ca(t.equityGlide,ce,t.duration);if(ut!=null&&xe===0){const ie=r+s;ie>0&&(r=ie*ut,s=ie*(1-ut))}d>0&&xe===0&&(ce>0&&(m=$I(m,e.equity[ce-1]||0)),p=UI(m));const ht=e.equity[ce]||0,en=e.inflation[ce]||.025,Ot=ce>0?e.inflation[ce-1]||.025:en;let et=Ln(t.equityMin,ce,t.duration,te,!0),ft=Ln(t.bondMin,ce,t.duration,te,!0);if(ut!=null){const ie=et+ft;et=ie*ut,ft=ie*(1-ut)}const bn=Ln(t.cashTarget,ce,t.duration,te,!1),wn=et+ft,tn=b;b=t.disableProtection?!1:Qm({totalGrowth:r+s,minGrowth:wn,consecCashDraws:_,wasInProtection:tn,consecutiveLimit:t.consecutiveLimit,recoveryBuffer:t.recoveryBuffer??Gl.RECOVERY_BUFFER}),b?($++,y++):(T=Math.max(T,y),y=0);const{sippMonthly:_n,isaMonthly:Wt,planInputs:_t,taxAnnual:Zn,higherRate:nn}=ZI(t,ce,te,ne,w);xe===0&&(N[ce]=w/te,z[ce]=(r+s+o+d)/te),L+=Zn/12/te,nn&&C++;const Yt=_n,En=Yt;let Ee=b?Yt*t.protectionMult:Yt,fe=Ee;const rn=Wt,sn=ee?{month:se,year:ce,monthInYear:xe,cumInf:te,equityStart:r,bondStart:s,cashStart:o,isaStart:w,sippMonthly:_n,isaMonthly:Wt,effectiveSipp:Ee,effectiveIsa:rn,boostAmount:0,inProtection:b,planInputs:_t}:null;sn&&ee.push(sn),b&&(v+=En-fe);const ei=ce>0?e.equity[ce-1]||0:ht,no=t.subAsset?LI({inf:en,prevInf:Ot,eqReturn:ht,prevEqReturn:ei},i,t.subAsset.bondWeights):KI(en,ht,Ot,i),Tn=tg(Ot),In=ie=>Math.pow(1+(Number.isFinite(ie)?Math.max(-.99,ie):-.99),1/12);if(r*=In(ht),s*=In(no),o*=In(Tn),w=Ty(w,t.isaReturn||Jt.RETURN),l>0){const Ft=(i()-.5)*2*.06;let jt=0;ht<-.1?jt=Math.min(.15,Math.abs(ht)*.4):ht<-.05&&(jt=Math.abs(ht)*.2);let pt=.069+Ft+jt;pt=Math.max(-.08,Math.min(.18,pt)),l*=In(pt)}if(d>0){const ie=YI({inf:en,eqReturn:ht},i,p,t.subAsset&&t.subAsset.diversifierWeights);d*=In(ie)}const on=r+s;let tt=0;if(!b){const ie=12-xe,Pt=le+En*ie+_t.fixed;tt=Jm({shortfall:v,standardMonthly:En,remainingMonths:ie,surplus:on-wn-na.SURPLUS_BUFFER,brlHeadroom:_t.brl-Pt}),tt>50&&(fe+=tt,v-=tt)}le+=fe,sn&&(sn.effectiveSipp=fe,sn.boostAmount=tt>50?tt:0);let Et="Growth";if(!b&&on>=wn+fe){const ie=Math.max(0,r-et),Pt=Math.max(0,s-ft),Ft=ie+Pt;if(Ft>0){if(r-=fe*ie/Ft,s-=fe*Pt/Ft,Et="Growth",o<bn){const jt=on-wn-fe;if(jt>5e3){const pt=Math.min((bn-o)*.3,jt*.5);r-=pt*ie/Ft,s-=pt*Pt/Ft,o+=pt}}}else o-=fe,Et="Cash"}else if(o>=fe)o-=fe,Et="Cash";else{const ie=fe-o;o=0,d>ie?(d-=ie,f+=ie,Et="Diversifier"):s>ie?(s-=ie,Et="Bond"):r>ie?(r-=ie,Et="Equity"):l>ie?(l-=ie,c+=ie,x===null&&(x=se),Et="HODL"):(E=!0,S=se)}if(_=Et==="Growth"?0:_+1,w=Math.max(0,w-Math.min(rn,w)),R===null&&I>0&&w/te<A&&(R=se),r=Math.max(0,r),s=Math.max(0,s),o=Math.max(0,o),d=Math.max(0,d),(xe===0||se===t.years*12-1||E)&&H.push({year:ce+xe/12,month:se,equity:r,bond:s,cash:o,hodl:l,diversifier:d,total:r+s+o+d,draw:fe,boostAmount:tt,source:Et,inProtection:b,equityMin:et,bondMin:ft,cashMax:bn}),E)break}if(T=Math.max(T,y),!E)N[t.years]=w/(te||1),z[t.years]=(r+s+o+d)/(te||1);else for(let se=Math.floor(S/12)+1;se<=t.years;se++)z[se]=0;let Me=0,Pe=0,ve=0,O=0,Z=1;for(let se=0;se<t.years;se++){const ce=e.inflation[se]??.025;Me+=ce,Z*=1+ce,Pe+=e.equity[se]??0,se<5&&(ve+=e.equity[se]??0,O++)}const _e=r+s+o+d;return{failed:E,duration:t.years,years:E?S/12:t.years,failMonth:S,avgInflation:Me/t.years,avgEquityReturn:Pe/t.years,earlyEquityReturn:O?ve/O:0,cumInflation:Z,finalReal:_e/Z,final:_e,finalEquity:r,finalBond:s,finalCash:o,finalHodl:l,finalDiversifier:d,divUsed:f,protMonths:$,maxConsec:T,hodlUsed:c,hodlUsedMonth:x,startIsa:I,finalIsa:w,isaDepletedMonth:R,isaLastedYears:R===null?t.years:R/12,higherRateYears:C/12,totalTaxReal:L,isaByYear:N,potByYear:z,hist:H,trace:ee,seed:n}}function KI(t,e,n,i){let r=.15,s=.3,o=.2,l=.1,c=.1,d=.15;const f=n!==void 0?n:t,m=f>.045,p=f>.07;if(m){const $=i()>.3?1:.5;p?(r=.15+.35*$,s=.3-.2*$,d=.15-.1*$,l=.1+.05*$):(r=.15+.2*$,s=.3-.1*$,d=.15-.05*$)}m&&i()<.15&&(r=.2,s=.25,d=.12);const w=t+.005+or(0,.03,i),x=.04-(t>.04?(t-.04)*.5:0)+or(0,.05,i),I=.03+t*.3+or(0,.08,i),A=t*.8+or(0,.15,i),R=tg(n),C=e*.5+or(0,.02,i),L=r*w+s*x+o*I+l*A+c*R+d*C,N=QI(t,e),z=(e-.1)/.17;return L+N*z*.055}function QI(t,e){return t>.045?.4:e<-.15?-.3:.1}function JI(t,e){return Oo(e,t.spendingProfile||"flat")}function XI(t,e){return t.spStartYear!==void 0?Math.max(0,t.spStartYear-e):t.statePensionYear!==void 0?Math.max(0,t.statePensionYear-e):0}function ZI(t,e,n,i,r=0){const s=t.taxMode==="frozen"?t.pa:t.pa*n,o=t.taxMode==="frozen"?t.brl:t.brl*n,l=t.taxMode==="frozen"?t.hrl:(t.hrl||125140)*n,c=t.baseSalary*n*JI(t,e),d=Ey(t.other,i);let f=0;if(t.spStartYear!==void 0){if(e>=t.spStartYear&&t.spWeeklyAmount>0){const x=t.spWeeklyAmount*52;e===t.spStartYear&&t.spFirstYearRatio!==void 0?f=x*t.spFirstYearRatio*n:f=x*n}}else t.statePensionYear!==void 0&&(f=e>=t.statePensionYear?(t.statePension||0)*n:0);const m=d+f,p=XI(t,e),w=uc({targetGross:c,fixedIncome:m,pa:s,brl:o,hrl:l,isaBalance:r,strategy:t.isaDrawdownStrategy||Jt.DRAWDOWN_STRATEGY,yearsUntilSp:p});return{sippMonthly:w.sippGross/12,isaMonthly:w.isaDraw/12,taxAnnual:w.tax,higherRate:w.taxable>o+1,planInputs:{target:c,other:d,statePension:f,fixed:m,pa:s,brl:o,hrl:l,yearsUntilSp:p}}}function ng(t,e=1e3){const n=[];for(let i=0;i<e;i++)n.push(kr(t,pd(t,i),i));return n}function pd(t,e){const n=Object.keys(qi).map(Number).sort((c,d)=>c-d),i=n.length,r=hc(e*12345),s={equity:{},inflation:{}},o=t.blockYears||GI;let l=0;for(;l<t.years;){const c=Math.floor(r()*i);for(let d=0;d<o&&l<t.years;d++,l++){const f=n[(c+d)%i];s.equity[l]=qi[f],s.inflation[l]=aa[f]||.025}}return s}function ig(t){const e=Object.keys(qi).map(Number).sort((r,s)=>r-s),n=Math.max(...e),i=[];for(const r of e){if(r+t.years-1>n)continue;const s={equity:{},inflation:{}};for(let l=0;l<t.years;l++)s.equity[l]=qi[r+l]||0,s.inflation[l]=aa[r+l]||.025;const o=kr(t,s,r);o.startYear=r,i.push(o)}return i}function ex(t,e){const n={equity:{},inflation:{}};for(let i=0;i<t.years;i++)n.equity[i]=e.equity[i%e.equity.length],n.inflation[i]=e.inflation[i%e.inflation.length];return kr(t,n,999)}function tx(t){const e=t.filter(n=>n.failed).length;return(t.length-e)/t.length*100}function nx(t){if(!t||t.failCount===0)return"No shortfalls: every simulated future funded the whole plan.";const e=d=>(d*100).toFixed(1)+"%",n=Math.round(t.medianFailYear),i=t.duration,r=Math.round(t.pctNearMiss);let s;t.pctNearMiss>=60?s=`and when they do it's usually late — the typical shortfall is at year ${n} of ${i}, and ${r}% happen only in the final years, after funding almost the whole of retirement`:t.pctNearMiss<=30?s=`and they tend to come EARLY — the typical shortfall is at year ${n} of ${i}, with only ${r}% holding on to the final years. An early shortfall is the serious kind, with little retirement left to adjust`:s=`spread through retirement — the typical shortfall is at year ${n} of ${i}`;const o=[{mag:t.succEarlyEq-t.failEarlyEq,text:`a poor first few years of markets (sequence-of-returns risk): the futures that fell short averaged ${e(t.failEarlyEq)} equity in the opening 5 years versus ${e(t.succEarlyEq)} for those that lasted`},{mag:t.succAvgEq-t.failAvgEq,text:`weak markets across the whole plan: ${e(t.failAvgEq)} average equity return versus ${e(t.succAvgEq)} for those that lasted`},{mag:t.failAvgInf-t.succAvgInf,text:`higher inflation eroding spending power: ${e(t.failAvgInf)} a year versus ${e(t.succAvgInf)} for those that lasted`}].filter(d=>d.mag>.005).sort((d,f)=>f.mag-d.mag),l=`About ${Math.round(t.failRate||0)}% of futures fall short`;if(!o.length)return`${l}, ${s}. No single market driver stands out — the shortfalls come down to broadly bad luck across returns and inflation.`;let c=`The common thread is ${o[0].text}`;return o[1]&&o[1].mag>o[0].mag*.5&&(c+=`. A secondary factor is ${o[1].text}`),`${l}, ${s}. ${c}.`}function rg(t){const e=t.filter(l=>!l.failed),n=t.filter(l=>l.failed),i=t.map(l=>l.years).sort((l,c)=>l-c),r=e.map(l=>l.final).sort((l,c)=>l-c),s=t.map(l=>l.protMonths).sort((l,c)=>l-c),o=(l,c)=>l[Math.floor(l.length*c)]||0;return{total:t.length,successCount:e.length,failCount:n.length,successRate:tx(t),survival:{p5:o(i,.05),p10:o(i,.1),p25:o(i,.25),p50:o(i,.5),p75:o(i,.75),p90:o(i,.9),p95:o(i,.95),min:i[0],max:i[i.length-1]},finalValue:{p5:o(r,.05),p10:o(r,.1),p25:o(r,.25),p50:o(r,.5),p75:o(r,.75),p90:o(r,.9),p95:o(r,.95),min:r[0]||0,max:r[r.length-1]||0,avg:e.reduce((l,c)=>l+c.final,0)/(e.length||1)},minYears:i[0],p10Years:o(i,.1),medianYears:o(i,.5),medianFinal:o(r,.5),p10Final:o(r,.1),p90Final:o(r,.9),avgFinal:e.reduce((l,c)=>l+c.final,0)/(e.length||1),protection:{runsWithProtection:t.filter(l=>l.protMonths>0).length,pctWithProtection:t.filter(l=>l.protMonths>0).length/t.length*100,avgMonths:s.reduce((l,c)=>l+c,0)/t.length,maxMonths:Math.max(...s),maxConsecutive:Math.max(...t.map(l=>l.maxConsec)),avgConsecutive:t.reduce((l,c)=>l+c.maxConsec,0)/t.length,p50Months:o(s,.5),p90Months:o(s,.9),p95Months:o(s,.95)},runsWithProtection:t.filter(l=>l.protMonths>0).length,avgProtMonths:s.reduce((l,c)=>l+c,0)/t.length,maxProtMonths:Math.max(...s),maxConsecutive:Math.max(...t.map(l=>l.maxConsec)),avgConsecutive:t.reduce((l,c)=>l+c.maxConsec,0)/t.length,hodl:{runsUsingHodl:t.filter(l=>l.hodlUsed>0).length,pctUsingHodl:t.filter(l=>l.hodlUsed>0).length/t.length*100,avgUsed:t.filter(l=>l.hodlUsed>0).length>0?t.filter(l=>l.hodlUsed>0).reduce((l,c)=>l+c.hodlUsed,0)/t.filter(l=>l.hodlUsed>0).length:0,maxUsed:Math.max(...t.map(l=>l.hodlUsed||0))},runsUsingHodl:t.filter(l=>l.hodlUsed>0).length,avgHodlUsed:t.filter(l=>l.hodlUsed>0).length>0?t.filter(l=>l.hodlUsed>0).reduce((l,c)=>l+c.hodlUsed,0)/t.filter(l=>l.hodlUsed>0).length:0,maxHodlUsed:Math.max(...t.map(l=>l.hodlUsed||0)),severity:(()=>{const l=Math.max(...t.map(I=>I.duration||I.years),1),c=t.filter(I=>I.failed),d=t.filter(I=>!I.failed),f=c.map(I=>I.years).sort((I,A)=>I-A),m=l*.85,p=(I,A)=>I.length?I.reduce((R,C)=>R+(C[A]||0),0)/I.length:0,w={duration:l,coverage:t.reduce((I,A)=>I+Math.min(1,(A.years||0)/l),0)/t.length*100,failCount:c.length,failRate:t.length?c.length/t.length*100:0,medianFailYear:f.length?o(f,.5):0,pctNearMiss:c.length?c.filter(I=>I.years>=m).length/c.length*100:0,failEarlyEq:p(c,"earlyEquityReturn"),succEarlyEq:p(d,"earlyEquityReturn"),failAvgEq:p(c,"avgEquityReturn"),succAvgEq:p(d,"avgEquityReturn"),failAvgInf:p(c,"avgInflation"),succAvgInf:p(d,"avgInflation")};w.diagnosis=nx(w);const x=[{k:"sequence",m:w.succEarlyEq-w.failEarlyEq},{k:"market",m:w.succAvgEq-w.failAvgEq},{k:"inflation",m:w.failAvgInf-w.succAvgInf}].filter(I=>I.m>.005).sort((I,A)=>A.m-I.m);return w.primaryDriver=w.failCount>0&&x.length?x[0].k:null,w})(),finalReal:(()=>{const l=t.map(c=>c.failed?0:c.finalReal||0).sort((c,d)=>c-d);return{p5:o(l,.05),p10:o(l,.1),p25:o(l,.25),p50:o(l,.5),p75:o(l,.75),p90:o(l,.9),p95:o(l,.95),min:l[0]||0,max:l[l.length-1]||0}})(),chartData:(()=>{const l=Math.max(...t.map(m=>m.duration||m.years),1),c=l+1,d={p10:[],p25:[],p50:[],p75:[],p90:[]},f=[];for(let m=0;m<c;m++){const p=t.map(x=>x.potByYear&&x.potByYear[m]!=null?x.potByYear[m]:0).sort((x,I)=>x-I);d.p10.push(o(p,.1)),d.p25.push(o(p,.25)),d.p50.push(o(p,.5)),d.p75.push(o(p,.75)),d.p90.push(o(p,.9));const w=t.filter(x=>(x.failed?x.failMonth/12:l)>=m).length;f.push(t.length?w/t.length*100:0)}return{years:c,potBand:d,solvency:f}})(),isa:(()=>{const l=t.filter(I=>(I.startIsa||0)>0);if(!l.length)return{funded:!1};const c=l.map(I=>I.isaLastedYears).sort((I,A)=>I-A),d=l.map(I=>I.finalIsa).sort((I,A)=>I-A),f=l.map(I=>I.higherRateYears),m=l.map(I=>I.totalTaxReal).sort((I,A)=>I-A),p=Math.max(...l.map(I=>(I.isaByYear||[]).length)),w=[],x=[];for(let I=0;I<p;I++){const A=l.filter(C=>C.isaByYear&&C.isaByYear[I]>0).length;w.push(l.length?A/l.length*100:0);const R=l.map(C=>C.isaByYear&&C.isaByYear[I]!=null?C.isaByYear[I]:0).sort((C,L)=>C-L);x.push(R[Math.floor(R.length/2)])}return{funded:!0,runs:l.length,startBalance:l[0].startIsa,medianLastedYears:o(c,.5),minLastedYears:c[0],pctSurviveFullTerm:l.filter(I=>I.isaDepletedMonth===null).length/l.length*100,finalBalance:{p10:o(d,.1),p50:o(d,.5),p90:o(d,.9)},avgHigherRateYears:f.reduce((I,A)=>I+A,0)/l.length,maxHigherRateYears:Math.max(...f),pctEverHigherRate:l.filter(I=>I.higherRateYears>0).length/l.length*100,medianTotalTax:o(m,.5),p90TotalTax:o(m,.9),pctHoldingByYear:w,medianIsaByYear:x}})(),failures:n.map(l=>({seed:l.seed,startYear:l.startYear,years:l.years,failMonth:l.failMonth,protMonths:l.protMonths}))}}function Or(t){if(!t)return null;const e={january:0,jan:0,february:1,feb:1,march:2,mar:2,april:3,apr:3,may:4,june:5,jun:5,july:6,jul:6,august:7,aug:7,september:8,sep:8,sept:8,october:9,oct:9,november:10,nov:10,december:11,dec:11},n=t.trim().replace(/\s+/g," ");if(/^\d{4}-\d{2}-\d{2}$/.test(n)){const r=new Date(n);if(!isNaN(r.getTime()))return r}if(/^\d{1,2}\/\d{1,2}\/\d{4}$/.test(n)){const[r,s,o]=n.split("/").map(Number);return new Date(o,s-1,r)}if(/^\d{1,2}-\d{1,2}-\d{4}$/.test(n)){const[r,s,o]=n.split("-").map(Number);return new Date(o,s-1,r)}let i=n.match(/^(\d{1,2})\s+(\w+)\s+(\d{4})$/i);if(i){const r=parseInt(i[1]),s=e[i[2].toLowerCase()],o=parseInt(i[3]);if(s!==void 0)return new Date(o,s,r)}if(i=n.match(/^(\w+)\s+(\d{1,2})\s+(\d{4})$/i),i){const r=e[i[1].toLowerCase()],s=parseInt(i[2]),o=parseInt(i[3]);if(r!==void 0)return new Date(o,r,s)}if(i=n.match(/^(\w+)\s+(\d{1,2})(?:st|nd|rd|th)?,?\s+(\d{4})$/i),i){const r=e[i[1].toLowerCase()],s=parseInt(i[2]),o=parseInt(i[3]);if(r!==void 0)return new Date(o,r,s)}if(i=n.match(/^(\d{1,2})(?:st|nd|rd|th)?\s+(\w+),?\s+(\d{4})$/i),i){const r=parseInt(i[1]),s=e[i[2].toLowerCase()],o=parseInt(i[3]);if(s!==void 0)return new Date(o,s,r)}return null}function Bo(t){const e=typeof t=="string"?Or(t):t;if(!e||isNaN(e.getTime()))return"";const n=["January","February","March","April","May","June","July","August","September","October","November","December"];return`${e.getDate()} ${n[e.getMonth()]} ${e.getFullYear()}`}function ix(t){const{taxYear:e,spStartDate:n,weeklyAmount:i,taxYearConfigs:r={}}=t;if(!n||!i||i<=0)return{annual:0,monthly:0,isReceiving:!1,isFirstYear:!1,weeksInYear:0,startDate:null};const s=typeof n=="string"?Or(n):n;if(!s||isNaN(s.getTime()))return{annual:0,monthly:0,isReceiving:!1,isFirstYear:!1,weeksInYear:0,startDate:null};const o=la(s);ol(e);const l=yy(e),c=[...new Set([o,e,...Object.keys(r)])].sort((I,A)=>ol(I).getTime()-ol(A).getTime()),d=c.indexOf(o),f=c.indexOf(e);if(f<d)return{annual:0,monthly:0,isReceiving:!1,isFirstYear:!1,weeksInYear:0,startDate:Bo(s)};let m=1;for(let I=d;I<f;I++){const A=c[I],R=r[A],C=(R==null?void 0:R.cpi)||.025;m*=1+C}const p=i*m;if(e===o){const A=Math.max(0,(l.getTime()-s.getTime())/6048e5),R=p*A;return{annual:R,monthly:R/12,isReceiving:!0,isFirstYear:!0,weeksInYear:Math.round(A*10)/10,startDate:Bo(s)}}const x=p*52;return{annual:x,monthly:x/12,isReceiving:!0,isFirstYear:!1,weeksInYear:52,startDate:Bo(s)}}function rx(t,e=new Date){const n=typeof t=="string"?Or(t):t;if(!n||isNaN(n.getTime()))return{years:0,months:0,totalMonths:0,isPast:!1};const i=n.getTime()-e.getTime(),r=i<=0;if(r)return{years:0,months:0,totalMonths:0,isPast:!0};const s=Math.floor(i/(30.44*24*60*60*1e3)),o=Math.floor(s/12),l=s%12;return{years:o,months:l,totalMonths:s,isPast:r}}const sg=2016;function $a(t,{now:e=new Date}={}){if(!t||!String(t).trim())return{valid:!0,error:null,warning:null,date:null};const n=Or(t);if(!n||isNaN(n.getTime()))return{valid:!1,error:'Could not read that date. Try a format like "6 May 2040".',warning:null,date:null};const i=n.getFullYear();return i<sg?{valid:!1,error:`That looks like a date of birth (${i}), not a State Pension start date. Enter the date your State Pension begins — check gov.uk/check-your-state-pension.`,warning:null,date:n}:n.getTime()<e.getTime()?{valid:!0,error:null,warning:`This date is in the past — State Pension will be treated as already in payment from ${i}.`,date:n}:{valid:!0,error:null,warning:null,date:n}}const Hh=Object.freeze(Object.defineProperty({__proto__:null,MIN_SP_START_YEAR:sg,calculateStatePensionForTaxYear:ix,formatStatePensionDate:Bo,getTimeUntilStatePension:rx,parseStatePensionDate:Or,validateStatePensionDate:$a},Symbol.toStringTag,{value:"Module"}));let fi=null;function ks(){return{settings:{equityMin:ye.EQUITY_MIN,bondMin:ye.BOND_MIN,cashTarget:ye.CASH_TARGET,duration:ye.DURATION_YEARS,baseSalary:ye.BASE_SALARY,other:0,statePension:12e3,statePensionYear:12,pa:Ye.PERSONAL_ALLOWANCE,brl:Ye.BASIC_RATE_LIMIT,hrl:Ye.HIGHER_RATE_LIMIT,taxMode:"inflates",protectionMult:Vi.PROTECTION_MULTIPLIER,consecutiveLimit:ye.CONSECUTIVE_LIMIT,disableProtection:!1,hodlEnabled:Vi.HODL_ENABLED,hodlValue:Vi.HODL_VALUE,spendingProfile:"flat",equityGlideEnabled:!1,diversifierStart:0,taggedFunds:[]},lastModified:null,checksum:null}}function md(){return Fe()&&dt()}function Hn(){fi=null}function sx(){return fi||ks()}async function og(){if(fi)return fi;if(!md())return console.warn("Firebase not available - returning defaults"),ks();try{const t=await uI();if(t){const e={settings:t,lastModified:new Date().toISOString(),checksum:null};return fi=lx(e),fi}}catch(t){console.error("Error loading stress data:",t)}return ks()}async function ox(t){if(!md())throw new Error("Must be logged in to save data");try{t.lastModified=new Date().toISOString(),t.checksum=ax(t),await qm(t.settings),fi=t}catch(e){throw console.error("Error saving stress data:",e),new Error("Failed to save stress data")}}function ax(t){return da(t.settings)}function lx(t){const e={...ks()};return t.settings&&(e.settings={...e.settings,...t.settings},t.settings.pacwMin!==void 0&&t.settings.equityMin===void 0&&(e.settings.equityMin=t.settings.pacwMin),t.settings.cgtMin!==void 0&&t.settings.bondMin===void 0&&(e.settings.bondMin=t.settings.cgtMin),t.settings.csh2Target!==void 0&&t.settings.cashTarget===void 0&&(e.settings.cashTarget=t.settings.csh2Target),e.settings.hodlEnabled===void 0&&(e.settings.hodlEnabled=!1),e.settings.hodlValue===void 0&&(e.settings.hodlValue=25e3)),e.lastModified=t.lastModified,e.checksum=t.checksum,e}function cx(){return sx().settings}async function Lt(){return(await og()).settings}async function Js(t){const e=await og();e.settings={...e.settings,...t},await ox(e)}async function dx(){if(!md())throw new Error("Must be logged in to reset settings");const t=ks();await qm(t.settings),Hn()}function ux(t){if(!t.spStartDate||!t.spWeeklyAmount)return null;const e=Or(t.spStartDate);if(!e)return console.warn("Could not parse spStartDate:",t.spStartDate),null;const n=new Date,i=365.25*24*60*60*1e3,r=Math.max(0,(e.getTime()-n.getTime())/i),s=Math.floor(r),o=365,l=Math.floor((e-new Date(e.getFullYear(),0,0))/(24*60*60*1e3)),d=(o-l)/o;return{spStartYear:s,spWeeklyAmount:t.spWeeklyAmount,spFirstYearRatio:d}}function Xs(t={},e=null){const n=e||cx(),i=ux(n),r=i?{spStartYear:i.spStartYear,spWeeklyAmount:i.spWeeklyAmount,spFirstYearRatio:i.spFirstYearRatio}:{statePension:n.statePension||0,statePensionYear:n.statePensionYear??999};return{equityStart:t.equityStart??n.equityMin,bondStart:t.bondStart??n.bondMin,cashStart:t.cashStart??n.cashTarget,equityMin:n.equityMin,bondMin:n.bondMin,cashTarget:n.cashTarget,years:t.years??n.duration,duration:n.duration,baseSalary:n.baseSalary,other:n.other,...r,pa:n.pa,brl:n.brl,hrl:n.hrl,taxMode:n.taxMode,protectionMult:n.protectionMult,consecutiveLimit:n.consecutiveLimit,disableProtection:n.disableProtection,hodlEnabled:n.hodlEnabled,hodlValue:n.hodlValue,isaBalance:n.isaBalance||0,isaReturn:n.isaReturn,isaDrawdownStrategy:n.isaDrawdownStrategy,spendingProfile:n.spendingProfile||"flat",equityGlide:n.equityGlideEnabled?cf(n):void 0,diversifierStart:t.diversifierStart??(n.diversifierStart||void 0),subAsset:n.subAsset||void 0}}async function gd(){try{const t=await pI();return{...As(),...t||{}}}catch(t){return console.error("Error loading budget:",t),As()}}async function yd(t){const e={...t,derived:Nr(t)};return await mI(e),e}function j(t,e=null){const n=Math.abs(t),i=e!==null?e:n<100,r=Math.abs(t).toLocaleString("en-GB",{minimumFractionDigits:i?2:0,maximumFractionDigits:i?2:0});return t<0?`-£${r}`:`£${r}`}function Wh(t,e){const n=hx(t);e.innerHTML=n}function hx(t){var E,S,v,le,pe;const e=t,n=e.calculationDetails||{};let i="";const r=e.isTaxEfficientYear??e.taxEfficient,s=e.protectionInducedTaxEfficiency||!1,o=e.boostAmount>0;let l,c,d;if(e.inProtection?(l="warning",c="Protection Mode",d="⚡"):o?(l="boost",c="Tax Boost (Catch-up)",d="↑"):s?(l="info",c="Protection-Induced Tax Efficiency",d="↑"):r?(l="success",c="Tax-Efficient Year",d="✓"):(l="warning",c="Tax-Inefficient Year",d="!"),i+=`<div class="decision-mode ${l}">
  ...
  </div>`}function fx(t){switch(t){case go.DANGER:return"alert-danger";case go.WARNING:return"alert-warning";case go.SUCCESS:return"alert-success";case go.INFO:default:return"alert-info"}}function px(){return`
    .decision-mode {
      display: flex;
      align-items: center;
      gap: 12px;
  ...
  `,Sx()}function Tx(){if(K.isApril,K.isApril)switch($t){case 1:return Yh();case 2:return jh();case 3:return Gh();case 4:return Kh();case 5:return Qh();case 6:return Jh();default:return""}else switch($t){case 1:return Yh();case 2:return Ix();case 3:return jh();case 4:return Gh();case 5:return Kh();case 6:return Qh();case 7:return Jh();default:return""}}function Yh(){return`
  ...
  `}function Ix(){const t=vd(K.selectedMonth),e=Px(K.selectedMonth);return`
    <div class="wizard-step">
  ...
  `}function Kh(){Zs();const t=yx({targetAnnualGross:V.confirmedSalary,brl:V.brl,pa:V.pa,other:V.other,statePension:K.statePension.amount,remainingMonths:K.remainingMonths,grossIncomeToDate:V.grossIncomeToDate});return V._isaCalc=t,t.brlExhausted?`
      <div class="wizard-step">
  ...
  `}function Qh(){Zs();const t=V._isaCalc,e=vx(V.isaSavingsAllocation,(t==null?void 0:t.isaNeeded)||0,(t==null?void 0:t.brlExhausted)||!1);if(e.sufficient&&!e.isBrlExhausted)return V.isTaxEfficient=!0,V.taxEfficiencyChoice="efficient",setTimeout(()=>{$t++,gs()},0),`
      <div class="wizard-step">
  ...
  `}function Mx(t={},e=null){const n=Xs(t,e),i=ng(n),r=rg(i);return{results:i,stats:r,config:n}}function Dx(t={},e=null){const n=Xs(t,e),i=ig(n),r=rg(i);return{results:i,stats:r,config:n}}function Bx(t={}){const e=Xs(t),n={};for(const[i,r]of Object.entries(my))n[i]={...r,result:ex(e,r)};return n}function bd(t){const e={[me.SHARES]:0,[me.BONDS]:0,[me.DIVERSIFIERS]:0,[me.CASH]:0},n={},i=[],r=[];let s=0,o=0;for(const l of t){const c=+l.value||0,d=l.subClass||(l.ticker?Xm[l.ticker]:void 0),f=d?Ut[d]:null;if(!f){r.push({...l});continue}if(s+=c,i.push({...l,subClass:d,bucket:f.bucket,label:f.label}),(l.wrapper||"").toUpperCase()==="ISA"){o+=c;continue}e[f.bucket]+=c,n[d]=(n[d]||0)+c}return{buckets:e,subClassTotals:n,bondWeights:Xh(n,me.BONDS),diversifierWeights:Xh(n,me.DIVERSIFIERS),total:s,isaTotal:o,tagged:i,untagged:r}}function Xh(t,e){const n=Object.entries(t).filter(([s])=>Ut[s].bucket===e),i=n.reduce((s,[,o])=>s+o,0);if(i<=0)return{};const r={};for(const[s,o]of n)r[s]=o/i;return r}function Lx(t){const e=t.buckets[me.DIVERSIFIERS]||0,n={equityStart:t.buckets[me.SHARES]||0,bondStart:t.buckets[me.BONDS]||0,cashStart:t.buckets[me.CASH]||0,isaBalance:t.isaTotal||0};return e>0&&(n.diversifierStart=e,n.subAsset={}),Object.keys(t.bondWeights).length&&(n.subAsset=n.subAsset||{},n.subAsset.bondWeights=t.bondWeights),Object.keys(t.diversifierWeights).length&&(n.subAsset=n.subAsset||{},n.subAsset.diversifierWeights=t.diversifierWeights),n}function cg(t){return la(dc(t))}function Nx(t){const[e,n]=t.split("-").map(Number);return Math.max(0,(n>=4?e:e-1)-2026)}async function Ox(t,e,n,i,r){var qr,ki,Hr,ti;const s=r.settings,o=r.history,l=r.allTaxYears,c=cg(t),d=Nx(t),[f,m]=t.split("-").map(Number);if(!l[c])throw new Error(`Tax year ${c} is not configured. Please add it in the Settings tab before calculating.`);const p=l[c],w=p.pa||12570,x=p.brl||50270,I=p.hrl||125140,A=p.other||0,R=p.isTaxEfficient!==!1,C=p.isaSavingsAllocation||0,L=p.grossIncomeToDate||0,N=p.confirmedSalary||s.baseSalary,z=o.find(X=>X.date===t),$=(z==null?void 0:z.isa)||0,T=Math.max(0,(p.isaSavingsUsed||0)-$),_=r.spInfo.amount||0;let b=1;for(let X=0;X<d;X++){const de=String((26+X)%100).padStart(2,"0")+"/"+String((27+X)%100).padStart(2,"0"),$e=(l[de]||{}).cpi||wy;b*=1+$e}let E=Ln(s.equityMin,d,s.duration,b,!0),S=Ln(s.bondMin,d,s.duration,b,!0);const v=Math.round(Ln(s.cashTarget,d,s.duration,b,!1)),le=ca(s.equityGlide,d,s.duration);if(le!=null){const X=E+S;E=X*le,S=X*(1-le)}E=Math.round(E),S=Math.round(S);const pe=e+n,H=E+S;let ee=0;const ne=o.filter(X=>X.date<t);for(let X=ne.length-1;X>=0&&ne[X].source==="Cash";X--)ee++;const te=Qm({totalGrowth:pe,minGrowth:H,consecCashDraws:ee,wasInProtection:ne.length>0&&ne[ne.length-1].inProtection,consecutiveLimit:s.consecutiveLimit||3,recoveryBuffer:s.recoveryBuffer||1e4}),Me=m>=4?16-m:4-m,Pe=Math.max(1,Me),ve=N*b,O=A+_;Bn(ve,w,x,I);let Z,_e,se,ce=0,xe=0,Xn=!1,ut=0;const en=Math.max(0,C-T)/Pe;if(R){const X=O/12;o.filter(Ve=>Ve.taxYear===c&&Ve.date<t);const de=ve/12,$e=r.isaBalance||0;let He,mt;if($e>0){const Ve=uc({targetGross:ve,fixedIncome:O,pa:w,brl:x,hrl:I,isaBalance:$e,strategy:s.isaDrawdownStrategy||"minimiseEarlyTax",yearsUntilSp:0});He=Ve.sippGross/12,mt=Ve.isaDraw/12}else{if(((ki=(qr=p.expectedMonthly)==null?void 0:qr.sipp)==null?void 0:ki.gross)>0)He=p.expectedMonthly.sipp.gross;else{const Se=Math.max(0,x-L-O)/12;He=Math.min(de-X,Se)}const Ve=Bn(ve,w,x,I)/12,Gt=Math.min(ve,x),be=Bn(Gt,w,x,I)/12,je=Math.max(0,Ve-be);mt=Math.min(je,en)}if(ut=mt,ce=He,te){const Ve=(s.protectionFactor||20)/100;Z=He*(1-Ve),_e=mt,se="Protection"}else{Z=He,_e=mt,se="Tax-Efficient";const Ve=m>=4?f:f-1,Gt=ne.filter(Se=>{const[ni,Ri]=Se.date.split("-").map(Number);return(Ri>=4?ni:ni-1)===Ve});let be=0,je=0;Gt.forEach(Se=>{je+=Se.sipp||0,Se.inProtection&&Se.stdSipp&&(be+=Se.stdSipp-Se.sipp),Se.boostAmount>0&&(be-=Se.boostAmount)});const gt=je+Z*Pe+O;xe=Jm({shortfall:be,standardMonthly:He,remainingMonths:Pe,surplus:pe-H-na.SURPLUS_BUFFER,brlHeadroom:x-gt}),xe>50&&(Z+=xe,se="Tax Boost")}}else{const X=ve/12,de=O/12;let $e;if(((ti=(Hr=p.expectedMonthly)==null?void 0:Hr.sipp)==null?void 0:ti.gross)>0?$e=p.expectedMonthly.sipp.gross:$e=Math.max(0,X-de),ce=$e,_e=0,te){const He=(s.protectionFactor||20)/100;Z=$e*(1-He),se="Protection";const mt=m>=4?f:f-1,Ve=ne.filter(je=>{const[gt,Se]=je.date.split("-").map(Number);return(Se>=4?gt:gt-1)===mt});let Gt=0;Ve.forEach(je=>{Gt+=je.sipp||0});const be=Gt+Z*Pe+O;if(be<x){const gt=(x-be)/Pe,Se=pe-H-(s.recoveryBuffer||1e4);Se>0&&gt>50&&(xe=Math.min(gt,Se/Pe),xe>50&&(Z+=xe,Xn=!0,se="Protection-Induced Efficiency"))}}else{Z=$e,se="Tax-Inefficient";const He=m>=4?f:f-1,mt=ne.filter(be=>{const[je,gt]=be.date.split("-").map(Number);return(gt>=4?je:je-1)===He});let Ve=0,Gt=0;if(mt.forEach(be=>{Gt+=be.sipp||0,be.inProtection&&be.stdSipp&&(Ve+=be.stdSipp-be.sipp),be.boostAmount>0&&(Ve-=be.boostAmount)}),Ve>0){const be=Gt+Z*Pe+O,je=x-be,gt=pe-H-(s.recoveryBuffer||1e4);if(je>0&&gt>0){const Se=je/Pe,ni=Ve/Pe,Ri=gt/Pe;xe=Math.min(ni,Se,Ri),xe>50&&(Z+=xe,se="Tax Boost")}}}}const Ot=r.diversifier||0;let et,ft,bn=0,wn=0,tn=0,_n=0,Wt="";if(!te&&pe>=H+Z){et="Growth";const X=Math.max(0,e-E),de=Math.max(0,n-S),$e=X+de;$e>0?(bn=Z*X/$e,wn=Z*de/$e,ft="Healthy"):(et="Cash",tn=Z,ft="At min")}else if(et="Cash",ft=te?"Protection":"Below min",Ot>0){tn=Math.min(i,Z);let X=Z-tn;X>0&&(_n=Math.min(Ot,X),X-=_n,et=tn>0?"Cash + Diversifier":"Diversifier"),X>0&&(Wt="Cash low!")}else tn=Z,i<Z&&(Wt="Cash low!");let _t="";const Zn=e-E,nn=n-S;if(Zn>5e3&&nn<-5e3){const X=Math.floor(Math.min(Zn,-nn)/1e3)*1e3;X>=5e3&&(_t=`Move £${X.toLocaleString()} Equity→Bond`)}else if(nn>5e3&&Zn<-5e3){const X=Math.floor(Math.min(nn,-Zn)/1e3)*1e3;X>=5e3&&(_t=`Move £${X.toLocaleString()} Bond→Equity`)}let Yt="";const En=v-i;if(En>5e3&&et==="Growth"&&!te){const X=pe-H-Z;if(X>1e4){const de=Math.floor(Math.min(En*.3,X*.5)/1e3)*1e3;de>=5e3&&(Yt=`Replenish Cash: Move £${de.toLocaleString()} from growth funds`)}}const Ee=[];Wt&&Ee.push({message:Wt,severity:"danger",type:"low-cash"}),xe>50&&Ee.push({message:`Tax Boost: +£${Math.round(xe).toLocaleString()}/mo catch-up from protection shortfall`,severity:"success",type:"tax-boost"}),_t&&Ee.push({message:_t,severity:"warning",type:"rebalance"}),Yt&&Ee.push({message:Yt,severity:"info",type:"cash-replenish"});const fe=m>=4?f:f-1,rn=ne.filter(X=>{const[de,$e]=X.date.split("-").map(Number);return($e>=4?de:de-1)===fe}),sn=rn.reduce((X,de)=>X+(de.sipp||0),0),ei=rn.length+1,Tn=Math.max(0,12-ei)*ce,on=sn+Z+Tn+A+_,tt=_l(on,w,x,I),Et=tt/12,Pt=Z+A/12+_/12-Et+_e,Ft=Et*ei,jt=tt,pt=ve/12,Ur=_l(pt*12,w,x,I),Ai=Math.max(0,Ur/12-tt/12),xn=T+ut;return{date:t,taxYear:c,yearNumber:d,remainingMonths:Pe,equity:e,bond:n,cash:i,isa:0,adjEquityMin:E,adjBondMin:S,adjCashTarget:v,pa:w,brl:x,other:A/12,statePension:_/12,sippDraw:Z,stdSipp:ce,isaDraw:_e,totalMonthlyNet:Pt,isTaxEfficientYear:R,yearlyIsaSavingsAllocation:C,cumulativeIsaSavingsUsed:xn,isaSavingsUsedThisMonth:ut,taxPaidYTD:Ft,taxProjectedAnnual:jt,taxSavedMonthly:Ai,taxSavedYTD:Ai*ei,taxSavedProjectedAnnual:Ai*12,taxEfficient:R&&!Xn,inProtection:te,protectionReason:te?ft:null,consecutiveCashDraws:ee,protectionInducedTaxEfficiency:Xn,boostAmount:xe>50?xe:0,boostEligible:xe>50,source:et,drawFromEquity:bn,drawFromBond:wn,drawFromCash:tn,...Ot>0?{drawFromDiversifier:_n,diversifier:Ot}:{},rebalanceNeeded:_t!=="",rebalanceActions:_t?[_t]:[],alerts:Ee,calculationDetails:{mode:se,reason:`${ft} | ${se}`,totalGrowth:pe,minGrowth:H,consec:ee,stdSipp:Z,inputs:{baseSalary:s.baseSalary,confirmedSalary:N,targetGross:ve,cumInf:b,yearNum:d,taxYear:c,OTHER:A,STATE:_,PA:w,BRL:x,isTaxEfficientYear:R,yearlyIsaSavingsAllocation:C,grossIncomeToDate:L},taxInfo:{annualTaxable:on,headroomToBRL:x-on,annualTax:tt,monthlyNet:Pt}}}}let Ps=null;function Fx(t,e){Ps=t,Vx(e)}function Vx({onGetStarted:t,onSignIn:e}){Ps&&(Ps.innerHTML=`
  ...
  `,document.getElementById("landingGetStarted").addEventListener("click",t),document.getElementById("landingSignIn").addEventListener("click",e))}function Cs(){Ps&&(Ps.style.display="none")}function zx(){return`
    .landing-page {
      position: fixed;
      top: 0;
      left: 0;
  ...
  `,Ux()}}function Ux(){const t=Xe.querySelectorAll(".auth-screen-tab");t.forEach(s=>{s.addEventListener("click",()=>{t.forEach(c=>c.classList.remove("active")),s.classList.add("active");const o=document.getElementById("signinForm"),l=document.getElementById("signupForm");s.dataset.tab==="signin"?(o.style.display="block",l.style.display="none"):(o.style.display="none",l.style.display="block"),Qi()})}),document.getElementById("signinForm").addEventListener("submit",qx),document.getElementById("signupForm").addEventListener("submit",Hx),document.getElementById("forgotPasswordBtn").addEventListener("click",Wx),document.getElementById("googleSigninBtn").addEventListener("click",Yx)}function Zt(t){const e=document.getElementById("authScreenError");e&&(e.textContent=t,e.style.display="block")}function Qi(){const t=document.getElementById("authScreenError");t&&(t.style.display="none")}async function qx(t){t.preventDefault(),Qi();const e=document.getElementById("signinEmail").value.trim(),n=document.getElementById("signinPassword").value;if(!e||!n){Zt("Please enter email and password");return}try{await WT(e,n)}catch(i){console.error("Sign in error:",i),Zt(Ua(i.code))}}async function Hx(t){t.preventDefault(),Qi();const e=document.getElementById("signupName").value.trim(),n=document.getElementById("signupEmail").value.trim(),i=document.getElementById("signupPassword").value;if(!e||!n||!i){Zt("Please fill in all fields");return}if(i.length<6){Zt("Password must be at least 6 characters");return}try{await UT(n,i,e)}catch(r){console.error("Sign up error:",r),Zt(Ua(r.code))}}async function Wx(){Qi();const t=document.getElementById("signinEmail").value.trim();if(!t){Zt("Please enter your email address first");return}try{await jT(t),typeof window.showToast=="function"&&window.showToast("Password reset email sent. Check your inbox.","success",5e3)}catch(e){console.error("Reset password error:",e),Zt(Ua(e.code))}}async function Yx(){Qi();try{await YT()}catch(t){console.error("Google sign in error:",t),Zt(Ua(t.code))}}function Ua(t){return{"auth/invalid-email":"Invalid email address","auth/user-disabled":"This account has been disabled","auth/user-not-found":"No account found with this email","auth/wrong-password":"Incorrect password","auth/email-already-in-use":"An account already exists with this email","auth/weak-password":"Password is too weak","auth/operation-not-allowed":"Sign in method not enabled","auth/popup-closed-by-user":"Sign in cancelled","auth/popup-blocked":"Sign in popup was blocked","auth/too-many-requests":"Too many attempts. Please try again later.","auth/invalid-credential":"Invalid email or password"}[t]||"An error occurred. Please try again."}function jx(t){Xe&&(Xe.style.display="block",Xe.innerHTML=`
    <div class="auth-screen">
  ...
  `}let Ds=null;function hg(t,e,n,i={}){Ds=t,Qx(e,n,i)}function Qx(t,e,n={}){if(!Ds)return;const i=t||"there",r=n.title||`Welcome, ${i}!`,s=n.subtitle||"Your account is set up and ready to go. Here's what Pension Planner can do for you.",o=n.ctaLabel||"Set Up Your First Plan";Ds.innerHTML=`
  ...
  `,document.getElementById("onboardingStartWizard").addEventListener("click",e),n.onSkip&&document.getElementById("onboardingSkip").addEventListener("click",n.onSkip)}function Fr(){Ds&&(Ds.style.display="none")}function Jx(){return`
    .onboarding-page {
      position: fixed;
      top: 0;
      left: 0;
  ...
  `,Ed()}function Zx(){const t=D.household==="couple";return`
    <div class="wizard-step">
  ...
  `,Ed()}function nS(t){switch(t){case 1:return`
      ...
      `;default:return""}}function iS(){Wn.innerHTML=`
    <div class="wizard-overlay">
      <div class="wizard-box">
  ...
  `,Ed()}function rS(t){switch(t){case 1:return`
        <div class="wizard-step">
          <div class="wizard-step-title">How much money do you want each year?</div>
          <div class="wizard-step-desc">
  ...
  `}function lS(){const e=getComputedStyle(document.documentElement).getPropertyValue("--bg").trim()==="#0d1117"||document.documentElement.classList.contains("dark")||window.matchMedia("(prefers-color-scheme: dark)").matches;return{primary:"#f0c674",success:"#2ea043",warning:"#e1b12c",danger:"#f85149",muted:"#8b8b9b",grid:"rgba(255,255,255,0.1)",bg:e?"rgba(15,15,26,1)":"#ffffff",text:e?"#c9d1d9":"#1f2937",cardBg:e?"#21262d":"#ffffff",cone:"rgba(240,198,116,0.15)",coneMid:"rgba(240,198,116,0.2)",coneInner:"rgba(240,198,116,0.35)",coneBorder:"rgba(240,198,116,0.4)",trajectory:"rgba(46,160,67,0.25)",trajectoryFailed:"rgba(248,81,73,0.8)",trajectoryHover:"#5fdd7b",trajectoryFailedHover:"#ff6b6b",glidepath:"#7eb8da",zeroLine:"#f85149"}}function cS(t,e,n={}){const i=lS(),r=t.getContext("2d"),{width:s,height:o}=t,l={top:50,right:180,bottom:60,left:80},c=s-l.left-l.right,d=o-l.top-l.bottom;r.fillStyle=i.bg,r.fillRect(0,0,s,o);const f=Object.keys(e),m=n.years||35;let p=0;f.forEach(A=>{const R=e[A].result;R&&R.hist&&R.hist.forEach(C=>{C.total>p&&(p=C.total)})}),p*=1.1;const w=A=>l.left+A/m*c,x=A=>l.top+d-A/p*d;dS(r,l,c,d,m,p,n.title||"Scenario Comparison",i);const I=["#6366f1","#22c55e","#f59e0b","#ef4444","#8b5cf6","#06b6d4","#ec4899","#84cc16"];f.forEach((A,R)=>{const C=e[A].result;if(!C||!C.hist)return;r.beginPath(),r.strokeStyle=I[R%I.length],r.lineWidth=2.5,C.hist.forEach((N,z)=>{const $=w(N.year),T=x(N.total);z===0?r.moveTo($,T):r.lineTo($,T)}),r.stroke();const L=l.top+15+R*24;r.fillStyle=I[R%I.length],r.fillRect(s-l.right+15,L,20,4),r.font="11px system-ui, sans-serif",r.fillStyle=i.text,r.textAlign="left",r.fillText(e[A].name||A,s-l.right+40,L+5),C.final/1e3,r.fillStyle=i.muted,r.fillText(`${gg(C.final)}`,s-l.right+40,L+18)})}function dS(t,e,n,i,r,s,o,l){t.font="bold 14px system-ui, sans-serif",t.fillStyle=l.text,t.textAlign="center",t.fillText(o,e.left+n/2,e.top-20),t.strokeStyle=l.grid,t.lineWidth=1;for(let c=0;c<=5;c++){const d=e.top+i*c/5;t.beginPath(),t.moveTo(e.left,d),t.lineTo(e.left+n,d),t.stroke();const f=s*(5-c)/5;t.font="11px system-ui, sans-serif",t.fillStyle=l.muted,t.textAlign="right",t.fillText(gg(f),e.left-10,d+4)}for(let c=0;c<=r;c+=5){const d=e.left+c/r*n;t.beginPath(),t.moveTo(d,e.top),t.lineTo(d,e.top+i),t.stroke(),t.textAlign="center",t.fillText(`Y${c}`,d,e.top+i+20)}t.font="12px system-ui, sans-serif",t.textAlign="center",t.fillText("Years",e.left+n/2,e.top+i+45),t.save(),t.translate(20,e.top+i/2),t.rotate(-Math.PI/2),t.fillText("Fund Value",0,0),t.restore()}function gg(t){return t>=1e6?`£${(t/1e6).toFixed(1)}M`:t>=1e3?`£${(t/1e3).toFixed(0)}k`:`£${t.toFixed(0)}`}function uS(){return`
  ...
  `}window._simEngine={runMonteCarlo:ng,runHistorical:ig,simulate:kr,monteCarloReturns:pd};window._constants={EQUITY_RETURNS:qi,INFLATION:aa};window._mathUtils={seededRng:hc};let yg=null,vg=null;function bg(){yg=null,vg=null;const t=document.getElementById("mcResults"),e=document.getElementById("histResults");t&&(t.innerHTML=""),e&&(e.innerHTML="");const n=document.getElementById("optimiseResultsMC"),i=document.getElementById("optimiseResultsHist");n&&(n.innerHTML=""),i&&(i.innerHTML="")}function wg(){document.querySelectorAll(".sub-tab[data-stresstab]").forEach(n=>n.classList.remove("active"));const t=document.querySelector('.sub-tab[data-stresstab="montecarlo"]');t&&t.classList.add("active"),document.querySelectorAll(".stress-subtab").forEach(n=>n.classList.add("hidden"));const e=document.getElementById("stress-montecarlo");e&&e.classList.remove("hidden")}function _g(){document.querySelectorAll(".sub-tab[data-decisiontab]").forEach(n=>n.classList.remove("active"));const t=document.querySelector('.sub-tab[data-decisiontab="entry"]');t&&t.classList.add("active"),document.querySelectorAll(".decision-subtab").forEach(n=>n.classList.add("hidden"));const e=document.getElementById("decision-entry");e&&e.classList.remove("hidden")}const Eg=document.createElement("style");Eg.textContent=px()+zx()+Kx()+Jx()+aS()+Cx()+uS();document.head.appendChild(Eg);const Td=document.getElementById("globalLoadingOverlay"),hS=Td.querySelector(".loading-text");function At(t="Loading..."){hS.textContent=t,Td.classList.add("active")}function kt(){Td.classList.remove("active")}window.showToast=function(e,n="info",i=3e3){const r=document.querySelector(".toast-notification");r&&r.remove();const s=document.createElement("div");s.className=`toast-notification ${n}`,s.innerHTML=`
      ...
      `,document.body.appendChild(s),document.getElementById("editToolsCancel").addEventListener("click",()=>s.remove()),s.addEventListener("click",o=>{o.target===s&&s.remove()}),document.getElementById("editToolsSave").addEventListener("click",async()=>{const o=[];if(document.getElementById("editToolStress").checked&&o.push("stress"),document.getElementById("editToolDecision").checked&&o.push("decision"),o.length===0){showToast("Please select at least one tool","error");return}const l=o.filter(c=>!e.includes(c));try{await cI(t,o);const c=await Bt();if(c&&c.id===t){Sd(o);const d=document.querySelector(".tab.active");if(d&&d.style.display==="none"){const f=document.querySelector('.tab:not([style*="display: none"])');if(f){document.querySelectorAll(".tab").forEach(w=>w.classList.remove("active")),f.classList.add("active"),document.querySelectorAll(".tab-content").forEach(w=>w.classList.remove("active"));const m=f.dataset.tab+"-content",p=document.getElementById(m);p&&p.classList.add("active")}}}if(await gr(),s.remove(),l.length>0){let d=null;try{if(l.includes("stress")&&e.includes("decision")){const p=await bt();p&&(d={source:"decision",...p})}else if(l.includes("decision")&&e.includes("stress")){const p=await Lt();p&&(d={source:"stress",...p})}}catch(p){console.warn("Could not load existing settings for pre-fill:",p)}const f=document.getElementById("setupWizard");f.style.display="block",document.getElementById("mainApp").style.display="none",oS(f,l,async p=>{Vr();try{l.includes("stress")&&(await Js({equityMin:p.equityMin,bondMin:p.bondMin,cashTarget:p.cashTarget,isaBalance:p.isaBalance||0,duration:p.duration,baseSalary:p.baseSalary,other:p.otherIncome||0,taxMode:p.taxMode||"inflates",equityGlideEnabled:p.equityGlideEnabled||!1}),Hn()),l.includes("decision")&&(await Qs({equityMin:p.decisionEquity,bondMin:p.decisionBond,cashTarget:p.decisionCash,isaBalance:p.decisionIsaBalance||0,duration:p.decisionDuration,baseSalary:p.decisionSalary,spStartDate:p.spStartDate||null,spWeeklyAmount:p.spWeeklyAmount||0,equityGlideEnabled:p.decisionEquityGlideEnabled||!1}),Ei())}catch(w){console.error("Error saving new tool settings:",w)}await xd(),showToast("New tool configured successfully","success")},d)}else showToast("Tools updated","success")}catch(c){console.error("Error updating scenario tools:",c),showToast("Failed to update tools: "+c.message,"error")}})}const ec=60*60*1e3,Ag="pt_lastActivity";let Lo=null,ef=0;function kg(){const t=Date.now();if(t-ef>1e4){ef=t;try{localStorage.setItem(Ag,String(t))}catch{}}}function mS(){try{return+localStorage.getItem(Ag)||0}catch{return 0}}async function Rg(){if(!dt())return;const t=Date.now()-mS();if(t<ec){Lo=setTimeout(Rg,Math.max(6e4,ec-t));return}showToast("You have been logged out due to inactivity (1 hour).","info",5e3);try{Ei(),Hn(),yn(),await sd(),document.getElementById("mainApp").classList.add("hidden"),Fr(),Vr(),Ms("signin")}catch(e){console.error("Auto-logout error:",e)}}function Pg(){Lo&&clearTimeout(Lo),dt()&&(Lo=setTimeout(Rg,ec))}const gS=["mousedown","mousemove","keydown","scroll","touchstart","click"];gS.forEach(t=>{document.addEventListener(t,()=>{kg(),Pg()},{passive:!0})});kg();Pg();Am(t=>{const e=!document.getElementById("mainApp").classList.contains("hidden");!t&&e&&(document.getElementById("mainApp").classList.add("hidden"),Fr(),Vr(),Ms("signin"),showToast("You’ve been signed out — sign in again to continue. Unsaved changes in open forms were not stored.","warning",8e3))});document.getElementById("resetBtn").addEventListener("click",async()=>{if(!(!confirm(`⚠️ WARNING: This will permanently delete ALL your data including:
...
Continue anyway?`)}return!0}window.handleDecisionSubmit=async function(t){t.preventDefault();const e=document.getElementById("entryMonth").value,n=parseFloat(document.getElementById("entryEquity").value)||0,i=parseFloat(document.getElementById("entryBond").value)||0,r=parseFloat(document.getElementById("entryCash").value)||0,s=[];if(e||s.push("Month"),!n&&n!==0&&s.push("Equity Fund"),!i&&i!==0&&s.push("Bond Balance"),!r&&r!==0&&s.push("Cash Balance"),s.length>0){showToast("Missing: "+s.join(", "),"error",4e3);return}if(!kd(n,i,r))return;if((await tr({limit:1e3})).find(c=>c.date===e)){showToast(`${Rr(e)} already has a saved decision. Delete it from the History tab first to recalculate.`,"error",5e3);return}try{if((await Ex(e)).showWizard){const f=document.getElementById("taxYearWizard");f.style.display="block",window._pendingDecisionForm={dateStr:e,equity:n,bond:i,cash:r},_x(f,e,async m=>{if(f.style.display="none",m&&m.completed)try{dr=await nf(e,n,i,r);const p=document.getElementById("decisionOutput");Wh(dr,p),document.getElementById("saveBtn").disabled=!1}catch(p){console.error("Decision error after wizard:",p),showToast("Error: "+p.message,"error")}});return}dr=await nf(e,n,i,r);const d=document.getElementById("decisionOutput");Wh(dr,d),document.getElementById("saveBtn").disabled=!1}catch(c){console.error("Decision error:",c),showToast("Error: "+c.message,"error")}};window.saveCurrentDecision=async function(){const t=document.getElementById("saveBtn");if(!dr){showToast("No decision to save","error");return}if(!dt()){showToast("Please sign in to save decisions","error");return}t.classList.add("loading"),t.disabled=!0;try{await II(dr),showToast("Decision saved to history","success"),await mn()}catch(e){console.error("Save error:",e),showToast("Error saving: "+e.message,"error"),t.disabled=!1}finally{t.classList.remove("loading")}};function Rd(t){const e=r=>"£"+Math.round(r||0).toLocaleString(),n=(t.diversifierStart||0)>0?` · Diversifiers ${e(t.diversifierStart)}`:"",i=`Starting balances come from your <strong>Settings</strong> (Fund Minimums): Equity ${e(t.equityMin)} · Bond ${e(t.bondMin)}${n} · Cash ${e(t.cashTarget)}. Edit them in the Settings tab.`;["mcStartSummary","histStartSummary","scenStartSummary"].forEach(r=>{const s=document.getElementById(r);s&&(s.innerHTML=i)}),["mcYears","histYears"].forEach(r=>{const s=document.getElementById(r);s&&(s.value=t.duration)})}window.runMonteCarloUI=async function(){const t=await Lt(),e={years:parseInt(document.getElementById("mcYears").value)||t.duration},n=document.getElementById("optimiseResultsMC");n&&(n.innerHTML=""),document.getElementById("mcResults").innerHTML='<div class="loading"><div class="spinner"></div>Running simulation...</div>',setTimeout(()=>{try{const{results:i,stats:r}=Mx(e);yg=i,Dg(r,i,"Monte Carlo (1000 runs)","mcResults",e.years)}catch(i){console.error("Simulation error:",i),document.getElementById("mcResults").innerHTML=`<div class="alert alert-danger">Error: ${i.message}</div>`}},50)};window.runHistoricalUI=async function(){const t=await Lt(),e={years:parseInt(document.getElementById("histYears").value)||t.duration},n=document.getElementById("optimiseResultsHist");n&&(n.innerHTML=""),document.getElementById("histResults").innerHTML='<div class="loading"><div class="spinner"></div>Running simulation...</div>',setTimeout(()=>{try{const{results:i,stats:r}=Dx(e);vg=i,Dg(r,i,"Historical Analysis","histResults",e.years)}catch(i){console.error("Simulation error:",i),document.getElementById("histResults").innerHTML=`<div class="alert alert-danger">Error: ${i.message}</div>`}},50)};window.runScenariosUI=async function(){await Lt();const t={};document.getElementById("scenResults").innerHTML='<div class="loading"><div class="spinner"></div>Running scenarios...</div>',setTimeout(()=>{try{const e=Bx(t);SS(e,"scenResults")}catch(e){console.error("Scenario error:",e),document.getElementById("scenResults").innerHTML=`<div class="alert alert-danger">Error: ${e.message}</div>`}},50)};let ai=!1,ls=0;function yS(){ls++}window.runOptimisationUI=async function(t){if(ai)return;ai=!0;const e=++ls,n=document.getElementById("optimiseBtn"+t),i=document.getElementById("optimiseResults"+t);n&&(n.disabled=!0),n&&(n.textContent="Optimising..."),i.innerHTML='<div class="loading"><div class="spinner"></div>Preparing optimisation...</div>';const r=await Lt(),s=JSON.parse(JSON.stringify(r)),o=document.getElementById(t==="MC"?"mcYears":"histYears"),l=parseInt(o&&o.value)||s.duration,c=(s.equityMin||0)+(s.bondMin||0)+(s.cashTarget||0);if(e!==ls){ai=!1,n&&(n.disabled=!1,n.textContent="Optimise Allocation");return}const d=[];for(let b=5;b<=90;b+=5)for(let E=5;E<=95-b;E+=5){const S=100-b-E;S>=0&&d.push({equity:Math.round(c*E/100),bond:Math.round(c*S/100),cash:Math.round(c*b/100)})}const{EQUITY_RETURNS:f,INFLATION:m}=window._constants,{simulate:p,monteCarloReturns:w}=window._simEngine,x=Object.keys(f).map(Number).sort((b,E)=>b-E),I=Math.max(...x),A=b=>{const E={...s,equityMin:b.equity,bondMin:b.bond,cashTarget:b.cash},S=Xs({years:l},E),v=[];if(t==="MC")for(let O=0;O<1e3;O++)v.push(p(S,w(S,O),O));else x.forEach(O=>{if(O+l-1>I)return;const Z={equity:{},inflation:{}};for(let _e=0;_e<l;_e++)Z.equity[_e]=f[O+_e]||0,Z.inflation[_e]=m[O+_e]||.025;v.push(p(S,Z,O))});const le=v.filter(O=>O.failed);v.filter(O=>!O.failed);const pe=(v.length-le.length)/v.length*100,H=v.reduce((O,Z)=>O+Math.min(1,(Z.years||0)/(Z.duration||l)),0)/v.length*100,ne=v.map(O=>O.protMonths).reduce((O,Z)=>O+Z,0)/v.length,te=v.filter(O=>O.protMonths>0).length,Me=v.map(O=>O.failed?0:O.finalReal||0).sort((O,Z)=>O-Z),Pe=Me.length?Me[Math.floor(Me.length*.5)]:0,ve=Me.length?Me[Math.floor(Me.length*.9)]:0;return{equity:b.equity,bond:b.bond,cash:b.cash,rate:pe,coverage:H,avgProt:ne,withProt:te,totalRuns:v.length,medianFinal:Pe,p90Final:ve}};let R;try{const b={equity:s.equityMin||0,bond:s.bondMin||0,cash:s.cashTarget||0},E=A(b);R={...b,...E}}catch(b){console.error("Optimisation error (original):",b),i.innerHTML='<div class="alert alert-danger">Error: '+b.message+"</div>",ai=!1,n&&(n.disabled=!1,n.textContent="Optimise Allocation");return}const C=10;let L=0;const N=[];let z=null;function $(b){const E=Math.max(...b.map(v=>v.coverage)),S=b.filter(v=>v.coverage>=E-.5);return S.sort((v,le)=>v.avgProt-le.avgProt||le.medianFinal-v.medianFinal),S[0]}function T(b,E){return Math.round(b.equity)===Math.round(E.equity)&&Math.round(b.bond)===Math.round(E.bond)&&Math.round(b.cash)===Math.round(E.cash)}function y(){if(e!==ls){ai=!1,n&&(n.disabled=!1,n.textContent="Optimise Allocation"),i.innerHTML="";return}try{const b=Math.min(L+C,d.length);for(;L<b;L++)N.push(A(d[L]));i.innerHTML='<div class="loading"><div class="spinner"></div>Testing allocations... '+L+"/"+d.length+"</div>",L<d.length?setTimeout(y,0):(z=$([...N,R]),_())}catch(b){console.error("Optimisation error:",b),i.innerHTML='<div class="alert alert-danger">Error: '+b.message+"</div>",ai=!1,n&&(n.disabled=!1,n.textContent="Optimise Allocation")}}function _(){if(e!==ls){ai=!1,n&&(n.disabled=!1,n.textContent="Optimise Allocation"),i.innerHTML="";return}const b=c>0?R.cash/c*100:0,E=c>0?R.equity/c*100:0,v=b>90||b<5||E<5?'<div class="alert alert-info" style="margin-bottom:16px;font-size:13px;">Your current split is outside the range the optimiser sweeps, but it was included in this comparison.</div>':"",le=z&&!T(z,R)&&(z.coverage>R.coverage+.5||z.coverage>=R.coverage-.01&&z.avgProt<R.avgProt-3),pe=(ee,ne)=>{const te=Me=>Math.round(Me/c*100);return'<div style="padding:16px;border-radius:8px;'+(ne?"background:rgba(46,160,67,0.1);border:1px solid var(--success);":"background:rgba(0,0,0,0.2);")+'"><div style="font-weight:500;margin-bottom:10px;color:var(--'+(ne?"success":"text-muted")+');">'+(ne?"Optimised split":"Your current split")+'</div><div style="font-size:26px;font-weight:700;color:var(--'+(ne?"success":"warning")+');">'+ee.coverage.toFixed(0)+'%</div><div style="font-size:12px;color:var(--text-muted);margin-bottom:8px;">of retirement years funded'+(ne?" ("+(z.coverage-R.coverage>=0?"+":"")+(z.coverage-R.coverage).toFixed(0)+"%)":"")+'</div><div style="font-size:13px;">Equity '+te(ee.equity)+"% · Bonds "+te(ee.bond)+"% · Cash "+te(ee.cash)+'%</div><div style="font-size:12px;color:var(--text-muted);margin-top:8px;">'+ee.rate.toFixed(0)+"% never run out · "+j(ee.medianFinal)+" typically left</div></div>"};let H="";if(le){const ee=z.medianFinal-R.medianFinal,ne=R.medianFinal>0?ee/R.medianFinal*100:0;H+='<div class="card" style="margin-top:20px;border-color:var(--success);">',H+='<h3 style="color:var(--success);margin-top:0;">A better fund split</h3>',H+='<p style="color:var(--text-muted);margin-bottom:16px;">This split funds more of your retirement (higher coverage). Coverage credits a plan for every year it pays for, so it prefers splits that fall short late over ones that fail early.</p>',H+=v,H+='<div class="grid-2" style="gap:20px;margin-bottom:20px;">'+pe(R,!1)+pe(z,!0)+"</div>",ee<0?H+='<div class="alert alert-warning" style="margin-bottom:16px;"><strong>Trade-off:</strong> it typically leaves '+Math.abs(ne).toFixed(0)+"% less at the end (usually less equity) — more safety, a bit less upside.</div>":ee>0&&(H+='<div class="alert alert-info" style="margin-bottom:16px;"><strong>Bonus:</strong> it also typically leaves '+ne.toFixed(0)+"% more at the end.</div>"),H+='<button onclick="applyOptimisedAllocationUI('+z.equity+","+z.bond+","+z.cash+')" style="width:100%;">Apply this split to your Settings</button>',H+="</div>"}else H+='<div class="card" style="margin-top:20px;border-color:var(--primary);">',H+='<h3 style="color:var(--primary);margin-top:0;">Your split is already about as good as it gets</h3>',H+=v,H+='<p style="color:var(--text-muted);">We tested '+d.length+" fund splits. Yours funds "+R.coverage.toFixed(0)+"% of retirement years — the best, or within 0.5% of it, with no clearly better low-protection alternative.</p>",H+='<p style="font-size:13px;color:var(--text-muted);">Your split — Equity '+Math.round(E)+"% · Bonds "+Math.round(R.bond/c*100)+"% · Cash "+Math.round(b)+"% · "+R.rate.toFixed(0)+"% never run out.</p>",H+="</div>";i.innerHTML=H,ai=!1,n&&(n.disabled=!1,n.textContent="Optimise Allocation")}setTimeout(y,0)};window.applyOptimisedAllocationUI=async function(t,e,n){if(writeAlloc("ss",t,e,n),writeAlloc("ds",t,e,n),Rd({equityMin:t,bondMin:e,cashTarget:n,duration:parseInt(document.getElementById("ssDuration").value)||35}),qa(),dt())try{await Js({equityMin:t,bondMin:e,cashTarget:n})}catch(i){console.error("Error saving optimised settings:",i)}showToast("Optimised allocation applied to settings and starting values. Scroll up to re-run.","success",4e3)};const vS={1929:"Wall Street Crash / Great Depression",1930:"Great Depression",1931:"Great Depression",1932:"Great Depression",1937:"Recession of 1937",1968:"Late 1960s stagflation",1969:"Late 1960s recession",1973:"Oil Crisis / 1973-74 crash",1974:"1973-74 bear market",2e3:"Dot-com bubble burst",2001:"Dot-com bust / 9/11",2007:"Global Financial Crisis",2008:"Global Financial Crisis",2022:"Post-COVID inflation / rate hikes"};function bS(t){if(!t||t.length===0)return"";const e=t.filter(s=>s.failed).sort((s,o)=>s.years-o.years),n=t.filter(s=>s.protMonths>0).sort((s,o)=>o.protMonths-s.protMonths),i=e.length>0?e.slice(0,5):n.slice(0,5);if(i.length===0)return"";let r=`
        <details style="margin-top: 24px;">
          ...
          <div style="overflow-x: auto;">
            <table class="data-table" style="width: 100%; margin-top: 10px;">
              ...
              <tbody>
      `;return i.forEach(s=>{const o=s.startYear||s.seed,l=vS[o]||"-",c=s.failed?"danger":"success";r+=`
          <tr>
            <td>${o}</td>
      ...
      `,r}function Dn(t){return`<span class="hlp" tabindex="0" data-tip="${String(t).replace(/"/g,"&quot;")}">?</span>`}function wS(){if(window.__helpTipInit)return;window.__helpTipInit=!0;const t=document.createElement("div");t.className="help-tip",t.style.display="none",document.body.appendChild(t);let e=null;const n=r=>{const s=r.getAttribute("data-tip");if(!s)return;clearTimeout(e),t.textContent=s,t.style.display="block";const o=r.getBoundingClientRect(),l=Math.min(260,window.innerWidth-24);t.style.width=l+"px";let c=o.left+o.width/2-l/2+window.scrollX;c=Math.max(12+window.scrollX,Math.min(c,window.scrollX+window.innerWidth-l-12)),t.style.left=c+"px";const d=t.offsetHeight;let f=o.top+window.scrollY-d-8;o.top<d+12&&(f=o.bottom+window.scrollY+8),t.style.top=f+"px"},i=()=>{e=setTimeout(()=>{t.style.display="none"},80)};document.addEventListener("mouseover",r=>{const s=r.target.closest&&r.target.closest("[data-tip]");s&&n(s)}),document.addEventListener("mouseout",r=>{r.target.closest&&r.target.closest("[data-tip]")&&i()}),document.addEventListener("focusin",r=>{const s=r.target.closest&&r.target.closest("[data-tip]");s&&n(s)}),document.addEventListener("focusout",r=>{r.target.closest&&r.target.closest("[data-tip]")&&i()}),document.addEventListener("click",r=>{const s=r.target.closest&&r.target.closest("[data-tip]");s&&(t.style.display==="block"?i():n(s))})}function _S(){if(window.__chartHoverInit)return;window.__chartHoverInit=!0;const t=e=>e.querySelectorAll("circle[data-tip]").forEach(n=>{n.setAttribute("fill","transparent"),n.removeAttribute("stroke")});document.addEventListener("mousemove",e=>{const n=e.target.closest&&e.target.closest(".ichart");if(!n)return;const i=n.querySelectorAll("circle[data-tip]");if(!i.length)return;let r=null,s=1/0;i.forEach(o=>{const l=o.getBoundingClientRect(),c=Math.abs(l.left+l.width/2-e.clientX);c<s&&(s=c,r=o)}),r&&(t(n),r.setAttribute("fill","#60a5fa"),r.setAttribute("stroke","var(--surface,#161b22)"),r.setAttribute("stroke-width","2"),r.dispatchEvent(new MouseEvent("mouseover",{bubbles:!0})))}),document.addEventListener("mouseout",e=>{const n=e.target.closest&&e.target.closest(".ichart");n&&t(n)})}const Fi=t=>"£"+Math.round(t).toLocaleString();function Cg(t,e,n){return`<svg class="ichart" viewBox="0 0 ${e} ${n}" style="width:100%;height:auto;overflow:visible;display:block" role="img">${t}</svg>`}function Mg(t,{max:e,valueFmt:n=Fi,tip:i,pct:r=!1}={}){const m=t.length;if(m<2)return"";const p=e??(r?100:Math.max(1,...t)),w=N=>56+N/(m-1)*590,x=N=>174-Math.max(0,Math.min(r?100:1/0,N))/p*160,I=t.map((N,z)=>`${w(z).toFixed(1)},${x(N).toFixed(1)}`).join(" "),A=`56,${174 .toFixed(1)} ${I} ${w(m-1).toFixed(1)},${174 .toFixed(1)}`,R=r?[0,50,100]:[0,p/2,p],C=[0,Math.floor((m-1)/2),m-1],L=i||((N,z)=>`Year ${z}: ${n(N)}`);return Cg(R.map(N=>`<line x1="56" y1="${x(N).toFixed(1)}" x2="646" y2="${x(N).toFixed(1)}" stroke="var(--border,#8883)" opacity=".45"/><text x="50" y="${(x(N)+3).toFixed(1)}" text-anchor="end" font-size="10" fill="var(--text-muted,#999)">${n(N)}</text>`).join("")+`<polygon points="${A}" fill="rgba(96,165,250,.13)"/><polyline points="${I}" fill="none" stroke="#60a5fa" stroke-width="2.5"/>`+t.map((N,z)=>`<circle cx="${w(z).toFixed(1)}" cy="${x(N).toFixed(1)}" r="8" fill="transparent" data-tip="${L(N,z).replace(/"/g,"&quot;")}"></circle>`).join("")+C.map(N=>`<text x="${w(N).toFixed(1)}" y="192" text-anchor="middle" font-size="10" fill="var(--text-muted,#999)">Year ${N}</text>`).join(""),660,200)}function ES(t){const l=t.p50.length;if(l<2)return"";const c=Math.max(1,...t.p90),d=I=>60+I/(l-1)*606,f=I=>222-Math.max(0,I)/c*208,m=(I,A)=>I.map((R,C)=>`${d(C).toFixed(1)},${f(R).toFixed(1)}`).concat(A.map((R,C)=>`${d(l-1-C).toFixed(1)},${f(A[l-1-C]).toFixed(1)}`)).join(" "),p=I=>I.map((A,R)=>`${d(R).toFixed(1)},${f(A).toFixed(1)}`).join(" "),w=[0,c/4,c/2,3*c/4,c],x=[0,Math.floor((l-1)/2),l-1];return Cg(w.map(I=>`<line x1="60" y1="${f(I).toFixed(1)}" x2="666" y2="${f(I).toFixed(1)}" stroke="var(--border,#8883)" opacity=".4"/><text x="54" y="${(f(I)+3).toFixed(1)}" text-anchor="end" font-size="10" fill="var(--text-muted,#999)">${Fi(I)}</text>`).join("")+`<polygon points="${m(t.p90,t.p10)}" fill="rgba(96,165,250,.12)"/><polygon points="${m(t.p75,t.p25)}" fill="rgba(96,165,250,.22)"/><polyline points="${p(t.p50)}" fill="none" stroke="#60a5fa" stroke-width="2.5"/>`+t.p50.map((I,A)=>`<circle cx="${d(A).toFixed(1)}" cy="${f(I).toFixed(1)}" r="8" fill="transparent" data-tip="Year ${A}: middle ${Fi(I)}; likely range ${Fi(t.p10[A])} to ${Fi(t.p90[A])}"></circle>`).join("")+x.map(I=>`<text x="${d(I).toFixed(1)}" y="242" text-anchor="middle" font-size="10" fill="var(--text-muted,#999)">Year ${I}</text>`).join(""),680,250)}function TS(t){if(!t||!t.funded)return"";const e=r=>(r||0).toFixed(r>=10?0:1),n=t.pctSurviveFullTerm>=80?"success":t.pctSurviveFullTerm>=50?"warning":"danger",i=t.avgHigherRateYears<1?"success":t.avgHigherRateYears<4?"warning":"danger";return`
        ...
        <div class="verdict-basis">Based on ${e}. Pot and income values are shown in today's money.</div>
          ...
          <p>${n.diagnosis}</p>
          <p class="lever"><strong>What could help:</strong> ${IS(n.primaryDriver)}</p>
        </div>`),s}function Dg(t,e,n,i,r){wS(),_S();const s=t.survival||{},o=t.finalReal||{},l=t.protection||{},c=l.pctWithProtection!=null?l.pctWithProtection:(l.runsWithProtection||0)/(e.length||1)*100,d=i==="mcResults",f=d?`${e.length.toLocaleString()} simulated futures`:`${e.length} historical periods since 1928`;let m=`
        <div class="card">
          <h2>${n}</h2>
      ...
      `;document.getElementById(i).innerHTML=m}function SS(t,e){let n='<div class="card"><h2>Scenario Analysis</h2>';n+=`
...
Continue?`))return;At(`Deleting ${c.length} entries...`);try{await lc(c),showToast(`Deleted ${c.length} entries`,"success"),zt=null,await mn()}catch(f){console.error("Delete error:",f),showToast("Error deleting: "+f.message,"error")}finally{kt()}}};window.deleteHistoryForTaxYear=async function(t){if(!dt()){showToast("Please sign in to delete entries","error");return}const n=(await tr({sortDesc:!1,limit:1e3})).filter(i=>(i.taxYear||oa(i.date))===t);if(n.length===0){showToast(`No history entries for tax year ${t}`,"info");return}if(confirm(`Delete all ${n.length} history entries for tax year ${t}?`)){At(`Deleting tax year ${t}...`);try{await lc(n);const i=await Qn();i[t]&&await er(t,{...i[t],isaSavingsUsed:0}),showToast(`Deleted all entries for ${t}`,"success"),zt=null,await mn()}catch(i){console.error("Delete error:",i),showToast("Error deleting: "+i.message,"error")}finally{kt()}}};window.deleteHistoryForSelectedYear=async function(){if(ln==="all"){showToast("Select a specific year first","error");return}const t=`${parseInt(ln)%100}/${(parseInt(ln)+1)%100}`;await deleteHistoryForTaxYear(t)};window.deleteAllHistory=async function(){if(confirm("Delete ALL history entries? This cannot be undone.")&&confirm("Are you ABSOLUTELY sure? All decision history will be permanently deleted.")){if(!dt()){showToast("Please sign in to delete entries","error");return}At("Deleting all history...");try{const t=await tr({limit:1e3});for(const n of t)await Km(n.date);const e=await Qn();for(const[n,i]of Object.entries(e))i.isaSavingsUsed>0&&await er(n,{...i,isaSavingsUsed:0});showToast(`Deleted ${t.length} entries`,"success"),zt=null,await mn()}catch(t){console.error("Delete all error:",t),showToast("Error deleting: "+t.message,"error")}finally{kt()}}};let Bi=null;async function Ji(){const t=document.getElementById("taxYearTabs"),e=document.getElementById("taxYearDetail");if(!t||!e)return;t.innerHTML='<span class="loading">Loading...</span>';const n=await Qn(),i=await bt(),r=Object.keys(n).sort(),s=HS(),o=WS(r,s,40);let l="";o.forEach(f=>{const m=n[f],p=m&&m.yearSetupComplete,w=f===Bi,x=["tax-year-tab"];w&&x.push("active"),p||x.push("not-setup"),l+=`<button class="${x.join(" ")}" onclick="selectTaxYear('${f}')">${f}</button>`}),t.innerHTML=l;const c=document.getElementById("taxYearMobileSelector");if(c){let f="";o.forEach(m=>{const p=n[m],x=p&&p.yearSetupComplete?m:`${m} (not set up)`;f+=`<option value="${m}">${x}</option>`}),c.innerHTML=f}if(!Bi){const f=r.filter(m=>{var p;return(p=n[m])==null?void 0:p.yearSetupComplete});Bi=f.length>0?f[f.length-1]:s}c&&(c.value=Bi),await Gg(Bi,n,i);const d=t.querySelector(".tax-year-tab.active");d&&d.scrollIntoView({behavior:"smooth",inline:"center",block:"nearest"})}function HS(){const t=new Date,e=t.getFullYear(),n=t.getMonth()+1;return n<4||n===4&&t.getDate()<6?`${String(e-1).slice(-2)}/${String(e).slice(-2)}`:`${String(e).slice(-2)}/${String(e+1).slice(-2)}`}function WS(t,e,n){const i=new Set(t),[r]=e.split("/").map(Number),s=r<50?2e3+r:1900+r;for(let o=0;o<n&&i.size<n;o++){const l=s+o,c=l+1;i.add(`${String(l).slice(-2)}/${String(c).slice(-2)}`)}return Array.from(i).sort()}async function Gg(t,e,n){var _,b,E,S,v,le,pe,H,ee,ne,te,Me,Pe,ve;const i=document.getElementById("taxYearDetail"),r=e[t];if(!r||!r.yearSetupComplete){i.innerHTML=`
        ...
        `;return}const s=await ud(t),o=Math.round(s.amount||0),l=s.startDate||"Not configured",c=s.isReceiving;s.yearsUntil;const d=O=>O!=null?"£"+Math.round(O).toLocaleString():"—",f=(n.equityMin||0)+(n.bondMin||0)+(n.cashTarget||0),m=n.duration||35,p=Math.max(0,2e3+(parseInt(t.split("/")[0],10)||26)-2026),w=!!n.equityGlideEnabled,x={equity:f>0?n.equityMin/f:.5,bond:f>0?n.bondMin/f:.4,cash:f>0?n.cashTarget/f:.1,equityGlide:w?Ls(n.equityMin,n.bondMin):void 0},I=El(x,p,m),A=El(x,Math.max(0,p-1),m),R=O=>Math.round(O*100),C=Math.max(5,m-20),L=R(I.equity)-R(A.equity),N=`${R(I.equity)}% shares / ${R(I.bond)}% bonds / ${R(I.cash)}% cash`;let z,$;w?p>C?($=`Holding — reached your mix at year ${C}`,z=`You've reached your endgame mix. Hold ${N}; no glide change this year.`):L>0?($=`Rising — year ${p} of ${C}`,z=`Shift about ${L}% of your pot from bonds into shares this year, reaching ${N}.`):($=`Rising — year ${p} of ${C}`,z=`Hold ${N}.`):($="Flat (bond tent off)",z=`Hold a steady ${N}. Rebalance back to this whenever it drifts.`);const T=`
        ...
        <div class="tax-year-detail-card">
          ...
          <div class="tax-year-grid">
            ...
            <div class="tax-year-field">
              ...
              <span class="value">${YS(r.startMonth||4)}</span>
            </div>
            <div class="tax-year-field">
