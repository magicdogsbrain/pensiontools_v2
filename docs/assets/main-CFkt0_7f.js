 ...
 */function Uf(n){return Oo(n=St(n,Jn)),new bb(n,e=>fi(n,e))}(function(e,t=!0){(function(s){os=s})(ss),Wr(new mr("firestore",(r,{instanceIdentifier:s,options:i})=>{const a=r.getProvider("app").getImmediate(),l=new Jn(new w0(r.getProvider("auth-internal")),new T0(r.getProvider("app-check-internal")),function(d,f){if(!Object.prototype.hasOwnProperty.apply(d.options,["projectId"]))throw new U(k.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new js(d.options.projectId,f)}(a,s),a);return i=Object.assign({useFetchStreams:t},i),l._setSettings(i),l},"PUBLIC").setMultipleInstances(!0)),Un(Du,"4.7.3",e),Un(Du,"4.7.3","esm2017")})();const qf={apiKey:"AIzaSyBdbve0H70D-Ch69WlaxEly7PVBFVRB5p0",authDomain:"pensiontools-4b237.firebaseapp.com",projectId:"pensiontools-4b237",storageBucket:"pensiontools-4b237.firebasestorage.app",messagingSenderId:"760877353696",appId:"1:760877353696:web:2d6f7173c8d7fab6fd9e85",measurementId:"G-80XX542QZE"};function Oe(){return qf.apiKey!=="YOUR_API_KEY"}let Aa=null,yt=null,ct=null;try{Oe()?(Aa=Od(qf),yt=m0(Aa),ct=rb(Aa)):console.warn("Firebase not configured. Login required to save data.")}catch(n){console.error("Firebase initialization error:",n)}const Eb=new ln;let On=null,Vs=[];function Tb(){if(!Oe()||!yt){console.warn("Firebase not configured - auth disabled");return}rv(yt,n=>{console.log("onAuthStateChanged fired:",n?n.email:"null"),On=n,console.log("Notifying",Vs.length,"listeners"),Vs.forEach(e=>e(n))})}function Ib(n){return console.log("onAuthStateChange: adding listener, currentUser is:",On&&On.email),Vs.push(n),On&&(console.log("onAuthStateChange: immediately calling listener with user"),n(On)),()=>{Vs=Vs.filter(e=>e!==n)}}function Sr(){return On}function ht(){return On!==null}async function Sb(n,e,t=null){if(!Oe()||!yt)throw new Error("Firebase not configured");const r=await Jy(yt,n,e);return t&&r.user&&await ev(r.user,{displayName:t}),r}async function Ab(n,e){if(!Oe()||!yt)throw new Error("Firebase not configured");return Xy(yt,n,e)}async function xb(){if(!Oe()||!yt)throw new Error("Firebase not configured");console.log("Initiating Google sign-in popup...");try{const n=await Iv(yt,Eb);return console.log("Google sign-in successful:",n.user.email),n}catch(n){throw console.error("signInWithPopup error:",n.code,n.message),n}}async function Hf(){if(!Oe()||!yt)throw new Error("Firebase not configured");return sv(yt)}async function Rb(n){if(!Oe()||!yt)throw new Error("Firebase not configured");return Qy(yt,n)}Tb();function Nr(...n){return n.find(e=>e!==void 0)}function Pb(n){if(!n||typeof n!="object")return{scenario:n,migrated:!1};const e=Object.keys(n).filter(c=>c.includes(".")),t="decisionSettings"in n||"stressSettings"in n||"name"in n||"description"in n||"taxYears"in n;if(!(e.length>0||t))return{scenario:n,migrated:!1};const s=n.decisionTool||{},i=n.stressTool||{},a=n.planDetails||{},l={isActive:n.isActive??!1,enabledTools:n.enabledTools||["stress","decision"],planDetails:{name:Nr(n["planDetails.name"],a.name,n.name)??"My Plan",description:Nr(n["planDetails.description"],a.description,n.description)??""},decisionTool:{settings:Nr(n["decisionTool.settings"],s.settings,n.decisionSettings)??{},history:Nr(n["decisionTool.history"],s.history)??[],taxYears:Nr(n["decisionTool.taxYears"],s.taxYears,n.taxYears)??{}},stressTool:{settings:Nr(n["stressTool.settings"],i.settings,n.stressSettings)??{}}};return n.id!==void 0&&(l.id=n.id),n.createdAt!==void 0&&(l.createdAt=n.createdAt),n.lastModified!==void 0&&(l.lastModified=n.lastModified),{scenario:l,migrated:!0}}function tc(n,e="settings"){const t=Sr();return!t||!ct?null:ts(ct,"users",t.uid,n,e)}function jf(n){const e=Sr();return!e||!ct?null:nb(ct,"users",e.uid,n)}async function Yf(n){const{scenario:e,migrated:t}=Pb(n);if(t){const r=Sr();if(r&&ct)try{const{id:s,...i}=e;await gb(ts(ct,"users",r.uid,"scenarios",s),i)}catch(s){console.error("Scenario migration write failed:",s)}}return e}async function $o(){if(!Oe())return[];const n=jf("scenarios");if(!n)return[];try{const e=await mb(n),t=[];return e.forEach(r=>{t.push({id:r.id,...r.data()})}),Promise.all(t.map(r=>Yf(r)))}catch(e){return console.error("Error loading scenarios:",e),[]}}async function Cb(n){if(!Oe())return null;const e=tc("scenarios",n);if(!e)return null;try{const t=await pb(e);return t.exists()?Yf({id:t.id,...t.data()}):null}catch(t){return console.error("Error loading scenario:",t),null}}async function Ar(n,e){if(!Oe())return;const t=tc("scenarios",n);if(t)try{await yb(t,{...e,lastModified:new Date().toISOString()})}catch(r){throw console.error("Error saving scenario:",r),r}}async function Wf(n){if(!Oe())return null;const e=jf("scenarios");if(!e)return null;try{return(await wb(e,{...n,createdAt:new Date().toISOString(),lastModified:new Date().toISOString()})).id}catch(t){throw console.error("Error creating scenario:",t),t}}async function kb(n){if(!Oe())return;const e=tc("scenarios",n);if(e)try{await vb(e)}catch(t){throw console.error("Error deleting scenario:",t),t}}async function nc(n){if(!Oe())return;const e=Sr();if(!(!e||!ct))try{const t=await $o(),r=Uf(ct);for(const s of t){const i=ts(ct,"users",e.uid,"scenarios",s.id);s.id===n?r.update(i,{isActive:!0}):s.isActive&&r.update(i,{isActive:!1})}await r.commit()}catch(t){throw console.error("Error setting active scenario:",t),t}}async function Mb(){if(!Oe())return;const n=Sr();if(!(!n||!ct))try{const e=await $o(),t=Uf(ct);for(const r of e)t.delete(ts(ct,"users",n.uid,"scenarios",r.id));t.delete(ts(ct,"users",n.uid,"profile","settings")),await t.commit(),console.log("All user data wiped successfully")}catch(e){throw console.error("Error wiping user data:",e),e}}async function Db(){return Oe()?(await $o()).length>0:!1}let Hr=null,ke=null;function Xn(){return Oe()&&ht()}function In(){Hr=null,ke=null}function rc(){return{equityMin:ue.EQUITY_MIN,bondMin:ue.BOND_MIN,cashTarget:ue.CASH_TARGET,duration:ue.DURATION_YEARS,baseSalary:ue.BASE_SALARY,other:0,statePension:12e3,statePensionYear:12,pa:Fe.PERSONAL_ALLOWANCE,brl:Fe.BASIC_RATE_LIMIT,hrl:Fe.HIGHER_RATE_LIMIT,taxMode:"inflates",protectionMult:hr.PROTECTION_MULTIPLIER,consecutiveLimit:ue.CONSECUTIVE_LIMIT,disableProtection:!1,hodlEnabled:hr.HODL_ENABLED,hodlValue:hr.HODL_VALUE,isaBalance:0,isaReturn:Dt.RETURN,isaMin:Dt.MIN,isaDrawdownStrategy:Dt.DRAWDOWN_STRATEGY}}function Gf(){return{equityMin:ue.EQUITY_MIN,bondMin:ue.BOND_MIN,cashTarget:ue.CASH_TARGET,duration:ue.DURATION_YEARS,baseSalary:ue.BASE_SALARY,protectionFactor:ue.PROTECTION_FACTOR,recoveryBuffer:ue.RECOVERY_BUFFER,consecutiveLimit:ue.CONSECUTIVE_LIMIT,spStartDate:null,spWeeklyAmount:0,statePension:0,statePensionYear:0,isaBalance:0,isaReturn:Dt.RETURN,isaMin:Dt.MIN,isaDrawdownStrategy:Dt.DRAWDOWN_STRATEGY}}function Nb(n,e={},t=new Date().toISOString()){const r=n||{};return{...rc(),...e,equityMin:r.equityMin,bondMin:r.bondMin,cashTarget:r.cashTarget,duration:r.duration,baseSalary:r.baseSalary,spStartDate:r.spStartDate??e.spStartDate??null,spWeeklyAmount:r.spWeeklyAmount??e.spWeeklyAmount??0,consecutiveLimit:r.consecutiveLimit,recoveryBuffer:r.recoveryBuffer,protectionMult:r.protectionFactor!=null?1-r.protectionFactor/100:e.protectionMult??hr.PROTECTION_MULTIPLIER,isaBalance:r.isaBalance??0,isaReturn:r.isaReturn??Dt.RETURN,isaMin:r.isaMin??Dt.MIN,isaDrawdownStrategy:r.isaDrawdownStrategy??Dt.DRAWDOWN_STRATEGY,seededFrom:"decision",seededAt:t,decisionChecksum:ll(r)}}function Kf(){return{}}function Lb(n="My Plan",e="",t=["stress","decision"]){return{planDetails:{name:n,description:e},enabledTools:t,isActive:!0,decisionTool:{settings:Gf(),history:[],taxYears:Kf()},stressTool:{settings:rc()}}}async function sc(){if(Hr)return Hr;if(!Xn())return[];try{const n=await $o();return Hr=n,n}catch(n){return console.error("Error listing scenarios:",n),[]}}async function Bt(){if(ke)return ke;if(!Xn())return null;try{const e=(await sc()).find(t=>t.isActive);return e?(ke=e,e):null}catch(n){return console.error("Error getting active scenario:",n),null}}async function Ob(n,e,t,r={},s=!0){if(!Xn())throw new Error("Must be logged in to create scenarios");const i=Lb(n,e,t);if(r.stressSettings&&(i.stressTool.settings={...i.stressTool.settings,...r.stressSettings}),r.decisionSettings&&(i.decisionTool.settings={...i.decisionTool.settings,...r.decisionSettings}),r.taxYears&&(i.decisionTool.taxYears=r.taxYears),i.isActive=s,s&&Hr){const l=Hr.find(c=>c.isActive);l&&(await nc(null),await Ar(l.id,{isActive:!1}))}const a=await Wf(i);return In(),a}async function Bb(n){if(!Xn())throw new Error("Must be logged in to switch scenarios");await nc(n),In()}async function Vb(n,e){if(!Xn())throw new Error("Must be logged in to duplicate scenarios");const t=await Cb(n);if(!t)throw new Error("Source scenario not found");const{id:r,createdAt:s,lastModified:i,...a}=t;a.planDetails={...a.planDetails,name:e},a.isActive=!1;const l=await Wf(a);return In(),l}async function Fb(n,e){if(!Xn())throw new Error("Must be logged in to rename scenarios");await Ar(n,{"planDetails.name":e}),In()}async function $b(n,e){if(!Xn())throw new Error("Must be logged in to update scenarios");await Ar(n,{enabledTools:e}),In()}async function zb(n){if(!Xn())throw new Error("Must be logged in to delete scenarios");const e=await sc();if(e.length<=1)throw new Error("Cannot delete the last scenario");const t=e.find(r=>r.id===n);if(t!=null&&t.isActive){const r=e.find(s=>s.id!==n);r&&await nc(r.id)}await kb(n),In()}async function Ub(){var e;const n=await Bt();return((e=n==null?void 0:n.stressTool)==null?void 0:e.settings)||rc()}async function Qf(n){const e=await Bt();if(!e)throw new Error("No active scenario");await Ar(e.id,{"stressTool.settings":n}),ke&&(ke.stressTool||(ke.stressTool={}),ke.stressTool.settings=n)}async function qb(){var e;const n=await Bt();return((e=n==null?void 0:n.decisionTool)==null?void 0:e.settings)||Gf()}async function Hb(n){const e=await Bt();if(!e)throw new Error("No active scenario");await Ar(e.id,{"decisionTool.settings":n}),ke&&(ke.decisionTool||(ke.decisionTool={}),ke.decisionTool.settings=n)}async function jb(){var e;const n=await Bt();return((e=n==null?void 0:n.decisionTool)==null?void 0:e.taxYears)||Kf()}async function Yb(n){const e=await Bt();if(!e)throw new Error("No active scenario");await Ar(e.id,{"decisionTool.taxYears":n}),ke&&(ke.decisionTool||(ke.decisionTool={}),ke.decisionTool.taxYears=n)}async function Wb(){var e;const n=await Bt();return((e=n==null?void 0:n.decisionTool)==null?void 0:e.history)||[]}async function Jf(n){const e=await Bt();if(!e)throw new Error("No active scenario");await Ar(e.id,{"decisionTool.history":n}),ke&&(ke.decisionTool||(ke.decisionTool={}),ke.decisionTool.history=n)}async function Xf(){const n=await Bt();return(n==null?void 0:n.enabledTools)||["stress","decision"]}let Hn=null;function ji(){return{settings:{equityMin:ue.EQUITY_MIN,bondMin:ue.BOND_MIN,cashTarget:ue.CASH_TARGET,duration:ue.DURATION_YEARS,baseSalary:ue.BASE_SALARY,protectionFactor:ue.PROTECTION_FACTOR,recoveryBuffer:ue.RECOVERY_BUFFER,consecutiveLimit:ue.CONSECUTIVE_LIMIT,startDate:null,spStartDate:null,spWeeklyAmount:0,statePension:0,statePensionYear:0},taxYears:{},history:[],lastModified:null,checksum:null}}function zo(){return Oe()&&ht()}function br(){Hn=null}function Zf(){return Hn||ji()}async function Jt(){if(Hn)return Hn;if(!zo())return console.warn("Firebase not available - returning defaults"),ji();try{const[n,e,t]=await Promise.all([qb(),jb(),Wb()]),r={settings:n||ji().settings,taxYears:e||{},history:t||[],lastModified:new Date().toISOString(),checksum:null};return r.checksum=ep(r),Hn=r,r}catch(n){console.error("Error loading decision data:",n)}return ji()}async function Uo(n){if(!zo())throw new Error("Must be logged in to save data");try{n.lastModified=new Date().toISOString(),n.checksum=ep(n),await Promise.all([Hb(n.settings),Yb(n.taxYears)]),Hn=n}catch(e){throw console.error("Error saving decision data:",e),new Error("Failed to save decision data")}}function ep(n){const e={settings:n.settings,taxYears:n.taxYears,historyCount:n.history.length,lastHistoryDate:n.history.length>0?n.history[n.history.length-1].date:null};return ll(e)}async function Sn(){return(await Jt()).settings}async function ic(n){const e=await Jt();e.settings={...e.settings,...n},await Uo(e)}function oc(){return{pa:Fe.PERSONAL_ALLOWANCE,brl:Fe.BASIC_RATE_LIMIT,hrl:Fe.HIGHER_RATE_LIMIT,cpi:.04,other:0,isaSavingsAllocation:0,isaSavingsUsed:0,isaContribution:0,isTaxEfficient:!0,taxEfficiencyChoice:null,grossIncomeToDate:0,startMonth:4,yearSetupComplete:!1,confirmedSalary:null}}function Gb(n){const t=Zf().taxYears[n];return t||oc()}async function qo(n){const t=(await Jt()).taxYears[n];return t||oc()}async function xr(n,e){console.log(`saveTaxYearConfig: Saving tax year ${n}`,e);const t=await Jt();t.taxYears[n]={...Gb(n),...e},await Uo(t),console.log(`saveTaxYearConfig: Saved tax year ${n}, yearSetupComplete=${t.taxYears[n].yearSetupComplete}`)}async function Kb(n){const e=Hn||await Jt(),t=(e.history||[]).filter(s=>s.taxYear===n),r=t.reduce((s,i)=>s+(i.isa||0),0);return console.log(`recalculateIsaSavingsUsed: Tax year ${n}, found ${t.length} records, total ISA used: ${r}`),console.log("recalculateIsaSavingsUsed: History records:",t.map(s=>({date:s.date,isa:s.isa}))),e.taxYears[n]||(console.log(`recalculateIsaSavingsUsed: No existing config for ${n}, creating default`),e.taxYears[n]=oc()),console.log(`recalculateIsaSavingsUsed: Before update, isaSavingsUsed=${e.taxYears[n].isaSavingsUsed}`),e.taxYears[n].isaSavingsUsed=r,console.log(`recalculateIsaSavingsUsed: After update, isaSavingsUsed=${e.taxYears[n].isaSavingsUsed}`),await Uo(e),console.log("recalculateIsaSavingsUsed: Saved to Firebase"),r}async function Qb(n){const e=await qo(n),t=e.yearSetupComplete===!0;return console.log(`isYearSetupComplete: Tax year ${n}, yearSetupComplete=${e.yearSetupComplete}, result=${t}`),t}async function Zn(){return(await Jt()).taxYears}function Jb(n={}){let t=[...Zf().history];return n.taxYear&&(t=t.filter(r=>r.taxYear===n.taxYear)),n.startDate&&(t=t.filter(r=>r.date>=n.startDate)),n.endDate&&(t=t.filter(r=>r.date<=n.endDate)),n.sortDesc?t.sort((r,s)=>s.date.localeCompare(r.date)):t.sort((r,s)=>r.date.localeCompare(s.date)),n.limit&&(t=t.slice(0,n.limit)),t}async function cs(n={}){return await Jt(),Jb(n)}async function Xb(n){if(!zo())throw new Error("Must be logged in to save history");const e=await Jt(),t=e.history.findIndex(r=>r.date===n.date);t>=0?e.history[t]=n:e.history.push(n),e.history.sort((r,s)=>r.date.localeCompare(s.date)),await Jf(e.history)}async function tp(n){if(!zo())throw new Error("Must be logged in to delete history");const e=await Jt();e.history=e.history.filter(t=>t.date!==n),await Jf(e.history)}async function ac(n){const e=await Sn(),t=await Zn(),r=e.spStartDate,s=e.spWeeklyAmount||0;if(!r||!s){let f=null;if(r){const{formatStatePensionDate:m}=await nu(async()=>{const{formatStatePensionDate:g}=await Promise.resolve().then(()=>gd);return{formatStatePensionDate:g}},void 0,import.meta.url);f=m(r)}return{amount:0,monthly:0,yearsUntil:0,isReceiving:!1,isFirstYear:!1,startDate:f}}const{calculateStatePensionForTaxYear:i,getTimeUntilStatePension:a,parseStatePensionDate:l}=await nu(async()=>{const{calculateStatePensionForTaxYear:f,getTimeUntilStatePension:m,parseStatePensionDate:g}=await Promise.resolve().then(()=>gd);return{calculateStatePensionForTaxYear:f,getTimeUntilStatePension:m,parseStatePensionDate:g}},void 0,import.meta.url),c=i({taxYear:n,spStartDate:r,weeklyAmount:s,taxYearConfigs:t}),d=a(r);return{amount:c.annual,monthly:c.monthly,yearsUntil:d.years,monthsUntil:d.months,isReceiving:c.isReceiving,isFirstYear:c.isFirstYear,weeksInYear:c.weeksInYear,startDate:c.startDate}}async function Zb(n){const e=rm(n);e.stdSipp=n.stdSipp||n.sippDraw,await Xb(e),n.taxYear&&await Kb(n.taxYear)}const md={TAX_EFFICIENT:"minimiseEarlyTax",LONGEVITY:"maximiseLongevity"};function eE(n,e){return n<=0?n:n*Math.pow(1+e,1/12)}function np({targetGross:n,fixedIncome:e=0,pa:t,brl:r,hrl:s,isaBalance:i=0,strategy:a=md.TAX_EFFICIENT,yearsUntilSp:l=0}){const c=Fn(n,t,r,s),d=Math.max(0,Math.min(r,n)-e),f=Fn(d+e,t,r,s),m=Math.max(0,c-f),g=a===md.LONGEVITY&&l>0?i/l:1/0,b=Math.max(0,Math.min(m,Math.max(0,i),g)),S=i-b,I=m-b;let R=d;if(I>0){const F=im(f+I,t,r,s);R=Math.max(d,F-e)}const C=R+e,D=Fn(C,t,r,s);return{sippGross:R,isaDraw:b,remainingIsa:S,taxable:C,tax:C-D,net:D+b}}const el={CONSECUTIVE_LIMIT:3,RECOVERY_BUFFER:1e4};function rp({totalGrowth:n,minGrowth:e,consecCashDraws:t,wasInProtection:r,consecutiveLimit:s=el.CONSECUTIVE_LIMIT,recoveryBuffer:i=el.RECOVERY_BUFFER}){let a=!1;return r&&(a=n<=e+i),!a&&n<e&&t+1>=s&&(a=!0),a}const fo={MAX_FRACTION:.5,MIN_BOOST:50,SURPLUS_BUFFER:15e3};function sp({shortfall:n,standardMonthly:e,remainingMonths:t,surplus:r,brlHeadroom:s=1/0,maxFraction:i=fo.MAX_FRACTION,minBoost:a=fo.MIN_BOOST}){if(!(n>0)||!(r>0)||t<1)return 0;const l=[n/t,r/t];if(Number.isFinite(s)){if(s<=0)return 0;l.push(s/t)}l.push(e*i);const c=Math.min(...l);return c>a?c:0}const tE=-.01,nE=5;function ip(n){return Math.max(0,n+tE)}function Ho(n,e,t=0){const r=al(t);let s=n.equityStart,i=n.bondStart,a=n.cashStart,l=n.hodlEnabled?n.hodlStart!==void 0?n.hodlStart:n.hodlValue:0,c=0,d=n.isaBalance||0,f=null;const m=n.isaBalance||0,g=Math.max(1e3,m*.05);let b=null,S=0,I=0;const R=new Array(n.years+1).fill(null),C=new Array(n.years+1).fill(null);let D=0,F=0,V=0,q=0,z=!1,T=!1,v=null,y=0,_=0,E=-1;const A=[],w=n.trace?[]:null,le=[];let re=1;A.push({year:0,month:0,equity:s,bond:i,cash:a,hodl:l,total:s+i+a,draw:0,source:"None",inProtection:!1,equityMin:n.equityMin,bondMin:n.bondMin,cashMax:n.cashTarget});for(let J=0;J<n.years*12;J++){const N=Math.floor(J/12),we=J%12,ge=N;if(ge!==E&&(y=0,_=0,E=ge),J>0&&J%12===0){const he=e.inflation[N]||.025;le.push(he),re*=1+he}const ft=e.equity[N]||0,Ie=e.inflation[N]||.025,An=N>0?e.inflation[N-1]||.025:Ie,Zt=fn(n.equityMin,N,n.duration,re,!0),en=fn(n.bondMin,N,n.duration,re,!0),Vt=fn(n.cashTarget,N,n.duration,re,!1),ot=Zt+en,At=z;z=n.disableProtection?!1:rp({totalGrowth:s+i,minGrowth:ot,consecCashDraws:q,wasInProtection:At,consecutiveLimit:n.consecutiveLimit,recoveryBuffer:n.recoveryBuffer??el.RECOVERY_BUFFER}),z?(D++,V++):(F=Math.max(F,V),V=0);const{sippMonthly:tn,isaMonthly:nn,planInputs:Ft,taxAnnual:er,higherRate:xt}=oE(n,N,re,le,d);we===0&&(R[N]=d/re,C[N]=(s+i+a)/re),I+=er/12/re,xt&&S++;const Rt=tn,vt=Rt;let rn=z?Rt*n.protectionMult:Rt,Be=rn;const wt=nn,Pt=w?{month:J,year:N,monthInYear:we,cumInf:re,equityStart:s,bondStart:i,cashStart:a,isaStart:d,sippMonthly:tn,isaMonthly:nn,effectiveSipp:rn,effectiveIsa:wt,boostAmount:0,inProtection:z,planInputs:Ft}:null;Pt&&w.push(Pt),z&&(y+=vt-Be);const tr=rE(Ie,ft,An,r),Pe=ip(An),_e=he=>Math.pow(1+(Number.isFinite(he)?Math.max(-.99,he):-.99),1/12);if(s*=_e(ft),i*=_e(tr),a*=_e(Pe),d=eE(d,n.isaReturn||Dt.RETURN),l>0){const pt=(r()-.5)*2*.06;let $t=0;ft<-.1?$t=Math.min(.15,Math.abs(ft)*.4):ft<-.05&&($t=Math.abs(ft)*.2);let at=.069+pt+$t;at=Math.max(-.08,Math.min(.18,at)),l*=_e(at)}const sn=s+i;let _t=0;if(!z){const he=12-we,ze=_+vt*he+Ft.fixed;_t=sp({shortfall:y,standardMonthly:vt,remainingMonths:he,surplus:sn-ot-fo.SURPLUS_BUFFER,brlHeadroom:Ft.brl-ze}),_t>50&&(Be+=_t,y-=_t)}_+=Be,Pt&&(Pt.effectiveSipp=Be,Pt.boostAmount=_t>50?_t:0);let bt="Growth";if(!z&&sn>=ot+Be){const he=Math.max(0,s-Zt),ze=Math.max(0,i-en),pt=he+ze;if(pt>0){if(s-=Be*he/pt,i-=Be*ze/pt,bt="Growth",a<Vt){const $t=sn-ot-Be;if($t>5e3){const at=Math.min((Vt-a)*.3,$t*.5);s-=at*he/pt,i-=at*ze/pt,a+=at}}}else a-=Be,bt="Cash"}else if(a>=Be)a-=Be,bt="Cash";else{const he=Be-a;a=0,i>he?(i-=he,bt="Bond"):s>he?(s-=he,bt="Equity"):l>he?(l-=he,c+=he,f===null&&(f=J),bt="HODL"):(T=!0,v=J)}if(q=bt==="Growth"?0:q+1,d=Math.max(0,d-Math.min(wt,d)),b===null&&m>0&&d/re<g&&(b=J),s=Math.max(0,s),i=Math.max(0,i),a=Math.max(0,a),(we===0||J===n.years*12-1||T)&&A.push({year:N+we/12,month:J,equity:s,bond:i,cash:a,hodl:l,total:s+i+a,draw:Be,boostAmount:_t,source:bt,inProtection:z,equityMin:Zt,bondMin:en,cashMax:Vt}),T)break}if(F=Math.max(F,V),!T)R[n.years]=d/(re||1),C[n.years]=(s+i+a)/(re||1);else for(let J=Math.floor(v/12)+1;J<=n.years;J++)C[J]=0;let j=0,Z=0,ie=0,$e=0,de=1;for(let J=0;J<n.years;J++){const N=e.inflation[J]??.025;j+=N,de*=1+N,Z+=e.equity[J]??0,J<5&&(ie+=e.equity[J]??0,$e++)}const et=s+i+a;return{failed:T,duration:n.years,years:T?v/12:n.years,failMonth:v,avgInflation:j/n.years,avgEquityReturn:Z/n.years,earlyEquityReturn:$e?ie/$e:0,cumInflation:de,finalReal:et/de,final:et,finalEquity:s,finalBond:i,finalCash:a,finalHodl:l,protMonths:D,maxConsec:F,hodlUsed:c,hodlUsedMonth:f,startIsa:m,finalIsa:d,isaDepletedMonth:b,isaLastedYears:b===null?n.years:b/12,higherRateYears:S/12,totalTaxReal:I,isaByYear:R,potByYear:C,hist:A,trace:w,seed:t}}function rE(n,e,t,r){let s=.15,i=.3,a=.2,l=.1,c=.1,d=.15;const f=t!==void 0?t:n,m=f>.045,g=f>.07;if(m){const z=r()>.3?1:.5;g?(s=.15+.35*z,i=.3-.2*z,d=.15-.1*z,l=.1+.05*z):(s=.15+.2*z,i=.3-.1*z,d=.15-.05*z)}m&&r()<.15&&(s=.2,i=.25,d=.12);const b=n+.005+Ts(0,.03,r),S=.04-(n>.04?(n-.04)*.5:0)+Ts(0,.05,r),I=.03+n*.3+Ts(0,.08,r),R=n*.8+Ts(0,.15,r),C=ip(t),D=e*.5+Ts(0,.02,r),F=s*b+i*S+a*I+l*R+c*C+d*D,V=sE(n,e),q=(e-.1)/.17;return F+V*q*.055}function sE(n,e){return n>.045?.4:e<-.15?-.3:.1}function iE(n,e){return n.spStartYear!==void 0?Math.max(0,n.spStartYear-e):n.statePensionYear!==void 0?Math.max(0,n.statePensionYear-e):0}function oE(n,e,t,r,s=0){const i=n.taxMode==="frozen"?n.pa:n.pa*t,a=n.taxMode==="frozen"?n.brl:n.brl*t,l=n.taxMode==="frozen"?n.hrl:(n.hrl||125140)*t,c=n.baseSalary*t,d=xd(n.other,r);let f=0;if(n.spStartYear!==void 0){if(e>=n.spStartYear&&n.spWeeklyAmount>0){const S=n.spWeeklyAmount*52;e===n.spStartYear&&n.spFirstYearRatio!==void 0?f=S*n.spFirstYearRatio*t:f=S*t}}else n.statePensionYear!==void 0&&(f=e>=n.statePensionYear?(n.statePension||0)*t:0);const m=d+f,g=iE(n,e),b=np({targetGross:c,fixedIncome:m,pa:i,brl:a,hrl:l,isaBalance:s,strategy:n.isaDrawdownStrategy||Dt.DRAWDOWN_STRATEGY,yearsUntilSp:g});return{sippMonthly:b.sippGross/12,isaMonthly:b.isaDraw/12,taxAnnual:b.tax,higherRate:b.taxable>a+1,planInputs:{target:c,other:d,statePension:f,fixed:m,pa:i,brl:a,hrl:l,yearsUntilSp:g}}}function op(n,e=1e3){const t=[];for(let r=0;r<e;r++)t.push(Ho(n,ap(n,r),r));return t}function ap(n,e){const t=Object.keys($s).map(Number).sort((c,d)=>c-d),r=t.length,s=al(e*12345),i={equity:{},inflation:{}},a=n.blockYears||nE;let l=0;for(;l<n.years;){const c=Math.floor(s()*r);for(let d=0;d<a&&l<n.years;d++,l++){const f=t[(c+d)%r];i.equity[l]=$s[f],i.inflation[l]=il[f]||.025}}return i}function lp(n){const e=Object.keys($s).map(Number).sort((s,i)=>s-i),t=Math.max(...e),r=[];for(const s of e){if(s+n.years-1>t)continue;const i={equity:{},inflation:{}};for(let l=0;l<n.years;l++)i.equity[l]=$s[s+l]||0,i.inflation[l]=il[s+l]||.025;const a=Ho(n,i,s);a.startYear=s,r.push(a)}return r}function aE(n,e){const t={equity:{},inflation:{}};for(let r=0;r<n.years;r++)t.equity[r]=e.equity[r%e.equity.length],t.inflation[r]=e.inflation[r%e.inflation.length];return Ho(n,t,999)}function lE(n){const e=n.filter(t=>t.failed).length;return(n.length-e)/n.length*100}function cE(n){if(!n||n.failCount===0)return"No shortfalls: every simulated future funded the whole plan.";const e=d=>(d*100).toFixed(1)+"%",t=Math.round(n.medianFailYear),r=n.duration,s=Math.round(n.pctNearMiss);let i;n.pctNearMiss>=60?i=`and when they do it's usually late — the typical shortfall is at year ${t} of ${r}, and ${s}% happen only in the final years, after funding almost the whole of retirement`:n.pctNearMiss<=30?i=`and they tend to come EARLY — the typical shortfall is at year ${t} of ${r}, with only ${s}% holding on to the final years. An early shortfall is the serious kind, with little retirement left to adjust`:i=`spread through retirement — the typical shortfall is at year ${t} of ${r}`;const a=[{mag:n.succEarlyEq-n.failEarlyEq,text:`a poor first few years of markets (sequence-of-returns risk): the futures that fell short averaged ${e(n.failEarlyEq)} equity in the opening 5 years versus ${e(n.succEarlyEq)} for those that lasted`},{mag:n.succAvgEq-n.failAvgEq,text:`weak markets across the whole plan: ${e(n.failAvgEq)} average equity return versus ${e(n.succAvgEq)} for those that lasted`},{mag:n.failAvgInf-n.succAvgInf,text:`higher inflation eroding spending power: ${e(n.failAvgInf)} a year versus ${e(n.succAvgInf)} for those that lasted`}].filter(d=>d.mag>.005).sort((d,f)=>f.mag-d.mag),l=`About ${Math.round(n.failRate||0)}% of futures fall short`;if(!a.length)return`${l}, ${i}. No single market driver stands out — the shortfalls come down to broadly bad luck across returns and inflation.`;let c=`The common thread is ${a[0].text}`;return a[1]&&a[1].mag>a[0].mag*.5&&(c+=`. A secondary factor is ${a[1].text}`),`${l}, ${i}. ${c}.`}function cp(n){const e=n.filter(l=>!l.failed),t=n.filter(l=>l.failed),r=n.map(l=>l.years).sort((l,c)=>l-c),s=e.map(l=>l.final).sort((l,c)=>l-c),i=n.map(l=>l.protMonths).sort((l,c)=>l-c),a=(l,c)=>l[Math.floor(l.length*c)]||0;return{total:n.length,successCount:e.length,failCount:t.length,successRate:lE(n),survival:{p5:a(r,.05),p10:a(r,.1),p25:a(r,.25),p50:a(r,.5),p75:a(r,.75),p90:a(r,.9),p95:a(r,.95),min:r[0],max:r[r.length-1]},finalValue:{p5:a(s,.05),p10:a(s,.1),p25:a(s,.25),p50:a(s,.5),p75:a(s,.75),p90:a(s,.9),p95:a(s,.95),min:s[0]||0,max:s[s.length-1]||0,avg:e.reduce((l,c)=>l+c.final,0)/(e.length||1)},minYears:r[0],p10Years:a(r,.1),medianYears:a(r,.5),medianFinal:a(s,.5),p10Final:a(s,.1),p90Final:a(s,.9),avgFinal:e.reduce((l,c)=>l+c.final,0)/(e.length||1),protection:{runsWithProtection:n.filter(l=>l.protMonths>0).length,pctWithProtection:n.filter(l=>l.protMonths>0).length/n.length*100,avgMonths:i.reduce((l,c)=>l+c,0)/n.length,maxMonths:Math.max(...i),maxConsecutive:Math.max(...n.map(l=>l.maxConsec)),avgConsecutive:n.reduce((l,c)=>l+c.maxConsec,0)/n.length,p50Months:a(i,.5),p90Months:a(i,.9),p95Months:a(i,.95)},runsWithProtection:n.filter(l=>l.protMonths>0).length,avgProtMonths:i.reduce((l,c)=>l+c,0)/n.length,maxProtMonths:Math.max(...i),maxConsecutive:Math.max(...n.map(l=>l.maxConsec)),avgConsecutive:n.reduce((l,c)=>l+c.maxConsec,0)/n.length,hodl:{runsUsingHodl:n.filter(l=>l.hodlUsed>0).length,pctUsingHodl:n.filter(l=>l.hodlUsed>0).length/n.length*100,avgUsed:n.filter(l=>l.hodlUsed>0).length>0?n.filter(l=>l.hodlUsed>0).reduce((l,c)=>l+c.hodlUsed,0)/n.filter(l=>l.hodlUsed>0).length:0,maxUsed:Math.max(...n.map(l=>l.hodlUsed||0))},runsUsingHodl:n.filter(l=>l.hodlUsed>0).length,avgHodlUsed:n.filter(l=>l.hodlUsed>0).length>0?n.filter(l=>l.hodlUsed>0).reduce((l,c)=>l+c.hodlUsed,0)/n.filter(l=>l.hodlUsed>0).length:0,maxHodlUsed:Math.max(...n.map(l=>l.hodlUsed||0)),severity:(()=>{const l=Math.max(...n.map(I=>I.duration||I.years),1),c=n.filter(I=>I.failed),d=n.filter(I=>!I.failed),f=c.map(I=>I.years).sort((I,R)=>I-R),m=l*.85,g=(I,R)=>I.length?I.reduce((C,D)=>C+(D[R]||0),0)/I.length:0,b={duration:l,coverage:n.reduce((I,R)=>I+Math.min(1,(R.years||0)/l),0)/n.length*100,failCount:c.length,failRate:n.length?c.length/n.length*100:0,medianFailYear:f.length?a(f,.5):0,pctNearMiss:c.length?c.filter(I=>I.years>=m).length/c.length*100:0,failEarlyEq:g(c,"earlyEquityReturn"),succEarlyEq:g(d,"earlyEquityReturn"),failAvgEq:g(c,"avgEquityReturn"),succAvgEq:g(d,"avgEquityReturn"),failAvgInf:g(c,"avgInflation"),succAvgInf:g(d,"avgInflation")};b.diagnosis=cE(b);const S=[{k:"sequence",m:b.succEarlyEq-b.failEarlyEq},{k:"market",m:b.succAvgEq-b.failAvgEq},{k:"inflation",m:b.failAvgInf-b.succAvgInf}].filter(I=>I.m>.005).sort((I,R)=>R.m-I.m);return b.primaryDriver=b.failCount>0&&S.length?S[0].k:null,b})(),finalReal:(()=>{const l=n.map(c=>c.failed?0:c.finalReal||0).sort((c,d)=>c-d);return{p5:a(l,.05),p10:a(l,.1),p25:a(l,.25),p50:a(l,.5),p75:a(l,.75),p90:a(l,.9),p95:a(l,.95),min:l[0]||0,max:l[l.length-1]||0}})(),chartData:(()=>{const l=Math.max(...n.map(m=>m.duration||m.years),1),c=l+1,d={p10:[],p25:[],p50:[],p75:[],p90:[]},f=[];for(let m=0;m<c;m++){const g=n.map(S=>S.potByYear&&S.potByYear[m]!=null?S.potByYear[m]:0).sort((S,I)=>S-I);d.p10.push(a(g,.1)),d.p25.push(a(g,.25)),d.p50.push(a(g,.5)),d.p75.push(a(g,.75)),d.p90.push(a(g,.9));const b=n.filter(S=>(S.failed?S.failMonth/12:l)>=m).length;f.push(n.length?b/n.length*100:0)}return{years:c,potBand:d,solvency:f}})(),isa:(()=>{const l=n.filter(I=>(I.startIsa||0)>0);if(!l.length)return{funded:!1};const c=l.map(I=>I.isaLastedYears).sort((I,R)=>I-R),d=l.map(I=>I.finalIsa).sort((I,R)=>I-R),f=l.map(I=>I.higherRateYears),m=l.map(I=>I.totalTaxReal).sort((I,R)=>I-R),g=Math.max(...l.map(I=>(I.isaByYear||[]).length)),b=[],S=[];for(let I=0;I<g;I++){const R=l.filter(D=>D.isaByYear&&D.isaByYear[I]>0).length;b.push(l.length?R/l.length*100:0);const C=l.filter(D=>D.isaByYear&&D.isaByYear[I]!=null).map(D=>D.isaByYear[I]).sort((D,F)=>D-F);S.push(C.length?C[Math.floor(C.length/2)]:0)}return{funded:!0,runs:l.length,startBalance:l[0].startIsa,medianLastedYears:a(c,.5),minLastedYears:c[0],pctSurviveFullTerm:l.filter(I=>I.isaDepletedMonth===null).length/l.length*100,finalBalance:{p10:a(d,.1),p50:a(d,.5),p90:a(d,.9)},avgHigherRateYears:f.reduce((I,R)=>I+R,0)/l.length,maxHigherRateYears:Math.max(...f),pctEverHigherRate:l.filter(I=>I.higherRateYears>0).length/l.length*100,medianTotalTax:a(m,.5),p90TotalTax:a(m,.9),pctHoldingByYear:b,medianAliveByYear:S}})(),failures:t.map(l=>({seed:l.seed,startYear:l.startYear,years:l.years,failMonth:l.failMonth,protMonths:l.protMonths}))}}function us(n){if(!n)return null;const e={january:0,jan:0,february:1,feb:1,march:2,mar:2,april:3,apr:3,may:4,june:5,jun:5,july:6,jul:6,august:7,aug:7,september:8,sep:8,sept:8,october:9,oct:9,november:10,nov:10,december:11,dec:11},t=n.trim().replace(/\s+/g," ");if(/^\d{4}-\d{2}-\d{2}$/.test(t)){const s=new Date(t);if(!isNaN(s.getTime()))return s}if(/^\d{1,2}\/\d{1,2}\/\d{4}$/.test(t)){const[s,i,a]=t.split("/").map(Number);return new Date(a,i-1,s)}if(/^\d{1,2}-\d{1,2}-\d{4}$/.test(t)){const[s,i,a]=t.split("-").map(Number);return new Date(a,i-1,s)}let r=t.match(/^(\d{1,2})\s+(\w+)\s+(\d{4})$/i);if(r){const s=parseInt(r[1]),i=e[r[2].toLowerCase()],a=parseInt(r[3]);if(i!==void 0)return new Date(a,i,s)}if(r=t.match(/^(\w+)\s+(\d{1,2})\s+(\d{4})$/i),r){const s=e[r[1].toLowerCase()],i=parseInt(r[2]),a=parseInt(r[3]);if(s!==void 0)return new Date(a,s,i)}if(r=t.match(/^(\w+)\s+(\d{1,2})(?:st|nd|rd|th)?,?\s+(\d{4})$/i),r){const s=e[r[1].toLowerCase()],i=parseInt(r[2]),a=parseInt(r[3]);if(s!==void 0)return new Date(a,s,i)}if(r=t.match(/^(\d{1,2})(?:st|nd|rd|th)?\s+(\w+),?\s+(\d{4})$/i),r){const s=parseInt(r[1]),i=e[r[2].toLowerCase()],a=parseInt(r[3]);if(i!==void 0)return new Date(a,i,s)}return null}function Yi(n){const e=typeof n=="string"?us(n):n;if(!e||isNaN(e.getTime()))return"";const t=["January","February","March","April","May","June","July","August","September","October","November","December"];return`${e.getDate()} ${t[e.getMonth()]} ${e.getFullYear()}`}function uE(n){const{taxYear:e,spStartDate:t,weeklyAmount:r,taxYearConfigs:s={}}=n;if(!t||!r||r<=0)return{annual:0,monthly:0,isReceiving:!1,isFirstYear:!1,weeksInYear:0,startDate:null};const i=typeof t=="string"?us(t):t;if(!i||isNaN(i.getTime()))return{annual:0,monthly:0,isReceiving:!1,isFirstYear:!1,weeksInYear:0,startDate:null};const a=vo(i);fa(e);const l=om(e),c=[...new Set([a,e,...Object.keys(s)])].sort((I,R)=>fa(I).getTime()-fa(R).getTime()),d=c.indexOf(a),f=c.indexOf(e);if(f<d)return{annual:0,monthly:0,isReceiving:!1,isFirstYear:!1,weeksInYear:0,startDate:Yi(i)};let m=1;for(let I=d;I<f;I++){const R=c[I],C=s[R],D=(C==null?void 0:C.cpi)||.025;m*=1+D}const g=r*m;if(e===a){const R=Math.max(0,(l.getTime()-i.getTime())/6048e5),C=g*R;return{annual:C,monthly:C/12,isReceiving:!0,isFirstYear:!0,weeksInYear:Math.round(R*10)/10,startDate:Yi(i)}}const S=g*52;return{annual:S,monthly:S/12,isReceiving:!0,isFirstYear:!1,weeksInYear:52,startDate:Yi(i)}}function dE(n,e=new Date){const t=typeof n=="string"?us(n):n;if(!t||isNaN(t.getTime()))return{years:0,months:0,totalMonths:0,isPast:!1};const r=t.getTime()-e.getTime(),s=r<=0;if(s)return{years:0,months:0,totalMonths:0,isPast:!0};const i=Math.floor(r/(30.44*24*60*60*1e3)),a=Math.floor(i/12),l=i%12;return{years:a,months:l,totalMonths:i,isPast:s}}const up=2016;function jo(n,{now:e=new Date}={}){if(!n||!String(n).trim())return{valid:!0,error:null,warning:null,date:null};const t=us(n);if(!t||isNaN(t.getTime()))return{valid:!1,error:'Could not read that date. Try a format like "6 May 2040".',warning:null,date:null};const r=t.getFullYear();return r<up?{valid:!1,error:`That looks like a date of birth (${r}), not a State Pension start date. Enter the date your State Pension begins — check gov.uk/check-your-state-pension.`,warning:null,date:t}:t.getTime()<e.getTime()?{valid:!0,error:null,warning:`This date is in the past — State Pension will be treated as already in payment from ${r}.`,date:t}:{valid:!0,error:null,warning:null,date:t}}const gd=Object.freeze(Object.defineProperty({__proto__:null,MIN_SP_START_YEAR:up,calculateStatePensionForTaxYear:uE,formatStatePensionDate:Yi,getTimeUntilStatePension:dE,parseStatePensionDate:us,validateStatePensionDate:jo},Symbol.toStringTag,{value:"Module"}));let Vn=null;function Ks(){return{settings:{equityMin:ue.EQUITY_MIN,bondMin:ue.BOND_MIN,cashTarget:ue.CASH_TARGET,duration:ue.DURATION_YEARS,baseSalary:ue.BASE_SALARY,other:0,statePension:12e3,statePensionYear:12,pa:Fe.PERSONAL_ALLOWANCE,brl:Fe.BASIC_RATE_LIMIT,hrl:Fe.HIGHER_RATE_LIMIT,taxMode:"inflates",protectionMult:hr.PROTECTION_MULTIPLIER,consecutiveLimit:ue.CONSECUTIVE_LIMIT,disableProtection:!1,hodlEnabled:hr.HODL_ENABLED,hodlValue:hr.HODL_VALUE},lastModified:null,checksum:null}}function lc(){return Oe()&&ht()}function Kn(){Vn=null}function hE(){return Vn||Ks()}async function dp(){if(Vn)return Vn;if(!lc())return console.warn("Firebase not available - returning defaults"),Ks();try{const n=await Ub();if(n){const e={settings:n,lastModified:new Date().toISOString(),checksum:null};return Vn=mE(e),Vn}}catch(n){console.error("Error loading stress data:",n)}return Ks()}async function fE(n){if(!lc())throw new Error("Must be logged in to save data");try{n.lastModified=new Date().toISOString(),n.checksum=pE(n),await Qf(n.settings),Vn=n}catch(e){throw console.error("Error saving stress data:",e),new Error("Failed to save stress data")}}function pE(n){return ll(n.settings)}function mE(n){const e={...Ks()};return n.settings&&(e.settings={...e.settings,...n.settings},n.settings.pacwMin!==void 0&&n.settings.equityMin===void 0&&(e.settings.equityMin=n.settings.pacwMin),n.settings.cgtMin!==void 0&&n.settings.bondMin===void 0&&(e.settings.bondMin=n.settings.cgtMin),n.settings.csh2Target!==void 0&&n.settings.cashTarget===void 0&&(e.settings.cashTarget=n.settings.csh2Target),e.settings.hodlEnabled===void 0&&(e.settings.hodlEnabled=!1),e.settings.hodlValue===void 0&&(e.settings.hodlValue=25e3)),e.lastModified=n.lastModified,e.checksum=n.checksum,e}function gE(){return hE().settings}async function Xt(){return(await dp()).settings}async function Yo(n){const e=await dp();e.settings={...e.settings,...n},await fE(e)}async function yE(){if(!lc())throw new Error("Must be logged in to reset settings");const n=Ks();await Qf(n.settings),Kn()}function vE(n){if(!n.spStartDate||!n.spWeeklyAmount)return null;const e=us(n.spStartDate);if(!e)return console.warn("Could not parse spStartDate:",n.spStartDate),null;const t=new Date,r=365.25*24*60*60*1e3,s=Math.max(0,(e.getTime()-t.getTime())/r),i=Math.floor(s),a=365,l=Math.floor((e-new Date(e.getFullYear(),0,0))/(24*60*60*1e3)),d=(a-l)/a;return{spStartYear:i,spWeeklyAmount:n.spWeeklyAmount,spFirstYearRatio:d}}function Wo(n={},e=null){const t=e||gE(),r=vE(t),s=r?{spStartYear:r.spStartYear,spWeeklyAmount:r.spWeeklyAmount,spFirstYearRatio:r.spFirstYearRatio}:{statePension:t.statePension||0,statePensionYear:t.statePensionYear??999};return{equityStart:n.equityStart??t.equityMin,bondStart:n.bondStart??t.bondMin,cashStart:n.cashStart??t.cashTarget,equityMin:t.equityMin,bondMin:t.bondMin,cashTarget:t.cashTarget,years:n.years??t.duration,duration:t.duration,baseSalary:t.baseSalary,other:t.other,...s,pa:t.pa,brl:t.brl,hrl:t.hrl,taxMode:t.taxMode,protectionMult:t.protectionMult,consecutiveLimit:t.consecutiveLimit,disableProtection:t.disableProtection,hodlEnabled:t.hodlEnabled,hodlValue:t.hodlValue,isaBalance:t.isaBalance||0,isaReturn:t.isaReturn,isaDrawdownStrategy:t.isaDrawdownStrategy}}function Q(n,e=null){const t=Math.abs(n),r=e!==null?e:t<100,s=Math.abs(n).toLocaleString("en-GB",{minimumFractionDigits:r?2:0,maximumFractionDigits:r?2:0});return n<0?`-£${s}`:`£${s}`}function yd(n,e){const t=wE(n);e.innerHTML=t}function wE(n){var E,A,w,le,re;const e=n,t=e.calculationDetails||{};let r="";const s=e.isTaxEfficientYear??e.taxEfficient,i=e.protectionInducedTaxEfficiency||!1,a=e.boostAmount>0;let l,c,d;if(e.inProtection?(l="warning",c="Protection Mode",d="⚡"):a?(l="boost",c="Tax Boost (Catch-up)",d="↑"):i?(l="info",c="Protection-Induced Tax Efficiency",d="↑"):s?(l="success",c="Tax-Efficient Year",d="✓"):(l="warning",c="Tax-Inefficient Year",d="!"),r+=`<div class="decision-mode ${l}">
  ...
  </div>`}function _E(n){switch(n){case Ci.DANGER:return"alert-danger";case Ci.WARNING:return"alert-warning";case Ci.SUCCESS:return"alert-success";case Ci.INFO:default:return"alert-info"}}function bE(){return`
    .decision-mode {
      display: flex;
      align-items: center;
      gap: 12px;
  ...
  `}function kE(){const n=cc(X.selectedMonth),e=BE(X.selectedMonth);return`
    <div class="wizard-step">
  ...
  `}function bd(){pi();const n=IE({targetAnnualGross:O.confirmedSalary,brl:O.brl,pa:O.pa,other:O.other,statePension:X.statePension.amount,remainingMonths:X.remainingMonths,grossIncomeToDate:O.grossIncomeToDate});return O._isaCalc=n,n.brlExhausted?`
      <div class="wizard-step">
  ...
  `}function Ed(){pi();const n=O._isaCalc,e=SE(O.isaSavingsAllocation,(n==null?void 0:n.isaNeeded)||0,(n==null?void 0:n.brlExhausted)||!1);if(e.sufficient&&!e.isBrlExhausted)return O.isTaxEfficient=!0,O.taxEfficiencyChoice="efficient",setTimeout(()=>{Tt++,Fs()},0),`
      <div class="wizard-step">
  ...
  `}function ME(n,e){let t="";for(let r=1;r<=n;r++){const s=r<e?"done":r===e?"active":"";t+=`<div class="wizard-dot ${s}"></div>`}return t}function DE(){pr.querySelectorAll("[data-action]").forEach(e=>{e.addEventListener("click",()=>NE(e.dataset.action))}),window._updateWizardSalary=function(){const e=document.getElementById("wizCPI"),t=document.getElementById("wizSalary"),r=document.getElementById("cpiDisplay"),s=document.getElementById("suggestedSalaryDisplay");if(e&&t&&r&&s){const i=parseFloat(e.value)||0,a=i/100,l=X.baseSalary,c=Math.round(l*(1+a));r.textContent=i.toFixed(1),s.textContent=c.toLocaleString(),t.value=c,O.cpi=a,O.confirmedSalary=c}}}function NE(n){pi();const e=X.isApril?6:7;switch(n){case"cancel":fp(),Qs&&Qs({completed:!1,cancelled:!0});break;case"next":Tt<e&&(Tt++,Fs());break;case"back":Tt>1&&(Tt--,Fs());break;case"apply-choice":LE(),Tt++,Fs();break;case"finish":OE();break}}function LE(){var e;const n=(e=document.querySelector('input[name="taxChoice"]:checked'))==null?void 0:e.value;switch(O.taxEfficiencyChoice=n,n){case"increase":O.isaSavingsAllocation=O._isaCalc.isaNeeded,O.isTaxEfficient=!0;break;case"reduced":O.confirmedSalary=O.brl,O.isaSavingsAllocation=0,O.isTaxEfficient=!0;break;case"inefficient":O.isaSavingsAllocation=0,O.isTaxEfficient=!1;break}}function pi(){const n=document.getElementById("wizPA");n&&(O.pa=parseFloat(n.value)||12570);const e=document.getElementById("wizBRL");e&&(O.brl=parseFloat(e.value)||50270);const t=document.getElementById("wizHRL");t&&(O.hrl=parseFloat(t.value)||125140);const r=document.getElementById("wizCPI");r&&(O.cpi=(parseFloat(r.value)||4)/100);const s=document.getElementById("wizSalary");s&&(O.confirmedSalary=parseFloat(s.value)||3e4);const i=document.getElementById("wizOther");i&&(O.other=parseFloat(i.value)||0);const a=document.getElementById("wizISA");a&&(O.isaSavingsAllocation=parseFloat(a.value)||0);const l=document.getElementById("wizIncomeToDate");l&&(O.grossIncomeToDate=parseFloat(l.value)||0)}async function OE(){pi();const n=hp({targetSalary:O.confirmedSalary,brl:O.brl,pa:O.pa,other:O.other,statePension:X.statePension.amount,isaSavingsAllocation:O.isaSavingsAllocation,remainingMonths:X.remainingMonths,grossIncomeToDate:O.grossIncomeToDate,isTaxEfficient:O.isTaxEfficient}),e=xE({pa:O.pa,brl:O.brl,hrl:O.hrl,cpi:O.cpi,other:O.other,isaSavingsAllocation:O.isaSavingsAllocation,isTaxEfficient:O.isTaxEfficient,taxEfficiencyChoice:O.taxEfficiencyChoice,grossIncomeToDate:O.grossIncomeToDate,startMonth:parseInt(X.selectedMonth.split("-")[1]),confirmedSalary:O.confirmedSalary,remainingMonths:X.remainingMonths,statePension:X.statePension.amount,monthlyBreakdown:n});console.log(`Tax Year Wizard: Saving config for ${X.taxYear}`,e);try{await xr(X.taxYear,e),console.log(`Tax Year Wizard: Successfully saved config for ${X.taxYear}`)}catch(t){console.error(`Tax Year Wizard: Failed to save config for ${X.taxYear}`,t),typeof window.showToast=="function"&&window.showToast(`Error saving tax year configuration: ${t.message}`,"error");return}fp(),Qs&&Qs({completed:!0,taxYear:X.taxYear,config:e,wizardInputs:O})}function fp(){pr&&(pr.innerHTML="",pr.style.display="none")}function cc(n){const[e,t]=n.split("-").map(Number);return new Date(e,t-1,1).toLocaleString("default",{month:"long",year:"numeric"})}function BE(n){const[e,t]=n.split("-").map(Number);return new Date(e,t-2,1).toLocaleString("default",{month:"long"})}function VE(){return`
    .wizard-summary {
      background: var(--card-alt);
      border: 1px solid var(--border);
      border-radius: 8px;
  ...
  `,document.getElementById("landingGetStarted").addEventListener("click",n),document.getElementById("landingSignIn").addEventListener("click",e))}function Xs(){Js&&(Js.style.display="none")}function YE(){return`
    .landing-page {
      position: fixed;
      top: 0;
      left: 0;
  ...
  `}let dt=null,Ra=null,Vr=!1;function WE(n,e){console.log("initAuthScreen: initializing"),dt=n,Ra=e,Vr=!1,Ib(t=>{console.log("AuthScreen: auth state change received:",t?t.email:"null","processed:",Vr),t&&Ra&&!Vr?(console.log("AuthScreen: calling onAuthSuccessCallback"),Vr=!0,ZE(),Ra(t)):t?console.log("AuthScreen: skipping callback, already processed or no callback"):(Vr=!1,console.log("AuthScreen: user signed out, reset authProcessed"))}),mp(),console.log("initAuthScreen: complete")}function mp(){if(dt){if(!Oe()){dt.innerHTML=`
  ...
  `,GE()}}function GE(){const n=dt.querySelectorAll(".auth-screen-tab");n.forEach(i=>{i.addEventListener("click",()=>{n.forEach(c=>c.classList.remove("active")),i.classList.add("active");const a=document.getElementById("signinForm"),l=document.getElementById("signupForm");i.dataset.tab==="signin"?(a.style.display="block",l.style.display="none"):(a.style.display="none",l.style.display="block"),mi()})}),document.getElementById("signinForm").addEventListener("submit",KE),document.getElementById("signupForm").addEventListener("submit",QE),document.getElementById("forgotPasswordBtn").addEventListener("click",JE),document.getElementById("googleSigninBtn").addEventListener("click",XE)}function jn(n){const e=document.getElementById("authScreenError");e&&(e.textContent=n,e.style.display="block")}function mi(){const n=document.getElementById("authScreenError");n&&(n.style.display="none")}async function KE(n){n.preventDefault(),mi();const e=document.getElementById("signinEmail").value.trim(),t=document.getElementById("signinPassword").value;if(!e||!t){jn("Please enter email and password");return}try{await Ab(e,t)}catch(r){console.error("Sign in error:",r),jn(Go(r.code))}}async function QE(n){n.preventDefault(),mi();const e=document.getElementById("signupName").value.trim(),t=document.getElementById("signupEmail").value.trim(),r=document.getElementById("signupPassword").value;if(!e||!t||!r){jn("Please fill in all fields");return}if(r.length<6){jn("Password must be at least 6 characters");return}try{await Sb(t,r,e)}catch(s){console.error("Sign up error:",s),jn(Go(s.code))}}async function JE(){mi();const n=document.getElementById("signinEmail").value.trim();if(!n){jn("Please enter your email address first");return}try{await Rb(n),typeof window.showToast=="function"&&window.showToast("Password reset email sent. Check your inbox.","success",5e3)}catch(e){console.error("Reset password error:",e),jn(Go(e.code))}}async function XE(){mi();try{await xb()}catch(n){console.error("Google sign in error:",n),jn(Go(n.code))}}function Go(n){return{"auth/invalid-email":"Invalid email address","auth/user-disabled":"This account has been disabled","auth/user-not-found":"No account found with this email","auth/wrong-password":"Incorrect password","auth/email-already-in-use":"An account already exists with this email","auth/weak-password":"Password is too weak","auth/operation-not-allowed":"Sign in method not enabled","auth/popup-closed-by-user":"Sign in cancelled","auth/popup-blocked":"Sign in popup was blocked","auth/too-many-requests":"Too many attempts. Please try again later.","auth/invalid-credential":"Invalid email or password"}[n]||"An error occurred. Please try again."}function ZE(){dt&&(dt.innerHTML=`
      <div class="auth-screen">
    ...
    `)}function gp(){console.log("hideAuthScreen: hiding auth screen, element=",!!dt),dt&&(dt.style.display="none",console.log("hideAuthScreen: set display to none"))}function eT(){Vr=!1,dt&&(dt.style.display="block",mp())}function po(n="signin"){eT(),dt.querySelectorAll(".auth-screen-tab").forEach(i=>i.classList.remove("active"));const t=dt.querySelector(`.auth-screen-tab[data-tab="${n}"]`);t&&t.classList.add("active");const r=document.getElementById("signinForm"),s=document.getElementById("signupForm");r&&s&&(r.style.display=n==="signin"?"block":"none",s.style.display=n==="signup"?"block":"none")}function tT(){return`
    .auth-screen {
      position: fixed;
      top: 0;
      left: 0;
  ...
  `}let Zs=null;function nT(n,e,t){Zs=n,rT(e,t)}function rT(n,e){if(!Zs)return;const t=n||"there";Zs.innerHTML=`
  ...
  `,document.getElementById("onboardingStartWizard").addEventListener("click",e)}function Ko(){Zs&&(Zs.style.display="none")}function sT(){return`
    .onboarding-page {
      position: fixed;
      top: 0;
      left: 0;
  ...
  `}let _n=null,mo=null,B={scenarioName:"My Plan",scenarioDescription:"",enabledTools:["stress","decision"],introDone:!1,baseSalary:3e4,otherIncome:0,spStartDate:"",spWeeklyAmount:0,equityMin:25e4,bondMin:2e5,cashTarget:5e4,isaBalance:0,duration:35,taxMode:"inflates",decisionSalary:3e4,decisionEquity:25e4,decisionBond:2e5,decisionCash:5e4,decisionIsaBalance:0,decisionDuration:35},st="scenario",Ee=1;function yp(){st="scenario",Ee=1,B={scenarioName:"My Plan",scenarioDescription:"",enabledTools:["stress","decision"],introDone:!1,baseSalary:3e4,otherIncome:0,spStartDate:"",spWeeklyAmount:0,equityMin:25e4,bondMin:2e5,cashTarget:5e4,isaBalance:0,duration:35,taxMode:"inflates",decisionSalary:3e4,decisionEquity:25e4,decisionBond:2e5,decisionCash:5e4,decisionIsaBalance:0,decisionDuration:35}}function vp(n,e){_n=n,mo=e,yp(),kt()}function kt(){_n&&(st==="scenario"?iT():st==="stress"?lT():st==="decision"&&uT())}function iT(){_n.innerHTML=`
    <div class="wizard-overlay">
      <div class="wizard-box">
  ...
  `}function aT(){const n=B.enabledTools.includes("stress"),e=B.enabledTools.includes("decision");return`
    <div class="wizard-step">
  ...
  `,dc()}function cT(n){switch(n){case 1:return`
        <div class="wizard-step">
      ...
      `;default:return""}}function uT(){_n.innerHTML=`
    <div class="wizard-overlay">
      <div class="wizard-box">
...
Continue anyway?`)}return!0}window.handleDecisionSubmit=async function(n){n.preventDefault();const e=document.getElementById("entryMonth").value,t=parseFloat(document.getElementById("entryEquity").value)||0,r=parseFloat(document.getElementById("entryBond").value)||0,s=parseFloat(document.getElementById("entryCash").value)||0,i=[];if(e||i.push("Month"),!t&&t!==0&&i.push("Equity Fund"),!r&&r!==0&&i.push("Bond Balance"),!s&&s!==0&&i.push("Cash Balance"),i.length>0){showToast("Missing: "+i.join(", "),"error",4e3);return}if(!mc(t,r,s))return;if((await cs({limit:1e3})).find(c=>c.date===e)){showToast(`${rs(e)} already has a saved decision. Delete it from the History tab first to recalculate.`,"error",5e3);return}try{if((await PE(e)).showWizard){const f=document.getElementById("taxYearWizard");f.style.display="block",window._pendingDecisionForm={dateStr:e,equity:t,bond:r,cash:s},RE(f,e,async m=>{if(f.style.display="none",m&&m.completed)try{Fr=await Sd(e,t,r,s);const g=document.getElementById("decisionOutput");yd(Fr,g),document.getElementById("saveBtn").disabled=!1}catch(g){console.error("Decision error after wizard:",g),showToast("Error: "+g.message,"error")}});return}Fr=await Sd(e,t,r,s);const d=document.getElementById("decisionOutput");yd(Fr,d),document.getElementById("saveBtn").disabled=!1}catch(c){console.error("Decision error:",c),showToast("Error: "+c.message,"error")}};window.saveCurrentDecision=async function(){const n=document.getElementById("saveBtn");if(!Fr){showToast("No decision to save","error");return}if(!ht()){showToast("Please sign in to save decisions","error");return}n.classList.add("loading"),n.disabled=!0;try{await Zb(Fr),showToast("Decision saved to history","success"),await Kt()}catch(e){console.error("Save error:",e),showToast("Error saving: "+e.message,"error"),n.disabled=!1}finally{n.classList.remove("loading")}};function kp(n){const e=r=>"£"+Math.round(r||0).toLocaleString(),t=`Starting balances come from your <strong>Settings</strong> (Fund Minimums): Equity ${e(n.equityMin)} · Bond ${e(n.bondMin)} · Cash ${e(n.cashTarget)}. Edit them in the Settings tab.`;["mcStartSummary","histStartSummary","scenStartSummary"].forEach(r=>{const s=document.getElementById(r);s&&(s.innerHTML=t)}),["mcYears","histYears"].forEach(r=>{const s=document.getElementById(r);s&&(s.value=n.duration)})}window.runMonteCarloUI=async function(){const n=await Xt(),e={years:parseInt(document.getElementById("mcYears").value)||n.duration},t=document.getElementById("optimiseResultsMC");t&&(t.innerHTML=""),document.getElementById("mcResults").innerHTML='<div class="loading"><div class="spinner"></div>Running simulation...</div>',setTimeout(()=>{try{const{results:r,stats:s}=FE(e);bp=r,Np(s,r,"Monte Carlo (1000 runs)","mcResults",e.years)}catch(r){console.error("Simulation error:",r),document.getElementById("mcResults").innerHTML=`<div class="alert alert-danger">Error: ${r.message}</div>`}},50)};window.runHistoricalUI=async function(){const n=await Xt(),e={years:parseInt(document.getElementById("histYears").value)||n.duration},t=document.getElementById("optimiseResultsHist");t&&(t.innerHTML=""),document.getElementById("histResults").innerHTML='<div class="loading"><div class="spinner"></div>Running simulation...</div>',setTimeout(()=>{try{const{results:r,stats:s}=$E(e);Ep=r,Np(s,r,"Historical Analysis","histResults",e.years)}catch(r){console.error("Simulation error:",r),document.getElementById("histResults").innerHTML=`<div class="alert alert-danger">Error: ${r.message}</div>`}},50)};window.runScenariosUI=async function(){await Xt();const n={};document.getElementById("scenResults").innerHTML='<div class="loading"><div class="spinner"></div>Running scenarios...</div>',setTimeout(()=>{try{const e=zE(n);NT(e,"scenResults")}catch(e){console.error("Scenario error:",e),document.getElementById("scenResults").innerHTML=`<div class="alert alert-danger">Error: ${e.message}</div>`}},50)};let kn=!1,Ms=0;function ST(){Ms++}window.runOptimisationUI=async function(n){if(kn)return;kn=!0;const e=++Ms,t=document.getElementById("optimiseBtn"+n),r=document.getElementById("optimiseResults"+n);t&&(t.disabled=!0),t&&(t.textContent="Optimising..."),r.innerHTML='<div class="loading"><div class="spinner"></div>Preparing optimisation...</div>';const s=await Xt(),i=JSON.parse(JSON.stringify(s)),a=document.getElementById(n==="MC"?"mcYears":"histYears"),l=parseInt(a&&a.value)||i.duration,c=(i.equityMin||0)+(i.bondMin||0)+(i.cashTarget||0);if(e!==Ms){kn=!1,t&&(t.disabled=!1,t.textContent="Optimise Allocation");return}const d=[];for(let _=5;_<=90;_+=5)for(let E=5;E<=95-_;E+=5){const A=100-_-E;A>=0&&d.push({equity:Math.round(c*E/100),bond:Math.round(c*A/100),cash:Math.round(c*_/100)})}const{EQUITY_RETURNS:f,INFLATION:m}=window._constants,{simulate:g,monteCarloReturns:b}=window._simEngine,S=Object.keys(f).map(Number).sort((_,E)=>_-E),I=Math.max(...S),R=_=>{const E={...i,equityMin:_.equity,bondMin:_.bond,cashTarget:_.cash},A=Wo({years:l},E),w=[];if(n==="MC")for(let N=0;N<1e3;N++)w.push(g(A,b(A,N),N));else S.forEach(N=>{if(N+l-1>I)return;const we={equity:{},inflation:{}};for(let ge=0;ge<l;ge++)we.equity[ge]=f[N+ge]||0,we.inflation[ge]=m[N+ge]||.025;w.push(g(A,we,N))});const le=w.filter(N=>N.failed);w.filter(N=>!N.failed);const re=(w.length-le.length)/w.length*100,j=w.reduce((N,we)=>N+Math.min(1,(we.years||0)/(we.duration||l)),0)/w.length*100,ie=w.map(N=>N.protMonths).reduce((N,we)=>N+we,0)/w.length,$e=w.filter(N=>N.protMonths>0).length,de=w.map(N=>N.failed?0:N.finalReal||0).sort((N,we)=>N-we),et=de.length?de[Math.floor(de.length*.5)]:0,J=de.length?de[Math.floor(de.length*.9)]:0;return{equity:_.equity,bond:_.bond,cash:_.cash,rate:re,coverage:j,avgProt:ie,withProt:$e,totalRuns:w.length,medianFinal:et,p90Final:J}};let C;try{const _={equity:i.equityMin||0,bond:i.bondMin||0,cash:i.cashTarget||0},E=R(_);C={..._,...E}}catch(_){console.error("Optimisation error (original):",_),r.innerHTML='<div class="alert alert-danger">Error: '+_.message+"</div>",kn=!1,t&&(t.disabled=!1,t.textContent="Optimise Allocation");return}const D=10;let F=0;const V=[];let q=null;function z(_){const E=Math.max(..._.map(w=>w.coverage)),A=_.filter(w=>w.coverage>=E-.5);return A.sort((w,le)=>w.avgProt-le.avgProt||le.medianFinal-w.medianFinal),A[0]}function T(_,E){return Math.round(_.equity)===Math.round(E.equity)&&Math.round(_.bond)===Math.round(E.bond)&&Math.round(_.cash)===Math.round(E.cash)}function v(){if(e!==Ms){kn=!1,t&&(t.disabled=!1,t.textContent="Optimise Allocation"),r.innerHTML="";return}try{const _=Math.min(F+D,d.length);for(;F<_;F++)V.push(R(d[F]));r.innerHTML='<div class="loading"><div class="spinner"></div>Testing allocations... '+F+"/"+d.length+"</div>",F<d.length?setTimeout(v,0):(q=z([...V,C]),y())}catch(_){console.error("Optimisation error:",_),r.innerHTML='<div class="alert alert-danger">Error: '+_.message+"</div>",kn=!1,t&&(t.disabled=!1,t.textContent="Optimise Allocation")}}function y(){if(e!==Ms){kn=!1,t&&(t.disabled=!1,t.textContent="Optimise Allocation"),r.innerHTML="";return}const _=c>0?C.cash/c*100:0,E=c>0?C.equity/c*100:0,w=_>90||_<5||E<5?'<div class="alert alert-info" style="margin-bottom:16px;font-size:13px;">Your current split is outside the range the optimiser sweeps, but it was included in this comparison.</div>':"",le=q&&!T(q,C)&&(q.coverage>C.coverage+.5||q.coverage>=C.coverage-.01&&q.avgProt<C.avgProt-3),re=(Z,ie)=>{const $e=de=>Math.round(de/c*100);return'<div style="padding:16px;border-radius:8px;'+(ie?"background:rgba(46,160,67,0.1);border:1px solid var(--success);":"background:rgba(0,0,0,0.2);")+'"><div style="font-weight:500;margin-bottom:10px;color:var(--'+(ie?"success":"text-muted")+');">'+(ie?"Optimised split":"Your current split")+'</div><div style="font-size:26px;font-weight:700;color:var(--'+(ie?"success":"warning")+');">'+Z.coverage.toFixed(0)+'%</div><div style="font-size:12px;color:var(--text-muted);margin-bottom:8px;">of retirement years funded'+(ie?" ("+(q.coverage-C.coverage>=0?"+":"")+(q.coverage-C.coverage).toFixed(0)+"%)":"")+'</div><div style="font-size:13px;">Equity '+$e(Z.equity)+"% · Bonds "+$e(Z.bond)+"% · Cash "+$e(Z.cash)+'%</div><div style="font-size:12px;color:var(--text-muted);margin-top:8px;">'+Z.rate.toFixed(0)+"% never run out · "+Q(Z.medianFinal)+" typically left</div></div>"};let j="";if(le){const Z=q.medianFinal-C.medianFinal,ie=C.medianFinal>0?Z/C.medianFinal*100:0;j+='<div class="card" style="margin-top:20px;border-color:var(--success);">',j+='<h3 style="color:var(--success);margin-top:0;">A better fund split</h3>',j+='<p style="color:var(--text-muted);margin-bottom:16px;">This split funds more of your retirement (higher coverage). Coverage credits a plan for every year it pays for, so it prefers splits that fall short late over ones that fail early.</p>',j+=w,j+='<div class="grid-2" style="gap:20px;margin-bottom:20px;">'+re(C,!1)+re(q,!0)+"</div>",Z<0?j+='<div class="alert alert-warning" style="margin-bottom:16px;"><strong>Trade-off:</strong> it typically leaves '+Math.abs(ie).toFixed(0)+"% less at the end (usually less equity) — more safety, a bit less upside.</div>":Z>0&&(j+='<div class="alert alert-info" style="margin-bottom:16px;"><strong>Bonus:</strong> it also typically leaves '+ie.toFixed(0)+"% more at the end.</div>"),j+='<button onclick="applyOptimisedAllocationUI('+q.equity+","+q.bond+","+q.cash+')" style="width:100%;">Apply this split to your Settings</button>',j+="</div>"}else j+='<div class="card" style="margin-top:20px;border-color:var(--primary);">',j+='<h3 style="color:var(--primary);margin-top:0;">Your split is already about as good as it gets</h3>',j+=w,j+='<p style="color:var(--text-muted);">We tested '+d.length+" fund splits. Yours funds "+C.coverage.toFixed(0)+"% of retirement years — the best, or within 0.5% of it, with no clearly better low-protection alternative.</p>",j+='<p style="font-size:13px;color:var(--text-muted);">Your split — Equity '+Math.round(E)+"% · Bonds "+Math.round(C.bond/c*100)+"% · Cash "+Math.round(_)+"% · "+C.rate.toFixed(0)+"% never run out.</p>",j+="</div>";r.innerHTML=j,kn=!1,t&&(t.disabled=!1,t.textContent="Optimise Allocation")}setTimeout(v,0)};window.applyOptimisedAllocationUI=async function(n,e,t){if(document.getElementById("ssEquityMin").value=n,document.getElementById("ssBondMin").value=e,document.getElementById("ssCashTarget").value=t,document.getElementById("dsEquityMin").value=n,document.getElementById("dsBondMin").value=e,document.getElementById("dsCashTarget").value=t,kp({equityMin:n,bondMin:e,cashTarget:t,duration:parseInt(document.getElementById("ssDuration").value)||35}),Jo(),ht())try{await Yo({equityMin:n,bondMin:e,cashTarget:t})}catch(r){console.error("Error saving optimised settings:",r)}showToast("Optimised allocation applied to settings and starting values. Scroll up to re-run.","success",4e3)};const AT={1929:"Wall Street Crash / Great Depression",1930:"Great Depression",1931:"Great Depression",1932:"Great Depression",1937:"Recession of 1937",1968:"Late 1960s stagflation",1969:"Late 1960s recession",1973:"Oil Crisis / 1973-74 crash",1974:"1973-74 bear market",2e3:"Dot-com bubble burst",2001:"Dot-com bust / 9/11",2007:"Global Financial Crisis",2008:"Global Financial Crisis",2022:"Post-COVID inflation / rate hikes"};function xT(n){if(!n||n.length===0)return"";const e=n.filter(i=>i.failed).sort((i,a)=>i.years-a.years),t=n.filter(i=>i.protMonths>0).sort((i,a)=>a.protMonths-i.protMonths),r=e.length>0?e.slice(0,5):t.slice(0,5);if(r.length===0)return"";let s=`
      ...
      `,s}function hn(n){return`<span class="hlp" tabindex="0" data-tip="${String(n).replace(/"/g,"&quot;")}">?</span>`}function RT(){if(window.__helpTipInit)return;window.__helpTipInit=!0;const n=document.createElement("div");n.className="help-tip",n.style.display="none",document.body.appendChild(n);let e=null;const t=s=>{const i=s.getAttribute("data-tip");if(!i)return;clearTimeout(e),n.textContent=i,n.style.display="block";const a=s.getBoundingClientRect(),l=Math.min(260,window.innerWidth-24);n.style.width=l+"px";let c=a.left+a.width/2-l/2+window.scrollX;c=Math.max(12+window.scrollX,Math.min(c,window.scrollX+window.innerWidth-l-12)),n.style.left=c+"px";const d=n.offsetHeight;let f=a.top+window.scrollY-d-8;a.top<d+12&&(f=a.bottom+window.scrollY+8),n.style.top=f+"px"},r=()=>{e=setTimeout(()=>{n.style.display="none"},80)};document.addEventListener("mouseover",s=>{const i=s.target.closest&&s.target.closest("[data-tip]");i&&t(i)}),document.addEventListener("mouseout",s=>{s.target.closest&&s.target.closest("[data-tip]")&&r()}),document.addEventListener("focusin",s=>{const i=s.target.closest&&s.target.closest("[data-tip]");i&&t(i)}),document.addEventListener("focusout",s=>{s.target.closest&&s.target.closest("[data-tip]")&&r()}),document.addEventListener("click",s=>{const i=s.target.closest&&s.target.closest("[data-tip]");i&&(n.style.display==="block"?r():t(i))})}function PT(){if(window.__chartHoverInit)return;window.__chartHoverInit=!0;const n=e=>e.querySelectorAll("circle[data-tip]").forEach(t=>{t.setAttribute("fill","transparent"),t.removeAttribute("stroke")});document.addEventListener("mousemove",e=>{const t=e.target.closest&&e.target.closest(".ichart");if(!t)return;const r=t.querySelectorAll("circle[data-tip]");if(!r.length)return;let s=null,i=1/0;r.forEach(a=>{const l=a.getBoundingClientRect(),c=Math.abs(l.left+l.width/2-e.clientX);c<i&&(i=c,s=a)}),s&&(n(t),s.setAttribute("fill","#60a5fa"),s.setAttribute("stroke","var(--surface,#161b22)"),s.setAttribute("stroke-width","2"),s.dispatchEvent(new MouseEvent("mouseover",{bubbles:!0})))}),document.addEventListener("mouseout",e=>{const t=e.target.closest&&e.target.closest(".ichart");t&&n(t)})}const dr=n=>"£"+Math.round(n).toLocaleString();function Mp(n,e,t){return`<svg class="ichart" viewBox="0 0 ${e} ${t}" style="width:100%;height:auto;overflow:visible;display:block" role="img">${n}</svg>`}function Dp(n,{max:e,valueFmt:t=dr,tip:r,pct:s=!1}={}){const m=n.length;if(m<2)return"";const g=e??(s?100:Math.max(1,...n)),b=V=>56+V/(m-1)*590,S=V=>174-Math.max(0,Math.min(s?100:1/0,V))/g*160,I=n.map((V,q)=>`${b(q).toFixed(1)},${S(V).toFixed(1)}`).join(" "),R=`56,${174 .toFixed(1)} ${I} ${b(m-1).toFixed(1)},${174 .toFixed(1)}`,C=s?[0,50,100]:[0,g/2,g],D=[0,Math.floor((m-1)/2),m-1],F=r||((V,q)=>`Year ${q}: ${t(V)}`);return Mp(C.map(V=>`<line x1="56" y1="${S(V).toFixed(1)}" x2="646" y2="${S(V).toFixed(1)}" stroke="var(--border,#8883)" opacity=".45"/><text x="50" y="${(S(V)+3).toFixed(1)}" text-anchor="end" font-size="10" fill="var(--text-muted,#999)">${t(V)}</text>`).join("")+`<polygon points="${R}" fill="rgba(96,165,250,.13)"/><polyline points="${I}" fill="none" stroke="#60a5fa" stroke-width="2.5"/>`+n.map((V,q)=>`<circle cx="${b(q).toFixed(1)}" cy="${S(V).toFixed(1)}" r="8" fill="transparent" data-tip="${F(V,q).replace(/"/g,"&quot;")}"></circle>`).join("")+D.map(V=>`<text x="${b(V).toFixed(1)}" y="192" text-anchor="middle" font-size="10" fill="var(--text-muted,#999)">Year ${V}</text>`).join(""),660,200)}function CT(n){const l=n.p50.length;if(l<2)return"";const c=Math.max(1,...n.p90),d=I=>60+I/(l-1)*606,f=I=>222-Math.max(0,I)/c*208,m=(I,R)=>I.map((C,D)=>`${d(D).toFixed(1)},${f(C).toFixed(1)}`).concat(R.map((C,D)=>`${d(l-1-D).toFixed(1)},${f(R[l-1-D]).toFixed(1)}`)).join(" "),g=I=>I.map((R,C)=>`${d(C).toFixed(1)},${f(R).toFixed(1)}`).join(" "),b=[0,c/4,c/2,3*c/4,c],S=[0,Math.floor((l-1)/2),l-1];return Mp(b.map(I=>`<line x1="60" y1="${f(I).toFixed(1)}" x2="666" y2="${f(I).toFixed(1)}" stroke="var(--border,#8883)" opacity=".4"/><text x="54" y="${(f(I)+3).toFixed(1)}" text-anchor="end" font-size="10" fill="var(--text-muted,#999)">${dr(I)}</text>`).join("")+`<polygon points="${m(n.p90,n.p10)}" fill="rgba(96,165,250,.12)"/><polygon points="${m(n.p75,n.p25)}" fill="rgba(96,165,250,.22)"/><polyline points="${g(n.p50)}" fill="none" stroke="#60a5fa" stroke-width="2.5"/>`+n.p50.map((I,R)=>`<circle cx="${d(R).toFixed(1)}" cy="${f(I).toFixed(1)}" r="8" fill="transparent" data-tip="Year ${R}: middle ${dr(I)}; likely range ${dr(n.p10[R])} to ${dr(n.p90[R])}"></circle>`).join("")+S.map(I=>`<text x="${d(I).toFixed(1)}" y="242" text-anchor="middle" font-size="10" fill="var(--text-muted,#999)">Year ${I}</text>`).join(""),680,250)}function kT(n){if(!n||!n.funded)return"";const e=s=>(s||0).toFixed(s>=10?0:1),t=n.pctSurviveFullTerm>=80?"success":n.pctSurviveFullTerm>=50?"warning":"danger",r=n.avgHigherRateYears<1?"success":n.avgHigherRateYears<4?"warning":"danger";return`
        ...
        <div class="verdict-basis">Based on ${e}. Pot and income values are shown in today's money.</div>
          ...
          <p>${t.diagnosis}</p>
          <p class="lever"><strong>What could help:</strong> ${MT(t.primaryDriver)}</p>
        </div>`),i}function Np(n,e,t,r,s){RT(),PT();const i=n.survival||{},a=n.finalReal||{},l=n.protection||{},c=l.pctWithProtection!=null?l.pctWithProtection:(l.runsWithProtection||0)/(e.length||1)*100,d=r==="mcResults",f=d?`${e.length.toLocaleString()} simulated futures`:`${e.length} historical periods since 1928`;let m=`
        <div class="card">
          <h2>${t}</h2>
      ...
      `;document.getElementById(r).innerHTML=m}function NT(n,e){let t='<div class="card"><h2>Scenario Analysis</h2>';t+=`
        ...
        <div class="tax-year-detail-card">
          ...
          <div class="tax-year-grid">
            ...
            <div class="tax-year-field">
              ...
              <span class="value">${BT(s.startMonth||4)}</span>
            </div>
            <div class="tax-year-field">
