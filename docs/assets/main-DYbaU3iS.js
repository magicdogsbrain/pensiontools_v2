 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const am="FirebaseError";class nn extends Error{constructor(t,e,r){super(e),this.code=t,this.customData=r,this.name=am,Object.setPrototypeOf(this,nn.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,Ns.prototype.create)}}class Ns{constructor(t,e,r){this.service=t,this.serviceName=e,this.errors=r}create(t,...e){const r=e[0]||{},s=`${this.service}/${t}`,i=this.errors[t],a=i?lm(i,r):"Error",l=`${this.serviceName}: ${a} (${s}).`;return new nn(s,l,r)}}function lm(n,t){return n.replace(cm,(e,r)=>{const s=t[r];return s!=null?String(s):`<${r}?>`})}const cm=/\{\$([^}]+)}/g;function um(n){for(const t in n)if(Object.prototype.hasOwnProperty.call(n,t))return!1;return!0}function Li(n,t){if(n===t)return!0;const e=Object.keys(n),r=Object.keys(t);for(const s of e){if(!r.includes(s))return!1;const i=n[s],a=t[s];if(Yc(i)&&Yc(a)){if(!Li(i,a))return!1}else if(i!==a)return!1}for(const s of r)if(!e.includes(s))return!1;return!0}function Yc(n){return n!==null&&typeof n=="object"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Vi=new Map,cg=new Map,_a=new Map;function Xc(n,t){try{n.container.addComponent(t)}catch(e){Je.debug(`Component ${t.name} failed to register with FirebaseApp ${n.name}`,e)}}function Mr(n){const t=n.name;if(_a.has(t))return Je.debug(`There were multiple attempts to register component ${t}.`),!1;_a.set(t,n);for(const e of Vi.values())Xc(e,n);for(const e of cg.values())Xc(e,n);return!0}function Ya(n,t){const e=n.container.getProvider("heartbeat").getImmediate({optional:!0});return e&&e.triggerHeartbeat(),n.container.getProvider(t)}function ve(n){return n.settings!==void 0}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $r=ag;function kd(n,t={}){let e=n;typeof t!="object"&&(t={name:t});const r=Object.assign({name:va,automaticDataCollectionEnabled:!1},t),s=r.name;if(typeof s!="string"||!s)throw wn.create("bad-app-name",{appName:String(s)});if(e||(e=xd()),!e)throw wn.create("no-options");const i=Vi.get(s);if(i){if(Li(e,i.options)&&Li(r,i.config))return i;throw wn.create("duplicate-app",{appName:s})}const a=new ym(s);for(const c of _a.values())a.addComponent(c);const l=new dg(e,r,a);return Vi.set(s,l),l}function Dd(n=va){const t=Vi.get(n);if(!t&&n===va&&xd())return kd();if(!t)throw wn.create("no-app",{appName:n});return t}function En(n,t,e){var r;let s=(r=lg[n])!==null&&r!==void 0?r:n;e&&(s+=`-${e}`);const i=s.match(/\s|\//),a=t.match(/\s|\//);if(i||a){const l=[`Unable to register library "${s}" with version "${t}":`];i&&l.push(`library name "${s}" contains illegal characters (whitespace or "/")`),i&&a&&l.push("and"),a&&l.push(`version name "${t}" contains illegal characters (whitespace or "/")`),Je.warn(l.join(" "));return}Mr(new Gn(`${s}-version`,()=>({library:s,version:t}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const hg="firebase-heartbeat-database",fg=1,Is="firebase-heartbeat-store";let Xo=null;function Md(){return Xo||(Xo=Cm(hg,fg,{upgrade:(n,t)=>{switch(t){case 0:try{n.createObjectStore(Is)}catch(e){console.warn(e)}}}}).catch(n=>{throw wn.create("idb-open",{originalErrorMessage:n.message})})),Xo}async function pg(n){try{const e=(await Md()).transaction(Is),r=await e.objectStore(Is).get(Nd(n));return await e.done,r}catch(t){if(t instanceof nn)Je.warn(t.message);else{const e=wn.create("idb-get",{originalErrorMessage:t==null?void 0:t.message});Je.warn(e.message)}}}async function Zc(n,t){try{const r=(await Md()).transaction(Is,"readwrite");await r.objectStore(Is).put(t,Nd(n)),await r.done}catch(e){if(e instanceof nn)Je.warn(e.message);else{const r=wn.create("idb-set",{originalErrorMessage:e==null?void 0:e.message});Je.warn(r.message)}}}function Nd(n){return`${n.name}!${n.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function wg(n){Mr(new Gn("platform-logger",t=>new Mm(t),"PRIVATE")),Mr(new Gn("heartbeat",t=>new yg(t),"PRIVATE")),En(ya,Jc,n),En(ya,Jc,"esm2017"),En("fire-js","")}wg("");var Eg="firebase",bg="10.14.1";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Oi=new Ha("@firebase/auth");function Ig(n,...t){Oi.logLevel<=et.WARN&&Oi.warn(`Auth (${$r}): ${n}`,...t)}function Ti(n,...t){Oi.logLevel<=et.ERROR&&Oi.error(`Auth (${$r}): ${n}`,...t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Vs{constructor(t,e){this.shortDelay=t,this.longDelay=e,Xe(e>t,"Short delay should be less than long delay!"),this.isMobile=Xp()||nm()}get(){return xg()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Lg(n,t){return Be(n,"POST","/v1/accounts:delete",t)}async function zd(n,t){return Be(n,"POST","/v1/accounts:lookup",t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Nr(n,t,e=!1){if(e)return t;try{return await t}catch(r){throw r instanceof nn&&Og(r)&&n.auth.currentUser===n&&await n.auth.signOut(),r}}function Og({code:n}){return n==="auth/user-disabled"||n==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Jd(n,t=[]){let e;switch(n){case"Browser":e=au(Jt());break;case"Worker":e=`${au(Jt())}-${n}`;break;default:e=n}const r=t.length?t.join(","):"FirebaseCore-web";return`${e}/JsCore/${$r}/${r}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Wg(n,t={}){return Be(n,"GET","/v2/passwordPolicy",rn(n,t))}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function cy(n,t){return Os(n,"POST","/v1/accounts:signInWithPassword",rn(n,t))}async function uy(n,t){return Be(n,"POST","/v1/accounts:sendOobCode",rn(n,t))}async function dy(n,t){return uy(n,t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function hy(n,t){return Os(n,"POST","/v1/accounts:signInWithEmailLink",rn(n,t))}async function fy(n,t){return Os(n,"POST","/v1/accounts:signInWithEmailLink",rn(n,t))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Pr(n,t){return Os(n,"POST","/v1/accounts:signInWithIdp",rn(n,t))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class He extends Bs{constructor(){super("google.com"),this.addScope("profile")}static credential(t,e){return Kn._fromParams({providerId:He.PROVIDER_ID,signInMethod:He.GOOGLE_SIGN_IN_METHOD,idToken:t,accessToken:e})}static credentialFromResult(t){return He.credentialFromTaggedObject(t)}static credentialFromError(t){return He.credentialFromTaggedObject(t.customData||{})}static credentialFromTaggedObject({_tokenResponse:t}){if(!t)return null;const{oauthIdToken:e,oauthAccessToken:r}=t;if(!e&&!r)return null;try{return He.credential(e,r)}catch{return null}}}He.GOOGLE_SIGN_IN_METHOD="google.com";He.PROVIDER_ID="google.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class mn extends Bs{constructor(){super("twitter.com")}static credential(t,e){return Kn._fromParams({providerId:mn.PROVIDER_ID,signInMethod:mn.TWITTER_SIGN_IN_METHOD,oauthToken:t,oauthTokenSecret:e})}static credentialFromResult(t){return mn.credentialFromTaggedObject(t)}static credentialFromError(t){return mn.credentialFromTaggedObject(t.customData||{})}static credentialFromTaggedObject({_tokenResponse:t}){if(!t)return null;const{oauthAccessToken:e,oauthTokenSecret:r}=t;if(!e||!r)return null;try{return mn.credential(e,r)}catch{return null}}}mn.TWITTER_SIGN_IN_METHOD="twitter.com";mn.PROVIDER_ID="twitter.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function yy(n,t){return Os(n,"POST","/v1/accounts:signUp",rn(n,t))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zi extends nn{constructor(t,e,r,s){var i;super(e.code,e.message),this.operationType=r,this.user=s,Object.setPrototypeOf(this,zi.prototype),this.customData={appName:t.name,tenantId:(i=t.tenantId)!==null&&i!==void 0?i:void 0,_serverResponse:e.customData._serverResponse,operationType:r}}static _fromErrorAndOperation(t,e,r,s){return new zi(t,e,r,s)}}function th(n,t,e,r){return(t==="reauthenticate"?e._getReauthenticationResolver(n):e._getIdTokenResponse(n)).catch(i=>{throw i.code==="auth/multi-factor-auth-required"?zi._fromErrorAndOperation(n,i,t,r):i})}async function vy(n,t,e=!1){const r=await Nr(n,t._linkToIdToken(n.auth,await n.getIdToken()),e);return Qn._forOperation(n,"link",r)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function nh(n){const t=sn(n);t._getPasswordPolicyInternal()&&await t._updatePasswordPolicy()}async function Ey(n,t,e){const r=sn(n);await Fi(r,{requestType:"PASSWORD_RESET",email:t,clientType:"CLIENT_TYPE_WEB"},"getOobCode",dy)}async function by(n,t,e){if(ve(n.app))return Promise.reject(Ke(n));const r=sn(n),a=await Fi(r,{returnSecureToken:!0,email:t,password:e,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",yy).catch(c=>{throw c.code==="auth/password-does-not-meet-requirements"&&nh(n),c}),l=await Qn._fromIdTokenResponse(r,"signIn",a);return await r._updateCurrentUser(l.user),l}function Ty(n,t,e){return ve(n.app)?Promise.reject(Ke(n)):wy(It(n),qr.credential(t,e)).catch(async r=>{throw r.code==="auth/password-does-not-meet-requirements"&&nh(n),r})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Iy(n,t){return Be(n,"POST","/v1/accounts:update",t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Sy(n,{displayName:t,photoURL:e}){if(t===void 0&&e===void 0)return;const r=It(n),i={idToken:await r.getIdToken(),displayName:t,photoUrl:e,returnSecureToken:!0},a=await Nr(r,Iy(r.auth,i));r.displayName=a.displayName||null,r.photoURL=a.photoUrl||null;const l=r.providerData.find(({providerId:c})=>c==="password");l&&(l.displayName=r.displayName,l.photoURL=r.photoURL),await r._updateTokensIfNecessary(a)}function Ay(n,t,e,r){return It(n).onIdTokenChanged(t,e,r)}function xy(n,t,e){return It(n).beforeAuthStateChanged(t,e)}function Ry(n,t,e,r){return It(n).onAuthStateChanged(t,e,r)}function Py(n){return It(n).signOut()}const Ui="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Me(){return window}function Ly(n){Me().location.href=n}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ah(){return typeof Me().WorkerGlobalScope<"u"&&typeof Me().importScripts=="function"}async function Vy(){if(!(navigator!=null&&navigator.serviceWorker))return null;try{return(await navigator.serviceWorker.ready).active}catch{return null}}function Oy(){var n;return((n=navigator==null?void 0:navigator.serviceWorker)===null||n===void 0?void 0:n.controller)||null}function By(){return ah()?self:null}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ov(n,t={}){return Be(n,"GET","/v1/projects",t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const dv=new Vs(3e4,6e4);function mu(){const n=Me().___jsl;if(n!=null&&n.H){for(const t of Object.keys(n.H))if(n.H[t].r=n.H[t].r||[],n.H[t].L=n.H[t].L||[],n.H[t].r=[...n.H[t].L],n.CP)for(let e=0;e<n.CP.length;e++)n.CP[e]=null}}function hv(n){return new Promise((t,e)=>{var r,s,i;function a(){mu(),gapi.load("gapi.iframes",{callback:()=>{t(gapi.iframes.getContext())},ontimeout:()=>{mu(),e(_e(n,"network-request-failed"))},timeout:dv.get()})}if(!((s=(r=Me().gapi)===null||r===void 0?void 0:r.iframes)===null||s===void 0)&&s.Iframe)t(gapi.iframes.getContext());else if(!((i=Me().gapi)===null||i===void 0)&&i.load)a();else{const l=Zg("iframefcb");return Me()[l]=()=>{gapi.load?a():e(_e(n,"network-request-failed"))},Xd(`${Xg()}?onload=${l}`).catch(c=>e(c))}}).catch(t=>{throw Ai=null,t})}let Ai=null;function fv(n){return Ai=Ai||hv(n),Ai}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const pv=new Vs(5e3,15e3),mv="__/auth/iframe",gv="emulator/auth/iframe",yv={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},vv=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function _v(n){const t=n.config;W(t.authDomain,n,"auth-domain-config-required");const e=t.emulator?Ja(t,gv):`https://${n.config.authDomain}/${mv}`,r={apiKey:t.apiKey,appName:n.name,v:$r},s=vv.get(n.config.apiHost);s&&(r.eid=s);const i=n._getFrameworks();return i.length&&(r.fw=i.join(",")),`${e}?${Ls(r).slice(1)}`}async function wv(n){const t=await fv(n),e=Me().gapi;return W(e,n,"internal-error"),t.open({where:document.body,url:_v(n),messageHandlersFilter:e.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:yv,dontclear:!0},r=>new Promise(async(s,i)=>{await r.restyle({setHideOnLeave:!1});const a=_e(n,"network-request-failed"),l=Me().setTimeout(()=>{i(a)},pv.get());function c(){Me().clearTimeout(l),s(r)}r.ping(c).then(c,()=>{i(a)})}))}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Lv(n){switch(n){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}function Vv(n){Mr(new Gn("auth",(t,{options:e})=>{const r=t.getProvider("app").getImmediate(),s=t.getProvider("heartbeat"),i=t.getProvider("app-check-internal"),{apiKey:a,authDomain:l}=r.options;W(a&&!a.includes(":"),"invalid-api-key",{appName:r.name});const c={apiKey:a,authDomain:l,clientPlatform:n,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:Jd(n)},d=new Kg(r,s,i,c);return sy(d,e),d},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((t,e,r)=>{t.getProvider("auth-internal").initialize()})),Mr(new Gn("auth-internal",t=>{const e=sn(t.getProvider("auth").getImmediate());return(r=>new Nv(r))(e)},"PRIVATE").setInstantiationMode("EXPLICIT")),En(vu,_u,Lv(n)),En(vu,_u,"esm2017")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Jn=new Ha("@firebase/firestore");function as(){return Jn.logLevel}function U(n,...t){if(Jn.logLevel<=et.DEBUG){const e=t.map(il);Jn.debug(`Firestore (${jr}): ${n}`,...e)}}function Ze(n,...t){if(Jn.logLevel<=et.ERROR){const e=t.map(il);Jn.error(`Firestore (${jr}): ${n}`,...e)}}function Lr(n,...t){if(Jn.logLevel<=et.WARN){const e=t.map(il);Jn.warn(`Firestore (${jr}): ${n}`,...e)}}function il(n){if(typeof n=="string")return n;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Y(n="Unexpected state"){const t=`FIRESTORE (${jr}) INTERNAL ASSERTION FAILED: `+n;throw Ze(t),new Error(t)}function lt(n,t){n||Y()}function K(n,t){return n}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ol{constructor(t,e){this.previousValue=t,e&&(e.sequenceNumberHandler=r=>this.ie(r),this.se=r=>e.writeSequenceNumber(r))}ie(t){return this.previousValue=Math.max(t,this.previousValue),this.previousValue}next(){const t=++this.previousValue;return this.se&&this.se(t),t}}ol.oe=-1;function io(n){return n==null}function qi(n){return n===0&&1/n==-1/0}function r0(n){return typeof n=="number"&&Number.isInteger(n)&&!qi(n)&&n<=Number.MAX_SAFE_INTEGER&&n>=Number.MIN_SAFE_INTEGER}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qt{constructor(t){this.comparator=t,this.data=new gt(this.comparator)}has(t){return this.data.get(t)!==null}first(){return this.data.minKey()}last(){return this.data.maxKey()}get size(){return this.data.size}indexOf(t){return this.data.indexOf(t)}forEach(t){this.data.inorderTraversal((e,r)=>(t(e),!1))}forEachInRange(t,e){const r=this.data.getIteratorFrom(t[0]);for(;r.hasNext();){const s=r.getNext();if(this.comparator(s.key,t[1])>=0)return;e(s.key)}}forEachWhile(t,e){let r;for(r=e!==void 0?this.data.getIteratorFrom(e):this.data.getIterator();r.hasNext();)if(!t(r.getNext().key))return}firstAfterOrEqual(t){const e=this.data.getIteratorFrom(t);return e.hasNext()?e.getNext().key:null}getIterator(){return new Iu(this.data.getIterator())}getIteratorFrom(t){return new Iu(this.data.getIteratorFrom(t))}add(t){return this.copy(this.data.remove(t).insert(t,!0))}delete(t){return this.has(t)?this.copy(this.data.remove(t)):this}isEmpty(){return this.data.isEmpty()}unionWith(t){let e=this;return e.size<t.size&&(e=t,t=this),t.forEach(r=>{e=e.add(r)}),e}isEqual(t){if(!(t instanceof qt)||this.size!==t.size)return!1;const e=this.data.getIterator(),r=t.data.getIterator();for(;e.hasNext();){const s=e.getNext().key,i=r.getNext().key;if(this.comparator(s,i)!==0)return!1}return!0}toArray(){const t=[];return this.forEach(e=>{t.push(e)}),t}toString(){const t=[];return this.forEach(e=>t.push(e)),"SortedSet("+t.toString()+")"}copy(t){const e=new qt(this.comparator);return e.data=t,e}}class Iu{constructor(t){this.iter=t}getNext(){return this.iter.getNext().key}hasNext(){return this.iter.hasNext()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function al(n){var t,e;return((e=(((t=n==null?void 0:n.mapValue)===null||t===void 0?void 0:t.fields)||{}).__type__)===null||e===void 0?void 0:e.stringValue)==="server_timestamp"}function ll(n){const t=n.mapValue.fields.__previous_value__;return al(t)?ll(t):t}function xs(n){const t=An(n.mapValue.fields.__local_write_time__.timestampValue);return new Pt(t.seconds,t.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ee{constructor(t){this.value=t}static empty(){return new ee({mapValue:{}})}field(t){if(t.isEmpty())return this.value;{let e=this.value;for(let r=0;r<t.length-1;++r)if(e=(e.mapValue.fields||{})[t.get(r)],!Ri(e))return null;return e=(e.mapValue.fields||{})[t.lastSegment()],e||null}}set(t,e){this.getFieldsMap(t.popLast())[t.lastSegment()]=gs(e)}setAll(t){let e=$t.emptyPath(),r={},s=[];t.forEach((a,l)=>{if(!e.isImmediateParentOf(l)){const c=this.getFieldsMap(e);this.applyChanges(c,r,s),r={},s=[],e=l.popLast()}a?r[l.lastSegment()]=gs(a):s.push(l.lastSegment())});const i=this.getFieldsMap(e);this.applyChanges(i,r,s)}delete(t){const e=this.field(t.popLast());Ri(e)&&e.mapValue.fields&&delete e.mapValue.fields[t.lastSegment()]}isEqual(t){return Oe(this.value,t.value)}getFieldsMap(t){let e=this.value;e.mapValue.fields||(e.mapValue={fields:{}});for(let r=0;r<t.length;++r){let s=e.mapValue.fields[t.get(r)];Ri(s)&&s.mapValue.fields||(s={mapValue:{fields:{}}},e.mapValue.fields[t.get(r)]=s),e=s}return e.mapValue.fields}applyChanges(t,e,r){er(e,(s,i)=>t[s]=i);for(const s of r)delete t[s]}clone(){return new ee(gs(this.value))}}function Ih(n){const t=[];return er(n.fields,(e,r)=>{const s=new $t([e]);if(Ri(r)){const i=Ih(r.mapValue).fields;if(i.length===0)t.push(s);else for(const a of i)t.push(s.child(a))}else t.push(s)}),new ae(t)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function fl(n,t){if(n.useProto3Json){if(isNaN(t))return{doubleValue:"NaN"};if(t===1/0)return{doubleValue:"Infinity"};if(t===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:qi(t)?"-0":t}}function Oh(n){return{integerValue:""+n}}function x0(n,t){return r0(t)?Oh(t):fl(n,t)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class h_{constructor(t){this.serializer=t,this.hr=new Map,this.Pr=new Map}getBundleMetadata(t,e){return L.resolve(this.hr.get(e))}saveBundleMetadata(t,e){return this.hr.set(e.id,function(s){return{id:s.id,version:s.version,createTime:Le(s.createTime)}}(e)),L.resolve()}getNamedQuery(t,e){return L.resolve(this.Pr.get(e))}saveNamedQuery(t,e){return this.Pr.set(e.name,function(s){return{name:s.name,query:o_(s.bundledQuery),readTime:Le(s.readTime)}}(e)),L.resolve()}}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Cr{constructor(t){this.comparator=t?(e,r)=>t(e,r)||q.comparator(e.key,r.key):(e,r)=>q.comparator(e.key,r.key),this.keyedMap=hs(),this.sortedSet=new gt(this.comparator)}static emptySet(t){return new Cr(t.comparator)}has(t){return this.keyedMap.get(t)!=null}get(t){return this.keyedMap.get(t)}first(){return this.sortedSet.minKey()}last(){return this.sortedSet.maxKey()}isEmpty(){return this.sortedSet.isEmpty()}indexOf(t){const e=this.keyedMap.get(t);return e?this.sortedSet.indexOf(e):-1}get size(){return this.sortedSet.size}forEach(t){this.sortedSet.inorderTraversal((e,r)=>(t(e),!1))}add(t){const e=this.delete(t.key);return e.copy(e.keyedMap.insert(t.key,t),e.sortedSet.insert(t,null))}delete(t){const e=this.get(t);return e?this.copy(this.keyedMap.remove(t),this.sortedSet.remove(e)):this}isEqual(t){if(!(t instanceof Cr)||this.size!==t.size)return!1;const e=this.sortedSet.getIterator(),r=t.sortedSet.getIterator();for(;e.hasNext();){const s=e.getNext().key,i=r.getNext().key;if(!s.isEqual(i))return!1}return!0}toString(){const t=[];return this.forEach(e=>{t.push(e.toString())}),t.length===0?"DocumentSet ()":`DocumentSet (
  `+t.join(`  
`)+`
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Cn{constructor(t,e,r){this.converter=e,this._query=r,this.type="query",this.firestore=t}withConverter(t){return new Cn(this.firestore,t,this._query)}}class re{constructor(t,e,r){this.converter=e,this._key=r,this.type="document",this.firestore=t}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new bn(this.firestore,this.converter,this._key.path.popLast())}withConverter(t){return new re(this.firestore,t,this._key)}}class bn extends Cn{constructor(t,e,r){super(t,e,hl(r)),this._path=r,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const t=this._path.popLast();return t.isEmpty()?null:new re(this.firestore,null,new q(t))}withConverter(t){return new bn(this.firestore,t,this._path)}}function xw(n,t,...e){if(n=It(n),Af("collection","path",t),n instanceof go){const r=pt.fromString(t,...e);return nd(r),new bn(n,null,r)}{if(!(n instanceof re||n instanceof bn))throw new z(M.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=n._path.child(pt.fromString(t,...e));return nd(r),new bn(n.firestore,null,r)}}function kr(n,t,...e){if(n=It(n),arguments.length===1&&(t=Eh.newId()),Af("doc","path",t),n instanceof go){const r=pt.fromString(t,...e);return ed(r),new re(n,null,new q(r))}{if(!(n instanceof re||n instanceof bn))throw new z(M.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=n._path.child(pt.fromString(t,...e));return ed(r),new re(n.firestore,n instanceof bn?n.converter:null,new q(r))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */function Xi(n){return yo(n=en(n,Gr)),new Hw(n,t=>jl(n,t))}(function(t,e=!0){(function(s){jr=s})($r),Mr(new Gn("firestore",(r,{instanceIdentifier:s,options:i})=>{const a=r.getProvider("app").getImmediate(),l=new Gr(new jv(r.getProvider("auth-internal")),new Gv(r.getProvider("app-check-internal")),function(d,f){if(!Object.prototype.hasOwnProperty.apply(d.options,["projectId"]))throw new z(M.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new Rs(d.options.projectId,f)}(a,s),a);return i=Object.assign({useFetchStreams:e},i),l._setSettings(i),l},"PUBLIC").setMultipleInstances(!0)),En(bu,"4.7.3",t),En(bu,"4.7.3","esm2017")})();const Of={apiKey:"AIzaSyBdbve0H70D-Ch69WlaxEly7PVBFVRB5p0",authDomain:"pensiontools-4b237.firebaseapp.com",projectId:"pensiontools-4b237",storageBucket:"pensiontools-4b237.firebasestorage.app",messagingSenderId:"760877353696",appId:"1:760877353696:web:2d6f7173c8d7fab6fd9e85",measurementId:"G-80XX542QZE"};function St(){return Of.apiKey!=="YOUR_API_KEY"}let oa=null,ce=null,ne=null;try{St()?(oa=kd(Of),ce=zv(oa),ne=Rw(oa)):console.warn("Firebase not configured. Login required to save data.")}catch(n){console.error("Firebase initialization error:",n)}const Ww=new He;let gn=null,Es=[];function Yw(){if(!St()||!ce){console.warn("Firebase not configured - auth disabled");return}Ry(ce,n=>{console.log("onAuthStateChanged fired:",n?n.email:"null"),gn=n,console.log("Notifying",Es.length,"listeners"),Es.forEach(t=>t(n))})}function Gw(n){return console.log("onAuthStateChange: adding listener, currentUser is:",gn&&gn.email),Es.push(n),gn&&(console.log("onAuthStateChange: immediately calling listener with user"),n(gn)),()=>{Es=Es.filter(t=>t!==n)}}function Ys(){return gn}function Ee(){return gn!==null}async function Kw(n,t,e=null){if(!St()||!ce)throw new Error("Firebase not configured");const r=await by(ce,n,t);return e&&r.user&&await Sy(r.user,{displayName:e}),r}async function Qw(n,t){if(!St()||!ce)throw new Error("Firebase not configured");return Ty(ce,n,t)}async function Jw(){if(!St()||!ce)throw new Error("Firebase not configured");console.log("Initiating Google sign-in popup...");try{const n=await Ky(ce,Ww);return console.log("Google sign-in successful:",n.user.email),n}catch(n){throw console.error("signInWithPopup error:",n.code,n.message),n}}async function Bf(){if(!St()||!ce)throw new Error("Firebase not configured");return Py(ce)}async function Xw(n){if(!St()||!ce)throw new Error("Firebase not configured");return Ey(ce,n)}Yw();function Io(n,t="settings"){const e=Ys();return!e||!ne?null:kr(ne,"users",e.uid,n,t)}function So(n){const t=Ys();return!t||!ne?null:xw(ne,"users",t.uid,n)}async function Ff(){if(!St())return null;const n=Io("decision");if(!n)return null;try{const t=await Lf(n);return t.exists()?t.data():null}catch(t){return console.error("Error loading decision data:",t),null}}async function Zw(n){if(!St())return;const t=Io("decision");if(t)try{await ql(t,{...n,lastModified:new Date().toISOString()},{merge:!0})}catch(e){throw console.error("Error saving decision data:",e),e}}async function Hl(n={}){if(!St())return[];const t=So("history");if(!t)return[];try{let e=ws(t,id("date",n.sortDesc?"desc":"asc"));n.taxYear&&(e=ws(t,Bl("taxYear","==",n.taxYear),id("date",n.sortDesc?"desc":"asc"))),n.limit&&(e=ws(e,Fw(n.limit)));const r=await To(e),s=[];return r.forEach(i=>{s.push({id:i.id,...i.data()})}),s}catch(e){return console.error("Error loading decision history:",e),[]}}async function tE(n){if(!St())return null;const t=So("history");if(!t)return null;try{const e=ws(t,Bl("date","==",n.date)),r=await To(e);if(!r.empty){const i=r.docs[0].id;return await ql(kr(ne,"users",Ys().uid,"history",i),{...n,updatedAt:new Date().toISOString()}),i}return(await qw(t,{...n,createdAt:new Date().toISOString()})).id}catch(e){throw console.error("Error adding history record:",e),e}}async function eE(n){if(!St())return;const t=So("history");if(t)try{const e=ws(t,Bl("date","==",n)),r=await To(e),s=Xi(ne);r.forEach(i=>{s.delete(i.ref)}),await s.commit()}catch(e){throw console.error("Error deleting history record:",e),e}}async function nE(){if(!St())return;const n=So("history");if(n)try{const t=await To(n),e=500,r=[];let s=Xi(ne),i=0;t.forEach(a=>{s.delete(a.ref),i++,i>=e&&(r.push(s),s=Xi(ne),i=0)}),i>0&&r.push(s),await Promise.all(r.map(a=>a.commit()))}catch(t){throw console.error("Error clearing history:",t),t}}async function rE(){if(!St())return null;const n=Io("stress");if(!n)return null;try{const t=await Lf(n);return t.exists()?t.data():null}catch(t){return console.error("Error loading stress data:",t),null}}async function zf(n){if(!St())return;const t=Io("stress");if(t)try{await ql(t,{...n,lastModified:new Date().toISOString()},{merge:!0})}catch(e){throw console.error("Error saving stress data:",e),e}}async function sE(){if(!St())return;const n=Ys();if(!(!n||!ne))try{await nE();const t=Xi(ne);t.delete(kr(ne,"users",n.uid,"decision","settings")),t.delete(kr(ne,"users",n.uid,"stress","settings")),t.delete(kr(ne,"users",n.uid,"profile","settings")),await t.commit(),console.log("All user data wiped successfully")}catch(t){throw console.error("Error wiping user data:",t),t}}async function iE(){if(!St())return!1;const n=await Ff(),t=await Hl({limit:1});return n!==null||t.length>0}let Qt=null,Hn=null;const Uf=5e3;function Di(){return{settings:{equityMin:te.EQUITY_MIN,bondMin:te.BOND_MIN,cashTarget:te.CASH_TARGET,duration:te.DURATION_YEARS,baseSalary:te.BASE_SALARY,protectionFactor:te.PROTECTION_FACTOR,recoveryBuffer:te.RECOVERY_BUFFER,consecutiveLimit:te.CONSECUTIVE_LIMIT,startDate:null,spStartDate:null,spWeeklyAmount:0,statePension:0,statePensionYear:0},taxYears:{},history:[],lastModified:null,checksum:null}}function Gs(){return St()&&Ee()}function oE(){Qt=null,Hn=null}function $f(){return Qt&&Hn&&Date.now()-Hn<Uf?Qt:Di()}async function rr(){if(Qt&&Hn&&Date.now()-Hn<Uf)return Qt;if(!Gs())return console.warn("Firebase not available - returning defaults"),Di();try{const n=await Ff(),t=await Hl();if(n){const e={settings:n.settings||Di().settings,taxYears:n.taxYears||{},history:t||[],lastModified:n.lastModified,checksum:n.checksum};return Qt=e,Hn=Date.now(),e}}catch(n){console.error("Error loading from Firebase:",n)}return Di()}async function Ao(n){if(!Gs())throw new Error("Must be logged in to save data");try{n.lastModified=new Date().toISOString(),n.checksum=aE(n),await Zw({settings:n.settings,taxYears:n.taxYears,lastModified:n.lastModified,checksum:n.checksum}),Qt=n,Hn=Date.now()}catch(t){throw console.error("Error saving to Firebase:",t),new Error("Failed to save decision data")}}function aE(n){const t={settings:n.settings,taxYears:n.taxYears,historyCount:n.history.length,lastHistoryDate:n.history.length>0?n.history[n.history.length-1].date:null};return bd(t)}async function sr(){return(await rr()).settings}async function Wl(n){const t=await rr();t.settings={...t.settings,...n},await Ao(t)}function Yl(){return{pa:oe.PERSONAL_ALLOWANCE,brl:oe.BASIC_RATE_LIMIT,hrl:oe.HIGHER_RATE_LIMIT,cpi:.04,other:0,isaSavingsAllocation:0,isaSavingsUsed:0,isTaxEfficient:!0,taxEfficiencyChoice:null,grossIncomeToDate:0,startMonth:4,yearSetupComplete:!1,confirmedSalary:null}}function lE(n){const e=$f().taxYears[n];return e||Yl()}async function xo(n){const e=(await rr()).taxYears[n];return e||Yl()}async function Ro(n,t){console.log(`saveTaxYearConfig: Saving tax year ${n}`,t);const e=await rr();e.taxYears[n]={...lE(n),...t},await Ao(e),console.log(`saveTaxYearConfig: Saved tax year ${n}, yearSetupComplete=${e.taxYears[n].yearSetupComplete}`)}async function cE(n){const t=Qt||await rr(),e=(t.history||[]).filter(s=>s.taxYear===n),r=e.reduce((s,i)=>s+(i.isa||0),0);return console.log(`recalculateIsaSavingsUsed: Tax year ${n}, found ${e.length} records, total ISA used: ${r}`),console.log("recalculateIsaSavingsUsed: History records:",e.map(s=>({date:s.date,isa:s.isa}))),t.taxYears[n]||(console.log(`recalculateIsaSavingsUsed: No existing config for ${n}, creating default`),t.taxYears[n]=Yl()),console.log(`recalculateIsaSavingsUsed: Before update, isaSavingsUsed=${t.taxYears[n].isaSavingsUsed}`),t.taxYears[n].isaSavingsUsed=r,console.log(`recalculateIsaSavingsUsed: After update, isaSavingsUsed=${t.taxYears[n].isaSavingsUsed}`),await Ao(t),console.log("recalculateIsaSavingsUsed: Saved to Firebase"),r}async function uE(n){const t=await xo(n),e=t.yearSetupComplete===!0;return console.log(`isYearSetupComplete: Tax year ${n}, yearSetupComplete=${t.yearSetupComplete}, result=${e}`),e}async function Ks(){return(await rr()).taxYears}function dE(n={}){let e=[...$f().history];return n.taxYear&&(e=e.filter(r=>r.taxYear===n.taxYear)),n.startDate&&(e=e.filter(r=>r.date>=n.startDate)),n.endDate&&(e=e.filter(r=>r.date<=n.endDate)),n.sortDesc?e.sort((r,s)=>s.date.localeCompare(r.date)):e.sort((r,s)=>r.date.localeCompare(s.date)),n.limit&&(e=e.slice(0,n.limit)),e}async function Gl(n={}){if(Gs())try{return await Hl(n)}catch(t){console.error("Error loading history from Firebase:",t)}return dE(n)}async function hE(n){if(!Gs())throw new Error("Must be logged in to save history");if(await tE(n),Qt){const t=Qt.history.findIndex(e=>e.date===n.date);t>=0?Qt.history[t]=n:Qt.history.push(n),Qt.history.sort((e,r)=>e.date.localeCompare(r.date))}}async function qf(n){if(!Gs())throw new Error("Must be logged in to delete history");await eE(n),Qt&&(Qt.history=Qt.history.filter(t=>t.date!==n))}async function Kl(n){const t=await sr(),e=await Ks(),r=t.spStartDate,s=t.spWeeklyAmount||0;if(!r||!s){let f=null;if(r){const{formatStatePensionDate:m}=await Hc(async()=>{const{formatStatePensionDate:v}=await Promise.resolve().then(()=>ld);return{formatStatePensionDate:v}},void 0,import.meta.url);f=m(r)}return{amount:0,monthly:0,yearsUntil:0,isReceiving:!1,isFirstYear:!1,startDate:f}}const{calculateStatePensionForTaxYear:i,getTimeUntilStatePension:a,parseStatePensionDate:l}=await Hc(async()=>{const{calculateStatePensionForTaxYear:f,getTimeUntilStatePension:m,parseStatePensionDate:v}=await Promise.resolve().then(()=>ld);return{calculateStatePensionForTaxYear:f,getTimeUntilStatePension:m,parseStatePensionDate:v}},void 0,import.meta.url),c=i({taxYear:n,spStartDate:r,weeklyAmount:s,taxYearConfigs:e}),d=a(r);return{amount:c.annual,monthly:c.monthly,yearsUntil:d.years,monthsUntil:d.months,isReceiving:c.isReceiving,isFirstYear:c.isFirstYear,weeksInYear:c.weeksInYear,startDate:c.startDate}}async function fE(n){const t=Rp(n);t.stdSipp=n.stdSipp||n.sippDraw,await hE(t),n.taxYear&&await cE(n.taxYear)}function Po(n,t,e=0){const r=ja(e);let s=n.equityStart,i=n.bondStart,a=n.cashStart,l=n.hodlEnabled?n.hodlStart!==void 0?n.hodlStart:n.hodlValue:0,c=0,d=null,f=0,m=0,v=0,E=0,T=!1,x=!1,I=null,P=0,D=-1;const C=[],N=[];let F=1;C.push({year:0,month:0,equity:s,bond:i,cash:a,hodl:l,total:s+i+a,draw:0,source:"None",inProtection:!1,equityMin:n.equityMin,bondMin:n.bondMin,cashMax:n.cashTarget});for(let V=0;V<n.years*12;V++){const b=Math.floor(V/12),g=V%12,y=g>=3?b:b-1;if(y!==D&&(P=0,D=y),V>0&&V%12===0){const it=t.inflation[b]||.025;N.push(it),F*=1+it}const w=t.equity[b]||0,S=t.inflation[b]||.025,A=b>0?t.inflation[b-1]||.025:S,_=Ar(n.equityMin,b,n.duration,F,!0),ot=Ar(n.bondMin,b,n.duration,F,!0),At=Ar(n.cashTarget,b,n.duration,F,!1),X=mE(n,b,F,N),Et=X;let ct=T?X*n.protectionMult:X;T&&(P+=Et-ct);const xt=pE(S,w,A,r),ht=Math.max(.005,S+.012);if(s*=1+Math.pow(1+w,1/12)-1,i*=1+Math.pow(1+xt,1/12)-1,a*=1+Math.pow(1+ht,1/12)-1,l>0){const ue=(r()-.5)*2*.06;let de=0;w<-.1?de=Math.min(.15,Math.abs(w)*.4):w<-.05&&(de=Math.abs(w)*.2);let kt=.069+ue+de;kt=Math.max(-.08,Math.min(.18,kt)),l*=1+Math.pow(1+kt,1/12)-1}const yt=s+i,$=_+ot;T&&yt>$+5e3&&(T=!1,E=0,m=Math.max(m,v),v=0),T&&(f++,v++);let _t=0;if(!T&&P>0&&yt>$+15e3){let it=g>=3?15-g:3-g;it<1&&(it=1);const Ct=yt-$-15e3,ue=Math.min(P/it,Ct/it),de=Et*.5;_t=Math.min(ue,de),_t>50&&(ct+=_t,P-=_t)}let J="Growth";if(!T&&yt>=$+ct){const it=Math.max(0,s-_),Ct=Math.max(0,i-ot),ue=it+Ct;if(ue>0){if(s-=ct*it/ue,i-=ct*Ct/ue,E=0,J="Growth",a<At){const de=yt-$-ct;if(de>5e3){const kt=Math.min((At-a)*.3,de*.5);s-=kt*it/ue,i-=kt*Ct/ue,a+=kt}}}else a-=ct,J="Cash"}else if(a>=ct)a-=ct,E++,J="Cash",!n.disableProtection&&E>=n.consecutiveLimit&&(T=!0);else{const it=ct-a;a=0,i>it?(i-=it,J="Bond"):s>it?(s-=it,J="Equity"):l>it?(l-=it,c+=it,d===null&&(d=V),J="HODL"):(x=!0,I=V)}if(s=Math.max(0,s),i=Math.max(0,i),a=Math.max(0,a),(g===0||V===n.years*12-1||x)&&C.push({year:b+g/12,month:V,equity:s,bond:i,cash:a,hodl:l,total:s+i+a,draw:ct,boostAmount:_t,source:J,inProtection:T,equityMin:_,bondMin:ot,cashMax:At}),x)break}return m=Math.max(m,v),{failed:x,years:x?I/12:n.years,failMonth:I,final:s+i+a,finalEquity:s,finalBond:i,finalCash:a,finalHodl:l,protMonths:f,maxConsec:m,hodlUsed:c,hodlUsedMonth:d,hist:C,seed:e}}function pE(n,t,e,r){let s=.15,i=.3,a=.2,l=.1,c=.1,d=.15;const f=e!==void 0?e:n,m=f>.045,v=f>.07;if(m){const C=r()>.3?1:.5;v?(s=.15+.35*C,i=.3-.2*C,d=.15-.1*C,l=.1+.05*C):(s=.15+.2*C,i=.3-.1*C,d=.15-.05*C)}m&&r()<.15&&(s=.2,i=.25,d=.12);const E=n+.005+os(0,.03,r),T=.04-(n>.04?(n-.04)*.5:0)+os(0,.05,r),x=.03+n*.3+os(0,.08,r),I=n*.8+os(0,.15,r),P=Math.max(.005,n+.005),D=t*.5+os(0,.02,r);return s*E+i*T+a*x+l*I+c*P+d*D}function mE(n,t,e,r){n.taxMode==="frozen"?n.pa:n.pa*e;const s=n.taxMode==="frozen"?n.brl:n.brl*e,i=n.baseSalary*e;let a=n.other;for(const f of r)a*=1+Math.min(f,.04);let l=0;if(n.spStartYear!==void 0){if(t>=n.spStartYear&&n.spWeeklyAmount>0){const f=n.spWeeklyAmount*52;t===n.spStartYear&&n.spFirstYearRatio!==void 0?l=f*n.spFirstYearRatio*e:l=f*e}}else n.statePensionYear!==void 0&&(l=t>=n.statePensionYear?(n.statePension||0)*e:0);const c=a+l;return Math.max(0,Math.min(s,i)-c)/12}function jf(n,t=1e3){const e=Object.keys(Ts).map(Number).sort((s,i)=>s-i),r=[];for(let s=0;s<t;s++){const i=ja(s*12345),a={equity:{},inflation:{}};for(let l=0;l<n.years;l++){const c=e[Math.floor(i()*e.length)];a.equity[l]=Ts[c],a.inflation[l]=$a[c]||.025}r.push(Po(n,a,s))}return r}function Hf(n){const t=Object.keys(Ts).map(Number).sort((s,i)=>s-i),e=Math.max(...t),r=[];for(const s of t){if(s+n.years-1>e)continue;const i={equity:{},inflation:{}};for(let l=0;l<n.years;l++)i.equity[l]=Ts[s+l]||0,i.inflation[l]=$a[s+l]||.025;const a=Po(n,i,s);a.startYear=s,r.push(a)}return r}function gE(n,t){const e={equity:{},inflation:{}};for(let r=0;r<n.years;r++)e.equity[r]=t.equity[r%t.equity.length],e.inflation[r]=t.inflation[r%t.inflation.length];return Po(n,e,999)}function yE(n){const t=n.filter(e=>e.failed).length;return(n.length-t)/n.length*100}function Wf(n){const t=n.filter(l=>!l.failed),e=n.filter(l=>l.failed),r=n.map(l=>l.years).sort((l,c)=>l-c),s=t.map(l=>l.final).sort((l,c)=>l-c),i=n.map(l=>l.protMonths).sort((l,c)=>l-c),a=(l,c)=>l[Math.floor(l.length*c)]||0;return{total:n.length,successCount:t.length,failCount:e.length,successRate:yE(n),survival:{p5:a(r,.05),p10:a(r,.1),p25:a(r,.25),p50:a(r,.5),p75:a(r,.75),p90:a(r,.9),p95:a(r,.95),min:r[0],max:r[r.length-1]},finalValue:{p5:a(s,.05),p10:a(s,.1),p25:a(s,.25),p50:a(s,.5),p75:a(s,.75),p90:a(s,.9),p95:a(s,.95),min:s[0]||0,max:s[s.length-1]||0,avg:t.reduce((l,c)=>l+c.final,0)/(t.length||1)},minYears:r[0],p10Years:a(r,.1),medianYears:a(r,.5),medianFinal:a(s,.5),p10Final:a(s,.1),p90Final:a(s,.9),avgFinal:t.reduce((l,c)=>l+c.final,0)/(t.length||1),protection:{runsWithProtection:n.filter(l=>l.protMonths>0).length,pctWithProtection:n.filter(l=>l.protMonths>0).length/n.length*100,avgMonths:i.reduce((l,c)=>l+c,0)/n.length,maxMonths:Math.max(...i),maxConsecutive:Math.max(...n.map(l=>l.maxConsec)),avgConsecutive:n.reduce((l,c)=>l+c.maxConsec,0)/n.length,p50Months:a(i,.5),p90Months:a(i,.9),p95Months:a(i,.95)},runsWithProtection:n.filter(l=>l.protMonths>0).length,avgProtMonths:i.reduce((l,c)=>l+c,0)/n.length,maxProtMonths:Math.max(...i),maxConsecutive:Math.max(...n.map(l=>l.maxConsec)),avgConsecutive:n.reduce((l,c)=>l+c.maxConsec,0)/n.length,hodl:{runsUsingHodl:n.filter(l=>l.hodlUsed>0).length,pctUsingHodl:n.filter(l=>l.hodlUsed>0).length/n.length*100,avgUsed:n.filter(l=>l.hodlUsed>0).length>0?n.filter(l=>l.hodlUsed>0).reduce((l,c)=>l+c.hodlUsed,0)/n.filter(l=>l.hodlUsed>0).length:0,maxUsed:Math.max(...n.map(l=>l.hodlUsed||0))},runsUsingHodl:n.filter(l=>l.hodlUsed>0).length,avgHodlUsed:n.filter(l=>l.hodlUsed>0).length>0?n.filter(l=>l.hodlUsed>0).reduce((l,c)=>l+c.hodlUsed,0)/n.filter(l=>l.hodlUsed>0).length:0,maxHodlUsed:Math.max(...n.map(l=>l.hodlUsed||0)),failures:e.map(l=>({seed:l.seed,startYear:l.startYear,years:l.years,failMonth:l.failMonth,protMonths:l.protMonths}))}}function Qs(n){if(!n)return null;const t={january:0,jan:0,february:1,feb:1,march:2,mar:2,april:3,apr:3,may:4,june:5,jun:5,july:6,jul:6,august:7,aug:7,september:8,sep:8,sept:8,october:9,oct:9,november:10,nov:10,december:11,dec:11},e=n.trim().replace(/\s+/g," ");if(/^\d{4}-\d{2}-\d{2}$/.test(e)){const s=new Date(e);if(!isNaN(s.getTime()))return s}if(/^\d{1,2}\/\d{1,2}\/\d{4}$/.test(e)){const[s,i,a]=e.split("/").map(Number);return new Date(a,i-1,s)}if(/^\d{1,2}-\d{1,2}-\d{4}$/.test(e)){const[s,i,a]=e.split("-").map(Number);return new Date(a,i-1,s)}let r=e.match(/^(\d{1,2})\s+(\w+)\s+(\d{4})$/i);if(r){const s=parseInt(r[1]),i=t[r[2].toLowerCase()],a=parseInt(r[3]);if(i!==void 0)return new Date(a,i,s)}if(r=e.match(/^(\w+)\s+(\d{1,2})\s+(\d{4})$/i),r){const s=t[r[1].toLowerCase()],i=parseInt(r[2]),a=parseInt(r[3]);if(s!==void 0)return new Date(a,s,i)}if(r=e.match(/^(\w+)\s+(\d{1,2})(?:st|nd|rd|th)?,?\s+(\d{4})$/i),r){const s=t[r[1].toLowerCase()],i=parseInt(r[2]),a=parseInt(r[3]);if(s!==void 0)return new Date(a,s,i)}if(r=e.match(/^(\d{1,2})(?:st|nd|rd|th)?\s+(\w+),?\s+(\d{4})$/i),r){const s=parseInt(r[1]),i=t[r[2].toLowerCase()],a=parseInt(r[3]);if(i!==void 0)return new Date(a,i,s)}return null}function Mi(n){const t=typeof n=="string"?Qs(n):n;if(!t||isNaN(t.getTime()))return"";const e=["January","February","March","April","May","June","July","August","September","October","November","December"];return`${t.getDate()} ${e[t.getMonth()]} ${t.getFullYear()}`}function vE(n){const{taxYear:t,spStartDate:e,weeklyAmount:r,taxYearConfigs:s={}}=n;if(!e||!r||r<=0)return{annual:0,monthly:0,isReceiving:!1,isFirstYear:!1,weeksInYear:0,startDate:null};const i=typeof e=="string"?Qs(e):e;if(!i||isNaN(i.getTime()))return{annual:0,monthly:0,isReceiving:!1,isFirstYear:!1,weeksInYear:0,startDate:null};const a=qa(i);kp(t);const l=Dp(t),c=[...new Set([a,t,...Object.keys(s)])].sort(),d=c.indexOf(a),f=c.indexOf(t);if(f<d)return{annual:0,monthly:0,isReceiving:!1,isFirstYear:!1,weeksInYear:0,startDate:Mi(i)};let m=1;for(let x=d;x<f;x++){const I=c[x],P=s[I],D=(P==null?void 0:P.cpi)||.025;m*=1+D}const v=r*m;if(t===a){const I=Math.max(0,(l.getTime()-i.getTime())/6048e5),P=v*I;return{annual:P,monthly:P/12,isReceiving:!0,isFirstYear:!0,weeksInYear:Math.round(I*10)/10,startDate:Mi(i)}}const T=v*52;return{annual:T,monthly:T/12,isReceiving:!0,isFirstYear:!1,weeksInYear:52,startDate:Mi(i)}}function _E(n,t=new Date){const e=typeof n=="string"?Qs(n):n;if(!e||isNaN(e.getTime()))return{years:0,months:0,totalMonths:0,isPast:!1};const r=e.getTime()-t.getTime(),s=r<=0;if(s)return{years:0,months:0,totalMonths:0,isPast:!0};const i=Math.floor(r/(30.44*24*60*60*1e3)),a=Math.floor(i/12),l=i%12;return{years:a,months:l,totalMonths:i,isPast:s}}const ld=Object.freeze(Object.defineProperty({__proto__:null,calculateStatePensionForTaxYear:vE,formatStatePensionDate:Mi,getTimeUntilStatePension:_E,parseStatePensionDate:Qs},Symbol.toStringTag,{value:"Module"}));let vn=null,Wn=null;const Yf=5e3;function Dr(){return{settings:{equityMin:te.EQUITY_MIN,bondMin:te.BOND_MIN,cashTarget:te.CASH_TARGET,duration:te.DURATION_YEARS,baseSalary:te.BASE_SALARY,other:0,statePension:12e3,statePensionYear:12,pa:oe.PERSONAL_ALLOWANCE,brl:oe.BASIC_RATE_LIMIT,hrl:oe.HIGHER_RATE_LIMIT,taxMode:"inflates",protectionMult:Yo.PROTECTION_MULTIPLIER,consecutiveLimit:te.CONSECUTIVE_LIMIT,disableProtection:!1,hodlEnabled:Yo.HODL_ENABLED,hodlValue:Yo.HODL_VALUE},lastModified:null,checksum:null}}function Ql(){return St()&&Ee()}function wE(){vn=null,Wn=null}function EE(){return vn&&Wn&&Date.now()-Wn<Yf?vn:Dr()}async function Gf(){if(vn&&Wn&&Date.now()-Wn<Yf)return vn;if(!Ql())return console.warn("Firebase not available - returning defaults"),Dr();try{const n=await rE();if(n){const t={settings:n.settings||Dr().settings,lastModified:n.lastModified,checksum:n.checksum};return vn=IE(t),Wn=Date.now(),vn}}catch(n){console.error("Error loading stress data from Firebase:",n)}return Dr()}async function bE(n){if(!Ql())throw new Error("Must be logged in to save data");try{n.lastModified=new Date().toISOString(),n.checksum=TE(n),await zf({settings:n.settings,lastModified:n.lastModified,checksum:n.checksum}),vn=n,Wn=Date.now()}catch(t){throw console.error("Error saving stress data to Firebase:",t),new Error("Failed to save stress data")}}function TE(n){return bd(n.settings)}function IE(n){const t={...Dr()};return n.settings&&(t.settings={...t.settings,...n.settings},n.settings.pacwMin!==void 0&&n.settings.equityMin===void 0&&(t.settings.equityMin=n.settings.pacwMin),n.settings.cgtMin!==void 0&&n.settings.bondMin===void 0&&(t.settings.bondMin=n.settings.cgtMin),n.settings.csh2Target!==void 0&&n.settings.cashTarget===void 0&&(t.settings.cashTarget=n.settings.csh2Target),t.settings.hodlEnabled===void 0&&(t.settings.hodlEnabled=!1),t.settings.hodlValue===void 0&&(t.settings.hodlValue=25e3)),t.lastModified=n.lastModified,t.checksum=n.checksum,t}function SE(){return EE().settings}async function kn(){return(await Gf()).settings}async function Jl(n){const t=await Gf();t.settings={...t.settings,...n},await bE(t)}async function AE(){if(!Ql())throw new Error("Must be logged in to reset settings");const n=Dr();await zf({settings:n.settings,lastModified:new Date().toISOString()}),wE()}function xE(n){if(!n.spStartDate||!n.spWeeklyAmount)return{spStartYear:999,spWeeklyAmount:0,spFirstYearRatio:1};const t=Qs(n.spStartDate);if(!t)return console.warn("Could not parse spStartDate:",n.spStartDate),{spStartYear:999,spWeeklyAmount:0,spFirstYearRatio:1};const e=new Date,r=365.25*24*60*60*1e3,s=Math.max(0,(t.getTime()-e.getTime())/r),i=Math.floor(s),a=365,l=Math.floor((t-new Date(t.getFullYear(),0,0))/(24*60*60*1e3)),d=(a-l)/a;return{spStartYear:i,spWeeklyAmount:n.spWeeklyAmount,spFirstYearRatio:d}}function Xl(n={},t=null){const e=t||SE(),r=xE(e);return{equityStart:n.equityStart??e.equityMin,bondStart:n.bondStart??e.bondMin,cashStart:n.cashStart??e.cashTarget,equityMin:e.equityMin,bondMin:e.bondMin,cashTarget:e.cashTarget,years:n.years??e.duration,duration:e.duration,baseSalary:e.baseSalary,other:e.other,spStartYear:r.spStartYear,spWeeklyAmount:r.spWeeklyAmount,spFirstYearRatio:r.spFirstYearRatio,pa:e.pa,brl:e.brl,hrl:e.hrl,taxMode:e.taxMode,protectionMult:e.protectionMult,consecutiveLimit:e.consecutiveLimit,disableProtection:e.disableProtection,hodlEnabled:e.hodlEnabled,hodlValue:e.hodlValue}}function H(n,t=null){const e=Math.abs(n),r=t!==null?t:e<100,s=Math.abs(n).toLocaleString("en-GB",{minimumFractionDigits:r?2:0,maximumFractionDigits:r?2:0});return n<0?`-£${s}`:`£${s}`}function cd(n,t){const e=RE(n);t.innerHTML=e}function RE(n){var S,A,_,ot,At;const t=n,e=t.calculationDetails||{};let r="";const s=t.isTaxEfficientYear??t.taxEfficient,i=t.protectionInducedTaxEfficiency||!1,a=t.boostAmount>0;let l,c,d;if(t.inProtection?(l="warning",c="Protection Mode",d="⚡"):a?(l="boost",c="Tax Boost (Catch-up)",d="↑"):i?(l="info",c="Protection-Induced Tax Efficiency",d="↑"):s?(l="success",c="Tax-Efficient Year",d="✓"):(l="warning",c="Tax-Inefficient Year",d="!"),r+=`<div class="decision-mode ${l}">
  ...
  `}function fd(){Js();const n=ME({targetAnnualGross:B.confirmedSalary,brl:B.brl,pa:B.pa,other:B.other,statePension:Q.statePension.amount,remainingMonths:Q.remainingMonths,grossIncomeToDate:B.grossIncomeToDate});return B._isaCalc=n,n.brlExhausted?`
      <div class="wizard-step">
  ...
  `}function pd(){Js();const n=B._isaCalc,t=NE(B.isaSavingsAllocation,(n==null?void 0:n.isaNeeded)||0,(n==null?void 0:n.brlExhausted)||!1);if(t.sufficient&&!t.isBrlExhausted)return B.isTaxEfficient=!0,B.taxEfficiencyChoice="efficient",setTimeout(()=>{pe++,bs()},0),`
      <div class="wizard-step">
  ...
  `}function GE(n={},t=null){const e=Xl(n,t),r=jf(e),s=Wf(r);return{results:r,stats:s,config:e}}function KE(n={},t=null){const e=Xl(n,t),r=Hf(e),s=Wf(r);return{results:r,stats:s,config:e}}function QE(n={}){const t=Xl(n),e={};for(const[r,s]of Object.entries(Pp))e[r]={...s,result:gE(t,s)};return e}let Ve=null,la=null,Tr=!1;function JE(n,t){console.log("initAuthScreen: initializing"),Ve=n,la=t,Tr=!1,Gw(e=>{console.log("AuthScreen: auth state change received:",e?e.email:"null","processed:",Tr),e&&la&&!Tr?(console.log("AuthScreen: calling onAuthSuccessCallback"),Tr=!0,la(e)):e?console.log("AuthScreen: skipping callback, already processed or no callback"):(Tr=!1,console.log("AuthScreen: user signed out, reset authProcessed"))}),Jf(),console.log("initAuthScreen: complete")}function Jf(){if(Ve){if(!St()){Ve.innerHTML=`
  ...
  `,XE()}}function XE(){const n=Ve.querySelectorAll(".auth-screen-tab");n.forEach(i=>{i.addEventListener("click",()=>{n.forEach(c=>c.classList.remove("active")),i.classList.add("active");const a=document.getElementById("signinForm"),l=document.getElementById("signupForm");i.dataset.tab==="signin"?(a.style.display="block",l.style.display="none"):(a.style.display="none",l.style.display="block"),Xs()})}),document.getElementById("signinForm").addEventListener("submit",ZE),document.getElementById("signupForm").addEventListener("submit",tb),document.getElementById("forgotPasswordBtn").addEventListener("click",eb),document.getElementById("googleSigninBtn").addEventListener("click",nb)}function Tn(n){const t=document.getElementById("authScreenError");t&&(t.textContent=n,t.style.display="block")}function Xs(){const n=document.getElementById("authScreenError");n&&(n.style.display="none")}async function ZE(n){n.preventDefault(),Xs();const t=document.getElementById("signinEmail").value.trim(),e=document.getElementById("signinPassword").value;if(!t||!e){Tn("Please enter email and password");return}try{await Qw(t,e)}catch(r){console.error("Sign in error:",r),Tn(Co(r.code))}}async function tb(n){n.preventDefault(),Xs();const t=document.getElementById("signupName").value.trim(),e=document.getElementById("signupEmail").value.trim(),r=document.getElementById("signupPassword").value;if(!t||!e||!r){Tn("Please fill in all fields");return}if(r.length<6){Tn("Password must be at least 6 characters");return}try{await Kw(e,r,t)}catch(s){console.error("Sign up error:",s),Tn(Co(s.code))}}async function eb(){Xs();const n=document.getElementById("signinEmail").value.trim();if(!n){Tn("Please enter your email address first");return}try{await Xw(n),alert("Password reset email sent. Check your inbox.")}catch(t){console.error("Reset password error:",t),Tn(Co(t.code))}}async function nb(){Xs();try{await Jw()}catch(n){console.error("Google sign in error:",n),Tn(Co(n.code))}}function Co(n){return{"auth/invalid-email":"Invalid email address","auth/user-disabled":"This account has been disabled","auth/user-not-found":"No account found with this email","auth/wrong-password":"Incorrect password","auth/email-already-in-use":"An account already exists with this email","auth/weak-password":"Password is too weak","auth/operation-not-allowed":"Sign in method not enabled","auth/popup-closed-by-user":"Sign in cancelled","auth/popup-blocked":"Sign in popup was blocked","auth/too-many-requests":"Too many attempts. Please try again later.","auth/invalid-credential":"Invalid email or password"}[n]||"An error occurred. Please try again."}function Ba(){console.log("hideAuthScreen: hiding auth screen, element=",!!Ve),Ve&&(Ve.style.display="none",console.log("hideAuthScreen: set display to none"))}function Xf(){Tr=!1,Ve&&(Ve.style.display="block",Jf())}function rb(){return`
    .auth-screen {
      position: fixed;
      top: 0;
      left: 0;
  ...
  `}let Rn=null,Fa=null,j={introDone:!1,baseSalary:3e4,otherIncome:0,spStartDate:"",spWeeklyAmount:0,equityMin:25e4,bondMin:2e5,cashTarget:5e4,duration:35,taxMode:"inflates",decisionSalary:3e4,decisionEquity:25e4,decisionBond:2e5,decisionCash:5e4,decisionDuration:35},Ce="intro",Vt=1;function sb(){Ce="intro",Vt=1,j={introDone:!1,baseSalary:3e4,otherIncome:0,spStartDate:"",spWeeklyAmount:0,equityMin:25e4,bondMin:2e5,cashTarget:5e4,duration:35,taxMode:"inflates",decisionSalary:3e4,decisionEquity:25e4,decisionBond:2e5,decisionCash:5e4,decisionDuration:35}}function za(n,t){Rn=n,Fa=t,sb(),hn()}function hn(){Rn&&(Ce==="intro"?ib():Ce==="stress"?lb():Ce==="decision"&&ub())}function ib(){Rn.innerHTML=`
    <div class="wizard-overlay">
      <div class="wizard-box">
  ...
  `,ec()}function cb(n){switch(n){case 1:return`
      ...
      `;default:return""}}function ub(){Rn.innerHTML=`
    <div class="wizard-overlay">
      <div class="wizard-box">
  ...
  `}function ko(){const t=getComputedStyle(document.documentElement).getPropertyValue("--bg").trim()==="#0d1117"||document.documentElement.classList.contains("dark")||window.matchMedia("(prefers-color-scheme: dark)").matches;return{primary:"#f0c674",success:"#2ea043",warning:"#e1b12c",danger:"#f85149",muted:"#8b8b9b",grid:"rgba(255,255,255,0.1)",bg:t?"rgba(15,15,26,1)":"#ffffff",text:t?"#c9d1d9":"#1f2937",cardBg:t?"#21262d":"#ffffff",cone:"rgba(240,198,116,0.15)",coneMid:"rgba(240,198,116,0.2)",coneInner:"rgba(240,198,116,0.35)",coneBorder:"rgba(240,198,116,0.4)",trajectory:"rgba(46,160,67,0.25)",trajectoryFailed:"rgba(248,81,73,0.8)",trajectoryHover:"#5fdd7b",trajectoryFailedHover:"#ff6b6b",glidepath:"#7eb8da",zeroLine:"#f85149"}}const tr=new Map;let _r=-1;function gd(n,t,e,r,s,i){const a=s-e,l=i-r,c=a*a+l*l;if(c===0)return Math.sqrt((n-e)*(n-e)+(t-r)*(t-r));const d=Math.max(0,Math.min(1,((n-e)*a+(t-r)*l)/c)),f=e+d*a,m=r+d*l;return Math.sqrt((n-f)*(n-f)+(t-m)*(t-m))}function mb(n,t,e={}){const r=ko(),s=n.getContext("2d"),{width:i,height:a}=n,l={top:20,right:40,bottom:50,left:80},c=i-l.left-l.right,d=a-l.top-l.bottom;s.fillStyle="rgba(0,0,0,0.2)",s.fillRect(0,0,i,a);const f=e.years||35,m={};for(let I=0;I<=f;I++)m[I]=[];t.forEach(I=>{I.hist.forEach(P=>{const D=Math.floor(P.year);m[D]!==void 0&&m[D].push(P.total)})});const v=[];for(let I=0;I<=f;I++){const P=m[I].sort((C,N)=>C-N);if(P.length===0)continue;const D=C=>P[Math.floor(P.length*C)]||0;v.push({year:I,p5:D(.05),p10:D(.1),p25:D(.25),p50:D(.5),p75:D(.75),p90:D(.9),p95:D(.95)})}if(v.length===0)return;const E=Math.max(...v.map(I=>I.p90))*1.15,T=I=>l.left+I/f*c,x=I=>a-l.bottom-I/E*d;s.strokeStyle=r.grid,s.lineWidth=1;for(let I=0;I<=5;I++){const P=l.top+I/5*d;s.beginPath(),s.moveTo(l.left,P),s.lineTo(i-l.right,P),s.stroke()}s.fillStyle=r.cone,s.beginPath(),v.forEach((I,P)=>{const D=T(I.year);P===0?s.moveTo(D,x(I.p95)):s.lineTo(D,x(I.p95))});for(let I=v.length-1;I>=0;I--)s.lineTo(T(v[I].year),x(v[I].p5));s.closePath(),s.fill(),s.fillStyle=r.coneMid,s.beginPath(),v.forEach((I,P)=>{const D=T(I.year);P===0?s.moveTo(D,x(I.p90)):s.lineTo(D,x(I.p90))});for(let I=v.length-1;I>=0;I--)s.lineTo(T(v[I].year),x(v[I].p10));s.closePath(),s.fill(),s.fillStyle=r.coneInner,s.beginPath(),v.forEach((I,P)=>{const D=T(I.year);P===0?s.moveTo(D,x(I.p75)):s.lineTo(D,x(I.p75))});for(let I=v.length-1;I>=0;I--)s.lineTo(T(v[I].year),x(v[I].p25));s.closePath(),s.fill(),e.glide&&e.glide.length>0&&(s.strokeStyle=r.glidepath,s.lineWidth=2,s.setLineDash([6,3]),s.beginPath(),e.glide.forEach((I,P)=>{const D=T(I.year),C=x(I.min);P===0?s.moveTo(D,C):s.lineTo(D,C)}),s.stroke(),s.setLineDash([])),s.strokeStyle=r.primary,s.lineWidth=3,s.beginPath(),v.forEach((I,P)=>{const D=T(I.year),C=x(I.p50);P===0?s.moveTo(D,C):s.lineTo(D,C)}),s.stroke(),s.strokeStyle="rgba(248,81,73,0.6)",s.lineWidth=1.5,s.setLineDash([4,2]),s.beginPath(),v.forEach((I,P)=>{const D=T(I.year);P===0?s.moveTo(D,x(I.p10)):s.lineTo(D,x(I.p10))}),s.stroke(),s.setLineDash([]),s.strokeStyle=r.zeroLine,s.lineWidth=2,s.setLineDash([5,5]),s.beginPath(),s.moveTo(l.left,x(0)),s.lineTo(i-l.right,x(0)),s.stroke(),s.setLineDash([]),s.fillStyle=r.muted,s.font="11px sans-serif",s.textAlign="right";for(let I=0;I<=5;I++){const P=E*(1-I/5);s.fillText(fe(P),l.left-10,l.top+I/5*d+4)}s.textAlign="center";for(let I=0;I<=f;I+=5)s.fillText(`Yr ${I}`,T(I),a-l.bottom+20);tr.set(n.id,{percentiles:v,xScale:T,yScale:x,padding:l,chartWidth:c,chartHeight:d,years:f,maxValue:E,type:"cone"}),wb(n)}function gb(n,t,e={}){const r=ko(),s=n.getContext("2d"),{width:i,height:a}=n,l={top:20,right:40,bottom:50,left:80},c=i-l.left-l.right,d=a-l.top-l.bottom;s.fillStyle="rgba(0,0,0,0.2)",s.fillRect(0,0,i,a);const f=e.years||35,m=e.startValue||1e6,v=t.slice(0,100),E=v.filter(C=>C.failed),T=v.filter(C=>!C.failed);let x;if(E.length>0)x=m*2;else{const C=T.map(F=>F.final).sort((F,V)=>F-V),N=C[Math.floor(C.length*.5)]||m;x=Math.max(N*1.3,m*1.5)}const I=C=>l.left+C/f*c,P=C=>a-l.bottom-Math.min(C,x)/x*d;s.strokeStyle=r.grid,s.lineWidth=1;for(let C=0;C<=5;C++){const N=l.top+C/5*d;s.beginPath(),s.moveTo(l.left,N),s.lineTo(i-l.right,N),s.stroke()}s.fillStyle=r.muted,s.font="11px sans-serif",s.textAlign="right";for(let C=0;C<=5;C++){const N=x*(1-C/5);s.fillText(fe(N),l.left-10,l.top+C/5*d+4)}s.textAlign="center";for(let C=0;C<=f;C+=5)s.fillText(`Yr ${C}`,I(C),a-l.bottom+20);const D=[];e.glide&&e.glide.length>0&&(s.strokeStyle=r.glidepath,s.lineWidth=3,s.setLineDash([8,4]),s.beginPath(),e.glide.forEach((C,N)=>{const F=I(C.year),V=P(C.min);N===0?s.moveTo(F,V):s.lineTo(F,V)}),s.stroke(),s.setLineDash([])),T.forEach((C,N)=>{const F=C.hist.map(V=>({x:I(V.year),y:P(V.total)}));D.push({run:C,pts:F,failed:!1,idx:N}),s.strokeStyle=r.trajectory,s.lineWidth=.5,s.beginPath(),F.forEach((V,b)=>{b===0?s.moveTo(V.x,V.y):s.lineTo(V.x,V.y)}),s.stroke()}),E.forEach((C,N)=>{const F=C.hist.map(V=>({x:I(V.year),y:P(V.total)}));D.push({run:C,pts:F,failed:!0,idx:T.length+N}),s.strokeStyle=r.trajectoryFailed,s.lineWidth=2,s.beginPath(),F.forEach((V,b)=>{b===0?s.moveTo(V.x,V.y):s.lineTo(V.x,V.y)}),s.stroke()}),s.strokeStyle=r.zeroLine,s.lineWidth=2,s.setLineDash([5,5]),s.beginPath(),s.moveTo(l.left,P(0)),s.lineTo(i-l.right,P(0)),s.stroke(),s.setLineDash([]),tr.set(n.id,{results:v,paths:D,xScale:I,yScale:P,padding:l,chartWidth:c,chartHeight:d,years:f,maxValue:x,glide:e.glide,type:"trajectory"}),Eb(n,r)}function yb(n,t,e={}){const r=ko(),s=n.getContext("2d"),{width:i,height:a}=n,l={top:30,right:20,bottom:55,left:60},c=i-l.left-l.right,d=a-l.top-l.bottom;s.fillStyle="rgba(0,0,0,0.2)",s.fillRect(0,0,i,a);const f=t.map(C=>C.protMonths),m=f.length,v=Math.max(...f),E=Math.max(1,Math.ceil(v/15)),T={};f.forEach(C=>{const N=Math.floor(C/E)*E;T[N]=(T[N]||0)+1});const x=Object.keys(T).map(Number).sort((C,N)=>C-N),I=Math.max(...Object.values(T)),P=c/(x.length||1),D=[];s.strokeStyle=r.grid,s.lineWidth=1,s.fillStyle=r.muted,s.font="10px sans-serif",s.textAlign="right";for(let C=0;C<=4;C++){const N=l.top+C/4*d;s.beginPath(),s.moveTo(l.left,N),s.lineTo(i-l.right,N),s.stroke();const F=Math.round(I*(1-C/4));s.fillText(`${F} runs`,l.left-5,N+4)}x.forEach((C,N)=>{const F=T[C],V=F/I*d,b=l.left+N*P+2,g=a-l.bottom-V,y=P-4;s.fillStyle=C===0?r.success:r.warning,s.fillRect(b,g,y,V),D.push({x:b,y:g,w:y,h:V,months:C,monthsEnd:C+E-1,count:F,pct:(F/m*100).toFixed(1)})}),s.fillStyle=r.muted,s.font="10px sans-serif",s.textAlign="center",x.forEach((C,N)=>{if(N%2===0||x.length<12){const F=E>1?`${C}-${C+E-1}`:C.toString();s.fillText(F,l.left+N*P+P/2,a-l.bottom+15)}}),s.fillText("Protection Months",i/2,a-5),s.save(),s.translate(12,a/2),s.rotate(-Math.PI/2),s.textAlign="center",s.fillText("Number of Runs",0,0),s.restore(),tr.set(n.id,{bars:D,totalRuns:m,type:"histogram"}),bb(n)}function vb(n,t,e={}){const r=ko(),s=n.getContext("2d"),{width:i,height:a}=n,l={top:50,right:180,bottom:60,left:80},c=i-l.left-l.right,d=a-l.top-l.bottom;s.fillStyle=r.bg,s.fillRect(0,0,i,a);const f=Object.keys(t),m=e.years||35;let v=0;f.forEach(I=>{const P=t[I].result;P&&P.hist&&P.hist.forEach(D=>{D.total>v&&(v=D.total)})}),v*=1.1;const E=I=>l.left+I/m*c,T=I=>l.top+d-I/v*d;_b(s,l,c,d,m,v,e.title||"Scenario Comparison",r);const x=["#6366f1","#22c55e","#f59e0b","#ef4444","#8b5cf6","#06b6d4","#ec4899","#84cc16"];f.forEach((I,P)=>{const D=t[I].result;if(!D||!D.hist)return;s.beginPath(),s.strokeStyle=x[P%x.length],s.lineWidth=2.5,D.hist.forEach((N,F)=>{const V=E(N.year),b=T(N.total);F===0?s.moveTo(V,b):s.lineTo(V,b)}),s.stroke();const C=l.top+15+P*24;s.fillStyle=x[P%x.length],s.fillRect(i-l.right+15,C,20,4),s.font="11px system-ui, sans-serif",s.fillStyle=r.text,s.textAlign="left",s.fillText(t[I].name||I,i-l.right+40,C+5),D.final/1e3,s.fillStyle=r.muted,s.fillText(`${fe(D.final)}`,i-l.right+40,C+18)})}function _b(n,t,e,r,s,i,a,l){n.font="bold 14px system-ui, sans-serif",n.fillStyle=l.text,n.textAlign="center",n.fillText(a,t.left+e/2,t.top-20),n.strokeStyle=l.grid,n.lineWidth=1;for(let c=0;c<=5;c++){const d=t.top+r*c/5;n.beginPath(),n.moveTo(t.left,d),n.lineTo(t.left+e,d),n.stroke();const f=i*(5-c)/5;n.font="11px system-ui, sans-serif",n.fillStyle=l.muted,n.textAlign="right",n.fillText(fe(f),t.left-10,d+4)}for(let c=0;c<=s;c+=5){const d=t.left+c/s*e;n.beginPath(),n.moveTo(d,t.top),n.lineTo(d,t.top+r),n.stroke(),n.textAlign="center",n.fillText(`Y${c}`,d,t.top+r+20)}n.font="12px system-ui, sans-serif",n.textAlign="center",n.fillText("Years",t.left+e/2,t.top+r+45),n.save(),n.translate(20,t.top+r/2),n.rotate(-Math.PI/2),n.fillText("Fund Value",0,0),n.restore()}function fe(n){return n>=1e6?`£${(n/1e6).toFixed(1)}M`:n>=1e3?`£${(n/1e3).toFixed(0)}k`:`£${n.toFixed(0)}`}function wb(n,t){const e=n._coneHoverListener;e&&n.removeEventListener("mousemove",e);const r=s=>{const i=tr.get(n.id);if(!i||i.type!=="cone")return;const a=n.getBoundingClientRect(),l=n.width/a.width,c=(s.clientX-a.left)*l,{percentiles:d,padding:f,chartWidth:m,years:v}=i,E=(c-f.left)/m*v,T=Math.round(E);if(T<0||T>v){In();return}const x=d.find(P=>P.year===T);if(!x){In();return}const I=`
    ...
    `;nc(s.clientX,s.clientY,I)};n._coneHoverListener=r,n.addEventListener("mousemove",r),n.addEventListener("mouseleave",In)}function Eb(n,t){const e=n._trajHoverListener;e&&n.removeEventListener("mousemove",e);const r=n._trajLeaveListener;r&&n.removeEventListener("mouseleave",r);const s=a=>{const l=tr.get(n.id);if(!l||l.type!=="trajectory")return;const c=n.getBoundingClientRect(),d=n.width/c.width,f=n.height/c.height,m=(a.clientX-c.left)*d,v=(a.clientY-c.top)*f,{paths:E,padding:T,chartWidth:x,chartHeight:I}=l;if(m<T.left||m>T.left+x||v<T.top||v>T.top+I){In(),_r!==-1&&(_r=-1,ua(n,l,t,null));return}let P=null,D=12*d;E.filter(N=>N.failed).forEach(N=>{for(let F=0;F<N.pts.length-1;F++){const V=gd(m,v,N.pts[F].x,N.pts[F].y,N.pts[F+1].x,N.pts[F+1].y);V<D&&(D=V,P=N)}}),P||E.filter(N=>!N.failed).forEach(N=>{for(let F=0;F<N.pts.length-1;F++){const V=gd(m,v,N.pts[F].x,N.pts[F].y,N.pts[F+1].x,N.pts[F+1].y);V<D&&(D=V,P=N)}});const C=P?P.idx:-1;if(C!==_r&&(_r=C,ua(n,l,t,P)),P){const N=P.run,F=P.failed?"#f85149":"#2ea043",V=P.failed?"❌":"✅",b=P.failed?"FAILED":"SUCCESS";let g=`
        <div style="border-bottom:1px solid #555;padding-bottom:6px;margin-bottom:6px;">
          <strong style="color:${F};">${V} ${b}</strong>
          <span style="float:right;color:#8b8b9b;font-size:11px;">Run #${P.idx+1}</span>
        </div>
        <div style="display:grid;grid-template-columns:auto auto;gap:4px 16px;">
      `;N.startYear&&(g+=`<span style="color:#8b8b9b;">Start year:</span><span>${N.startYear}</span>`),g+=`<span style="color:#8b8b9b;">Duration:</span><span>${N.years.toFixed(1)} years</span>`,g+=`<span style="color:#8b8b9b;">Final balance:</span><span>${fe(N.final)}</span>`,g+=`<span style="color:#8b8b9b;">Protection months:</span><span>${N.protMonths}</span>`,g+=`<span style="color:#8b8b9b;">Longest streak:</span><span>${N.maxConsec} months</span>`,N.hodlUsed>0&&(g+=`<span style="color:#8b8b9b;">HODL used:</span><span>${fe(N.hodlUsed)}</span>`),g+="</div>",P.failed&&N.failMonth&&(g+=`<div style="margin-top:8px;padding-top:8px;border-top:1px solid #555;color:#f0c674;">💀 Depleted at year ${(N.failMonth/12).toFixed(1)}</div>`),nc(a.clientX,a.clientY,g)}else In()},i=()=>{if(In(),_r!==-1){_r=-1;const a=tr.get(n.id);a&&ua(n,a,t,null)}};n._trajHoverListener=s,n._trajLeaveListener=i,n.addEventListener("mousemove",s),n.addEventListener("mouseleave",i)}function bb(n,t){const e=n._histHoverListener;e&&n.removeEventListener("mousemove",e);const r=s=>{const i=tr.get(n.id);if(!i||i.type!=="histogram")return;const a=n.getBoundingClientRect(),l=n.width/a.width,c=n.height/a.height,d=(s.clientX-a.left)*l,f=(s.clientY-a.top)*c,{bars:m,totalRuns:v}=i;let E=null;if(m.forEach(T=>{d>=T.x&&d<=T.x+T.w&&f>=T.y&&f<=T.y+T.h&&(E=T)}),E){const T=E.months===0,x=T?"#2ea043":"#e1b12c",I=T?"🟢":"🟡",P=T?"No Protection":`${E.months}${E.monthsEnd>E.months?`-${E.monthsEnd}`:""} months`,D=`
        <div style="border-bottom:1px solid #555;padding-bottom:6px;margin-bottom:6px;">
